  ...
  (defun zuni2 (zr zi fnu kode n yr yi nz nlast fnul tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((bry (make-array 3 :element-type 'double-float))
             ...
             (nw 0) (idum 0) (aarg 0.0) (aii 0.0) (air 0.0) (ang 0.0)
             (aphi 0.0) (argi 0.0) (argr 0.0) (ascle 0.0) (asumi 0.0)
             (asumr 0.0) (bsumi 0.0) (bsumr 0.0) (cidi 0.0) (crsc 0.0)
             (cscl 0.0) (c1r 0.0) (c2i 0.0) (c2m 0.0) (c2r 0.0) (daii 0.0)
             (dair 0.0) (fn 0.0) (phii 0.0) (phir 0.0) (rast 0.0) (raz 0.0)
             (rs1 0.0) (rzi 0.0) (rzr 0.0) (sti 0.0) (str 0.0) (s1i 0.0)
             (s1r 0.0) (s2i 0.0) (s2r 0.0) (zbi 0.0) (zbr 0.0) (zeta1i 0.0)
             (zeta1r 0.0) (zeta2i 0.0) (zeta2r 0.0) (zni 0.0) (znr 0.0)
             (car$ 0.0) (sar 0.0))
        (declare (type (array double-float (2)) cyi cyr)
                 ...
                 (type (double-float) sar car$ znr zni zeta2r zeta2i zeta1r
                  zeta1i zbr zbi s2r s2i s1r s1i str sti rzr rzi rs1 raz rast
                  phir phii fn dair daii c2r c2m c2i c1r cscl crsc cidi bsumr
                  bsumi asumr asumi ascle argr argi aphi ang air aii aarg)
                 (type (f2cl-lib:integer4) idum nw nuf nn ndai nd nai k j inu
                  in iflag i))
        (setf nz 0)
        (setf nd n)
        (setf nlast 0)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
           ...
           label80
            ...
            (setf (f2cl-lib:fref yr-%data% (j) ((1 n)) yr-%offset%)
                    (* s2r (f2cl-lib:fref csrr (iflag) ((1 3)))))
            (setf (f2cl-lib:fref yi-%data% (j) ((1 n)) yi-%offset%)

  ...
  (defun zunk1 (zr zi fnu kode mr n yr yi nz tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((bry (make-array 3 :element-type 'double-float))
        ...
        (declare
         (type (array double-float (2)) zeta2r zeta2i zeta1r zeta1i sumr sumi
          phir phii cyr cyi)
         (type (array double-float (48)) cwrkr cwrki)
         (type (array double-float (3)) cssr csrr bry)
         (type (double-float) zrr zri zet2dr zet2di zet1dr zet1di s2r s2i s1r
          s1i sumdr sumdi str sti sgn rzr rzi rs1 razr rast phidr phidi fnf fn
          fmr c2r c2m c2i c1r c1i csr cspnr cspni csgni cscl crsc ckr cki ascle
          asc aphi ang)
         (type (array f2cl-lib:integer4 (2)) init)
         (type (f2cl-lib:integer4) m j ipard ic initd nw kk kflag kdflg k iuf
          inu il ifn iflag ib i))
        (setf kdflg 1)
        (setf nz 0)
        (setf cscl (/ 1.0 tol))
        (setf crsc tol)
       ...
       label75
        ...
        (multiple-value-bind
            ...
            (zunik zrr zri fn 2 ipard tol initd phidr phidi zet1dr zet1di
             ...
             (f2cl-lib:fref cwrkr (1 3) ((1 16) (1 3)))
           ...
           label180
            (multiple-value-bind
                ...
                (zunik zrr zri fn 1 0 tol initd phidr phidi zet1dr zet1di
                 zet2dr zet2di sumdr sumdi
                 (f2cl-lib:fref cwrkr (1 m) ((1 16) (1 3)))

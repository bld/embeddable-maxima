...
(let ((ngam 0)
      ...
      (dxrel 0.0)
      (gamcs
       (make-array 42 :element-type 'double-float :initial-contents
                   '(0.00857119559098933 0.004415381324841007
                     0.05685043681599363 -0.00421983539641856
                     0.0013268081812124603 -1.8930245297988805e-4
                     3.606925327441245e-5 -6.056761904460864e-6
                     1.0558295463022833e-6 -1.811967365542384e-7
                     3.117724964715322e-8 -5.354219639019687e-9
                     9.193275519859589e-10 -1.5779412802883398e-10
                     2.7079806229349544e-11 -4.64681865382573e-12
                     7.97335019200742e-13 -1.368078209830916e-13
                     2.3473194865638007e-14 -4.027432614949067e-15
                     6.910051747372101e-16 -1.185584500221993e-16
                     2.034148542496374e-17 -3.490054341717406e-18
                     5.987993856485306e-19 -1.027378057872228e-19
                     1.7627028160605298e-20 -3.024320653735306e-21
                     5.188914660218398e-22 -8.902770842456576e-23
                     1.5274740684933426e-23 -2.620731256187363e-24
                     4.496464047830539e-25 -7.714712731336878e-26
                     1.323635453126044e-26 -2.2709994129429287e-27
                     3.8964189980039913e-28 -6.685198115125953e-29
                     1.1469986631400244e-29 -1.9679385863451348e-30
                     3.376448816585338e-31 -5.793070335782136e-32)))
      (pi$ 3.141592653589793)
      (sq2pil 0.9189385332046728)
      (first$ nil))
  (declare (type (f2cl-lib:integer4) ngam)
           (type (double-float) xmin xmax dxrel pi$ sq2pil)
           (type (array double-float (42)) gamcs)
  ...
  (defun dgamma (x)
    ...
    (prog ((sinpiy 0.0) (y 0.0) (dgamma 0.0) (i 0) (n 0))
      ...
      (if (and (< x -0.5)
               (< (abs (/ (- x (f2cl-lib:aint (- x 0.5))) x)) dxrel))

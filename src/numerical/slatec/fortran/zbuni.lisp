...
(defun zbuni (zr zi fnu kode n yr yi nz nui nlast fnul tol elim alim)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((cyr (make-array 2 :element-type 'double-float))
           ...
           (s2r 0.0) (ascle 0.0) (c1r 0.0) (c1i 0.0) (c1m 0.0))
      (declare (type (array double-float (3)) bry)
               (type (array double-float (2)) cyr cyi)
               (type (double-float) c1m c1i c1r ascle s2r s2i s1r s1i str sti
                rzr rzi raz gnu fnui dfnu cscrr csclr ay ax)
     ...
     label20
      ...
      (setf csclr 1.0)
      (if (> str (f2cl-lib:fref bry (1) ((1 3))))
          (go label21))
      (setf iflag 1)
      ...
      (go label25)
     label21
      (if (< str (f2cl-lib:fref bry (2) ((1 3))))
          (go label25))
      (setf iflag 3)
     ...
     label25
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf s2i (* s2i csclr))
         label30))
      (setf (f2cl-lib:fref yr-%data% (n) ((1 n)) yr-%offset%) (* s2r cscrr))
      (setf (f2cl-lib:fref yi-%data% (n) ((1 n)) yi-%offset%) (* s2i cscrr))
      (if (= n 1)
          (go end_label))
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf str (* s2r cscrr))
          (setf sti (* s2i cscrr))
          (setf (f2cl-lib:fref yr-%data% (k) ((1 n)) yr-%offset%) str)
          (setf (f2cl-lib:fref yi-%data% (k) ((1 n)) yi-%offset%) sti)
          (setf fnui (- fnui 1.0))
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil nz nil nlast nil nil nil nil)))))
  ...
  (setf (gethash 'fortran-to-lisp::zbuni fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil
                                              fortran-to-lisp::nz nil
                                              fortran-to-lisp::nlast nil nil
                                              nil nil)
                                            :calls
                                            '(fortran-to-lisp::d1mach
                                              fortran-to-lisp::zabs
                                              fortran-to-lisp::zuni2
                                              fortran-to-lisp::zuni1))))

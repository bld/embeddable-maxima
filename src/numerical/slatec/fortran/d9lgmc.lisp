...
(let ((nalgm 0)
      ...
      (algmcs
       (make-array 15 :element-type 'double-float :initial-contents
                   '(0.16663894804518634 -1.384948176067564e-5
                     9.81082564692473e-9 -1.809129475572494e-11
                     6.221098041892606e-14 -3.399615005417722e-16
                     2.683181998482699e-18 -2.868042435334643e-20
                     3.9628370610464347e-22 -6.831888753985767e-24
                     1.4292273559424982e-25 -3.5475981581010704e-27
                     1.025680058010471e-28 -3.401102254316749e-30
                     1.276642195630063e-31)))
      (first$ nil))
  (declare (type (f2cl-lib:integer4) nalgm)
           (type (double-float) xbig xmax)
           (type (array double-float (15)) algmcs)
  ...
  (defun d9lgmc (x)
    ...
    (prog ((d9lgmc 0.0))
      ...
      (if (< x 10.0)
          (xermsg "SLATEC" "D9LGMC" "X MUST BE GE 10" 1 2))
      (if (>= x xmax)
          (go label20))

      ...
      (prog ((i 0) (id 0) (idnu 0) (inu 0) (itime 0) (k 0) (kk 0) (magz 0)
        ...
        (declare
         (type (double-float) t1r t1i ttr tti test1 test rzr rzi rho rap1 rak
          p2r p2i p1r p1i ptr pti fnup flam fdnu dfnu cdfnur cdfnui az arg ap2
          ap1 amagz ak)
       ...
       label40
        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
          ...
          (setf (f2cl-lib:fref cyr-%data% (n) ((1 n)) cyr-%offset%) var-4)
          (setf (f2cl-lib:fref cyi-%data% (n) ((1 n)) cyi-%offset%) var-5))
        (if (= n 1)
            (go end_label))
        ...
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (setf ptr
                    (+ cdfnur (- (* t1r rzr) (* t1i rzi))
                       (f2cl-lib:fref cyr-%data% ((f2cl-lib:int-add k 1))
                                      ((1 n)) cyr-%offset%)))
            (setf pti
                    (+ cdfnui (+ (* t1r rzi) (* t1i rzr))
                       (f2cl-lib:fref cyi-%data% ((f2cl-lib:int-add k 1))
                                      ((1 n)) cyi-%offset%)))
           ...
           label50
            (setf rak (/ coner ak))
            (setf (f2cl-lib:fref cyr-%data% (k) ((1 n)) cyr-%offset%)
                    (* rak ptr rak))
            (setf (f2cl-lib:fref cyi-%data% (k) ((1 n)) cyi-%offset%)
                    (* (- rak) pti rak))
            (setf t1r (- t1r coner))

  ...
  (defun zseri (zr zi fnu kode n yr yi nz tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((wr (make-array 2 :element-type 'double-float))
             ...
             (hzr 0.0) (raz 0.0) (rs 0.0) (rtr1 0.0) (rzi 0.0) (rzr 0.0)
             (s 0.0) (ss 0.0) (sti 0.0) (str 0.0) (s1i 0.0) (s1r 0.0) (s2i 0.0)
             (s2r 0.0))
        (declare (type (array double-float (2)) wr wi)
                 (type (double-float) s2r s2i s1r s1i str sti ss s rzr rzi rtr1
                  rs raz hzr hzi fnup dfnu czr czi crscr coefr coefi ckr cki az
                  atol ascle arm ak1r ak1i ak acz aa)
       ...
       label30
        ...
        (setf (f2cl-lib:fref yr-%data% (nn) ((1 n)) yr-%offset%) zeror)
        (setf (f2cl-lib:fref yi-%data% (nn) ((1 n)) yi-%offset%) zeroi)
        (if (> acz dfnu)
            (go label190))
       ...
       label100
        (f2cl-lib:fdo (i ib (f2cl-lib:int-add i 1))
                      ((> i nn) nil)
          (tagbody
            (setf (f2cl-lib:fref yr-%data% (k) ((1 n)) yr-%offset%)
                    (+
                     (* (+ ak fnu)
                        (-
                         (* rzr
                            (f2cl-lib:fref yr-%data% ((f2cl-lib:int-add k 1))
                                           ((1 n)) yr-%offset%))
                         (* rzi
                            (f2cl-lib:fref yi-%data% ((f2cl-lib:int-add k 1))
                                           ((1 n)) yi-%offset%))))
                     (f2cl-lib:fref yr-%data% ((f2cl-lib:int-add k 2)) ((1 n))
                                    yr-%offset%)))
            (setf (f2cl-lib:fref yi-%data% (k) ((1 n)) yi-%offset%)
                    (+
                     (* (+ ak fnu)
                        (+
                         (* rzr
                         ...
                         (* rzi
                            (f2cl-lib:fref yr-%data% ((f2cl-lib:int-add k 1))
                                           ((1 n)) yr-%offset%))))
                     (f2cl-lib:fref yi-%data% ((f2cl-lib:int-add k 2)) ((1 n))
                                    yi-%offset%)))
            (setf ak (- ak 1.0))
       ...
       label120
        ...
        (f2cl-lib:fdo (l 3 (f2cl-lib:int-add l 1))
          ...
          (tagbody
            ...
            (setf ckr (* s2r crscr))
            (setf cki (* s2i crscr))
            (setf (f2cl-lib:fref yr-%data% (k) ((1 n)) yr-%offset%) ckr)
            (setf (f2cl-lib:fref yi-%data% (k) ((1 n)) yi-%offset%) cki)
            (setf ak (- ak 1.0))
            (setf k (f2cl-lib:int-sub k 1))
       ...
       label160
        (setf (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%) zeror)
        (setf (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) zeroi)
        (if (/= fnu 0.0)
            (go label170))
        (setf (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%) coner)
        (setf (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) conei)
       label170
        (if (= n 1)
            (go end_label))

  ...
  (defun dbesk (x fnu kode n y nz)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((w (make-array 2 :element-type 'double-float)) (cn 0.0) (dnu 0.0)
             ...
             (trx 0.0) (xlim 0.0) (zn 0.0) (i 0) (j 0) (k 0) (mz 0) (nb 0)
             (nd 0) (nn 0) (nud 0))
       ...
       label180
        ...
        (if (= kode 2)
            (go label190))
        (setf (f2cl-lib:fref y-%data% (j) ((1 *)) y-%offset%) (dbesk0 x))
        (go label200)
       label190
        (setf (f2cl-lib:fref y-%data% (j) ((1 *)) y-%offset%) (dbsk0e x))
       label200
        (if (= nd 1)
            (go label240))
        (setf j (f2cl-lib:int-add j 1))
       label210
        (if (= kode 2)
            (go label220))
        (setf (f2cl-lib:fref y-%data% (j) ((1 *)) y-%offset%) (dbesk1 x))
        (go label240)
       label220
        (setf (f2cl-lib:fref y-%data% (j) ((1 *)) y-%offset%) (dbsk1e x))
        (go label240)
       label230
       ...
       label310
        ...
        (go end_label)
       label320
        (xermsg "SLATEC" "DBESK" "OVERFLOW, FNU OR N TOO LARGE OR X TOO SMALL"
         6 1)
        (go end_label)
       end_label
  ...
  (setf (gethash 'fortran-to-lisp::dbesk fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::xermsg
                                              fortran-to-lisp::dbsknu
                                              fortran-to-lisp::dbsk1e
                                              fortran-to-lisp::dbesk1
                                              fortran-to-lisp::dbsk0e
                                              fortran-to-lisp::dbesk0
                                              fortran-to-lisp::dasyik

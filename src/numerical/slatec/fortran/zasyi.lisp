  ...
  (defun zasyi (zr zi fnu kode n yr yi nz rl tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (ib 0) (il 0) (inu 0) (j 0) (jl 0) (k 0) (koded 0) (m 0)
             ...
             (arm 0.0) (atol 0.0) (az 0.0) (bb 0.0) (bk 0.0) (cki 0.0)
             (ckr 0.0) (cs1i 0.0) (cs1r 0.0) (cs2i 0.0) (cs2r 0.0) (czi 0.0)
             (czr 0.0) (dfnu 0.0) (dki 0.0) (dkr 0.0) (dnu2 0.0) (ezi 0.0)
             (ezr 0.0) (fdn 0.0) (p1i 0.0) (p1r 0.0) (raz 0.0) (rtr1 0.0)
             (rzi 0.0) (rzr 0.0) (s 0.0) (sgn 0.0) (sqk 0.0) (sti 0.0)
             (str 0.0) (s2i 0.0) (s2r 0.0) (tzi 0.0) (tzr 0.0))
        (declare
         (type (double-float) tzr tzi s2r s2i str sti sqk sgn s rzr rzi rtr1
          raz p1r p1i fdn ezr ezi dnu2 dkr dki dfnu czr czi cs2r cs2i cs1r cs1i
          ckr cki bk bb az atol arm arg ak1r ak1i ak aez aa)
       ...
       label30
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (setf str
                    (-
                     (* (f2cl-lib:fref yr-%data% (i) ((1 n)) yr-%offset%) ckr)
                     (* (f2cl-lib:fref yi-%data% (i) ((1 n)) yi-%offset%)
                        cki)))
            (setf (f2cl-lib:fref yi-%data% (i) ((1 n)) yi-%offset%)
                    (+
                     (* (f2cl-lib:fref yr-%data% (i) ((1 n)) yr-%offset%) cki)
                     (* (f2cl-lib:fref yi-%data% (i) ((1 n)) yi-%offset%)
                        ckr)))
            (setf (f2cl-lib:fref yr-%data% (i) ((1 n)) yr-%offset%) str)
           label90))
        (go end_label)
       label100
        (setf nz -1)

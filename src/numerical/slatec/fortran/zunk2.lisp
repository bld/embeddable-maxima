...
(let ((zeror 0.0)
      ...
      (cipi
       (make-array 4 :element-type 'double-float :initial-contents
                   '(0.0 -1.0 0.0 1.0))))
  (declare
   (type (double-float) zeror zeroi coner cr1r cr1i cr2r cr2i hpi pi$ aic)
   (type (array double-float (4)) cipr cipi))
  (defun zunk2 (zr zi fnu kode mr n yr yi nz tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((bry (make-array 3 :element-type 'double-float))
             ...
             (str 0.0) (s1i 0.0) (s1r 0.0) (s2i 0.0) (s2r 0.0) (yy 0.0)
             (zbi 0.0) (zbr 0.0) (zet1di 0.0) (zet1dr 0.0) (zet2di 0.0)
             (zet2dr 0.0) (zni 0.0) (znr 0.0) (zri 0.0) (zrr 0.0))
        (declare (type (array double-float (3)) cssr csrr bry)
                 (type (array double-float (2)) zeta2r zeta2i zeta1r zeta1i
                  phir phii cyr cyi bsumr bsumi asumr asumi argr argi)
                 (type (double-float) zrr zri znr zni zet2dr zet2di zet1dr
                  zet1di zbr zbi yy s2r s2i s1r s1i str sti sgn sar rzr rzi rs1
                  razr rast ptr pti phidr phidi fnf fn fmr dair daii c2r c2m
                  c2i c1r c1i csr cspnr cspni csi csgni cscl crsc ckr cki car$
                  bsumdr bsumdi asumdr asumdi ascle asc argdr argdi aphi ang
                  air aii aarg)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
           ...
           label70
            ...
            (if (and
                 (=
                  (f2cl-lib:fref yr-%data% ((f2cl-lib:int-sub i 1)) ((1 n))
                                 yr-%offset%)
                  zeror)
                 (=
                  (f2cl-lib:fref yi-%data% ((f2cl-lib:int-sub i 1)) ((1 n))
                                 yi-%offset%)
                  zeroi))
                (go label80))
            (setf (f2cl-lib:fref yr-%data% ((f2cl-lib:int-sub i 1)) ((1 n))
                                 yr-%offset%)
                    zeror)
            (setf (f2cl-lib:fref yi-%data% ((f2cl-lib:int-sub i 1)) ((1 n))
                                 yi-%offset%)
                    zeroi)
            (setf nz (f2cl-lib:int-add nz 1))
           label80))
  ...
  (setf (gethash 'fortran-to-lisp::zunk2 fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::zs1s2
                                              ...
                                              fortran-to-lisp::zairy
                                              fortran-to-lisp::zabs
                                              fortran-to-lisp::zunhj

...
(let ((ntj1 0)
      ...
      (bj1cs
       (make-array 19 :element-type 'double-float :initial-contents
                   '(-0.11726141513332787 -0.2536152183079064
                     0.050127080984469566 -0.004631514809625082
                     2.47996229415914e-4 -8.678948686278825e-6
                     2.1429391714379368e-7 -3.93609307918318e-9
                     5.59118231794688e-11 -6.327616404661393e-13
                     5.840991610857247e-15 -4.4825338187012584e-17
                     2.9053844926250247e-19 -1.6117321978414417e-21
                     7.739478819392746e-24 -3.2486937821119987e-26
                     1.2022376772274103e-28 -3.952012212651349e-31
                     1.1616780822664534e-33)))
      (first$ nil))
  (declare (type (f2cl-lib:integer4) ntj1)
           (type (double-float) xsml xmin)
           (type (array double-float (19)) bj1cs)

  ...
  (defun zacai (zr zi fnu kode mr n yr yi nz rl tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cyr (make-array 2 :element-type 'double-float))
             ...
             (csgni 0.0) (cspnr 0.0) (cspni 0.0) (c1r 0.0) (c1i 0.0) (c2r 0.0)
             (c2i 0.0) (dfnu 0.0) (fmr 0.0) (sgn 0.0) (yy 0.0) (znr 0.0)
             (zni 0.0))
       ...
       label70
        (setf (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%)
                (- (+ (- (* cspnr c1r) (* cspni c1i)) (* csgnr c2r))
                   (* csgni c2i)))
        (setf (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%)
  ...
  (setf (gethash 'fortran-to-lisp::zacai fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              ...
                                              nil)
                                            :calls
                                            '(fortran-to-lisp::zs1s2
                                              fortran-to-lisp::d1mach
                                              fortran-to-lisp::zbknu
                                              fortran-to-lisp::zmlri
                                              fortran-to-lisp::zasyi
                                              fortran-to-lisp::zseri

...
(let ((ntj0 0)
      ...
      (bj0cs
       (make-array 19 :element-type 'double-float :initial-contents
                   '(0.10025416196893913 -0.6652230077644051 0.2489837034982813
                     -0.03325272317003577 0.0023114179304694017
                     -9.911277419950809e-5 2.891670864399881e-6
                     -6.121085866303263e-8 9.838650793856784e-10
                     -1.2423551597301765e-11 1.2654336302559046e-13
                     -1.0619456495287245e-15 7.470621075802456e-18
                     -4.469703227441278e-20 2.302428158433744e-22
                     -1.0319144794166698e-24 4.060817827487332e-27
                     -1.4143836005240915e-29 4.391090549669888e-32)))
      (first$ nil))
  (declare (type (f2cl-lib:integer4) ntj0)
           (type (double-float) xsml)
           (type (array double-float (19)) bj0cs)
  ...
  (defun dbesj0 (x)
    ...
    (prog ((ampl 0.0) (theta 0.0) (y 0.0) (dbesj0 0.0))
      ...
      (setf dbesj0 1.0)
      (if (> y xsml)
          (setf dbesj0 (dcsevl (- (* 0.125 y y) 1.0) bj0cs ntj0)))
      (go end_label)
     label20

...
(defun xermsg (librar subrou messg nerr level)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((lfirst
      ...
      (cond
       ((or (< nerr (f2cl-lib:int-sub 9999999)) (> nerr 99999999) (= nerr 0)
            (< level (f2cl-lib:int-sub 1)) (> level 2))
        (xerprn " ***" -1
         (f2cl-lib:f2cl-//
      ...
      (if (and (< level 2) (= lkntrl 0))
          (go label30))
      (if (and (= level 0) (> kount maxmes))
          (go label30))
      (if (and (= level 1) (> kount maxmes) (= mkntrl 1))
          (go label30))
      (if (and (= level 2)
               (> kount
     ...
     label30
      (if (or (<= level 0) (and (= level 1) (<= mkntrl 1)))
          (go end_label))
      (cond
       ((and (> lkntrl 0)
             (< kount
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::xermsg
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::xercnt
                                              fortran-to-lisp::xerhlt
                                              fortran-to-lisp::xersve
                                              fortran-to-lisp::xerprn

  ...
  (defun zuoik (zr zi fnu kode ikflg n yr yi nuf tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cwrkr (make-array 16 :element-type 'double-float))
             ...
             (sumi 0.0) (sumr 0.0) (zbi 0.0) (zbr 0.0) (zeta1i 0.0)
             (zeta1r 0.0) (zeta2i 0.0) (zeta2r 0.0) (zni 0.0) (znr 0.0)
             (zri 0.0) (zrr 0.0))
        (declare (type (array double-float (16)) cwrkr cwrki)
                 (type (double-float) zrr zri znr zni zeta2r zeta2i zeta1r
                  zeta1i zbr zbi sumr sumi sti str rcz phir phii gnu gnn fnn
                  czr czi bsumr bsumi ay ax ascle asumr asumi argr argi aphi
                  aarg)
       ...
       label70
        ...
        (if (= iform 2)
            (setf rcz (- rcz (* 0.25 (f2cl-lib:flog aarg)) aic)))
        (if (> rcz elim)
            (go label210))
        (go label130)
       label80

  ...
  (defun zacon (zr zi fnu kode mr n yr yi nz rl fnul tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cyr (make-array 2 :element-type 'double-float))
             ...
             (cscr 0.0) (csgni 0.0) (csgnr 0.0) (cspni 0.0) (cspnr 0.0)
             (csr 0.0) (c1i 0.0) (c1m 0.0) (c1r 0.0) (c2i 0.0) (c2r 0.0)
             (fmr 0.0) (fn 0.0) (pti 0.0) (ptr 0.0) (razn 0.0) (rzi 0.0)
             (rzr 0.0) (sc1i 0.0) (sc1r 0.0) (sc2i 0.0) (sc2r 0.0) (sgn 0.0)
             (spn 0.0) (sti 0.0) (str 0.0) (s1i 0.0) (s1r 0.0) (s2i 0.0)
             (s2r 0.0) (yy 0.0) (zni 0.0) (znr 0.0))
        (declare (type (array double-float (2)) cyr cyi)
                 (type (array double-float (3)) cssr csrr bry)
                 (type (double-float) znr zni yy s2r s2i s1r s1i str sti spn
                  sgn sc2r sc2i sc1r sc1i rzr rzi razn ptr pti fn fmr c2r c2i
                  c1r c1m c1i csr cspnr cspni csgnr csgni cscr cscl cpn ckr cki
                  bscle azn as2 ascle arg)
       ...
       label30
        ...
        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
          ...
          (setf ptr var-4)
          (setf pti var-5))
        (setf (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%) (+ str ptr))
        (setf (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) (+ sti pti))
        (if (= n 1)
            (go end_label))
        (setf cspnr (- cspnr))
        (setf cspni (- cspni))
        ...
        (setf c1r s2r)
        (setf c1i s2i)
        (setf c2r (f2cl-lib:fref yr-%data% (2) ((1 n)) yr-%offset%))
        (setf c2i (f2cl-lib:fref yi-%data% (2) ((1 n)) yi-%offset%))
        (if (= kode 1)
            (go label40))
        (multiple-value-bind
            (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
       ...
       label40
        ...
        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
          ...
          (setf ptr var-4)
          (setf pti var-5))
        (setf (f2cl-lib:fref yr-%data% (2) ((1 n)) yr-%offset%) (+ str ptr))
        (setf (f2cl-lib:fref yi-%data% (2) ((1 n)) yi-%offset%) (+ sti pti))
        (if (= n 2)
            (go end_label))
        (setf cspnr (- cspnr))
        (setf cspni (- cspni))
        ...
        (setf kflag 2)
        (if (> as2 (f2cl-lib:fref bry (1) ((1 3))))
            (go label50))
        (setf kflag 1)
        (go label60)
       label50
        (if (< as2 (f2cl-lib:fref bry (2) ((1 3))))
            (go label60))
        (setf kflag 3)
       label60
        ...
        (f2cl-lib:fdo (i 3 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf str c1r)
            (setf sti c1i)
            (setf c2r (f2cl-lib:fref yr-%data% (i) ((1 n)) yr-%offset%))
            (setf c2i (f2cl-lib:fref yi-%data% (i) ((1 n)) yi-%offset%))
            (if (= kode 1)
                (go label70))
            (if (< iuf 0)
                (go label70))

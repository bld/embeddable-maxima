  ...
  (defun dbsknu (x fnu kode n y nz)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((a (make-array 160 :element-type 'double-float))
             ...
             (fhs 0.0) (fk 0.0) (fks 0.0) (flrx 0.0) (fmu 0.0) (g1 0.0)
             (g2 0.0) (p 0.0) (pt 0.0) (p1 0.0) (p2 0.0) (q 0.0) (rx 0.0)
             (s 0.0) (smu 0.0) (sqk 0.0) (st 0.0) (s1 0.0) (s2 0.0) (tm 0.0)
             (tol 0.0) (t1 0.0) (t2 0.0) (i 0) (iflag 0) (inu 0) (j 0) (k 0)
             (kk 0) (koded 0) (nn 0))
        (declare (type (f2cl-lib:integer4) nn koded kk k j inu iflag i)
                 (type (double-float) t2 t1 tol tm s2 s1 st sqk smu s rx q p2
                  p1 pt p g2 g1 fmu flrx fks fk fhs fc f ex etest elim dnu2 dnu
                  dk cx coef ck bk a2 a1 ak)
                 (type (array double-float (160)) b a))
       ...
       label80
        ...
        (if (= koded 1)
            (go end_label))
        (setf (f2cl-lib:fref y-%data% (1) ((1 *)) y-%offset%) (* s1 (exp x)))
        (go end_label)
       label90
        (if (< x tol)
            (go label110))
       ...
       label220
        ...
        (setf (f2cl-lib:fref y-%data% (1) ((1 *)) y-%offset%) 0.0)
        (setf nz 1)
        (if (< s (- elim))
            (go label230))
        (setf (f2cl-lib:fref y-%data% (1) ((1 *)) y-%offset%) (exp s))
        (setf nz 0)
       label230
        (if (= n 1)
            (go end_label))
        (setf s (- (f2cl-lib:flog s2) x))
        (setf (f2cl-lib:fref y-%data% (2) ((1 *)) y-%offset%) 0.0)
        (setf nz (f2cl-lib:int-add nz 1))
        (if (< s (- elim))
            (go label240))
        (setf nz (f2cl-lib:int-sub nz 1))
        (setf (f2cl-lib:fref y-%data% (2) ((1 *)) y-%offset%) (exp s))
       label240
        (if (= n 2)
            (go end_label))
        (setf kk 2)
        ...
        (f2cl-lib:fdo (i 3 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (if (< s (- elim))
                (go label250))
            (setf (f2cl-lib:fref y-%data% (i) ((1 *)) y-%offset%) (exp s))
            (setf nz (f2cl-lib:int-sub nz 1))
            (go label260)
           label250))
        (go end_label)
       label260
        ...
        (setf (f2cl-lib:fref y-%data% (kk) ((1 *)) y-%offset%)

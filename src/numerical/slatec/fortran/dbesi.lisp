...
(let ((rttpi 0.398942280401433) (inlim 80))
  (declare (type (double-float) rttpi)
      ...
      (prog ((temp (make-array 3 :element-type 'double-float)) (ain 0.0)
        ...
        (declare (type (f2cl-lib:integer4) ns nn kt km kk k i1 is in ialp i)
                 ...
                 (type (double-float) z xo2l xo2 t2 trx tol tm tfn tb ta t$ s2
                  s1 sxo2 sx s ra gln fnu fnp1 fni fnf fn flgik etx elim earg
                  dx dtm dfn tolln atol arg ap ans akm ak ain))
        (setf nz 0)
        (setf kt 1)
        ...
        (f2cl-lib:arithmetic-if (f2cl-lib:int-sub n 1) (go label590)
       ...
       label280
        ...
        (setf dfn (+ fni fnf))
        (setf fn dfn)
        (f2cl-lib:arithmetic-if (f2cl-lib:int-sub nn 1) (go label340)
                                (go label290) (go label130))
       label290
        (setf kt 2)
        (setf is 2)
        (go label130)
       ...
       label400
        ...
        (f2cl-lib:fdo (i 3 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref y-%data% ((f2cl-lib:int-sub k 2)) ((1 *))
                                 y-%offset%)
                    (+
                     (* tm
                        (f2cl-lib:fref y-%data% ((f2cl-lib:int-sub k 1))
                                       ((1 *)) y-%offset%))
       ...
       label550
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i km) nil)
          (tagbody
            (setf (f2cl-lib:fref y-%data% ((f2cl-lib:int-sub k 1)) ((1 *))
                                 y-%offset%)
                    (+ (* tm (f2cl-lib:fref y-%data% (k) ((1 *)) y-%offset%))
                       (f2cl-lib:fref y-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                                      y-%offset%)))
            (setf dtm (- dtm 1.0))
            (setf tm (* (+ dtm fnf) trx))
            (setf k (f2cl-lib:int-sub k 1))

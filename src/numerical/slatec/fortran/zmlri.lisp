  ...
  (defun zmlri (zr zi fnu kode n yr yi nz tol)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (iaz 0) (idum 0) (ifnu 0) (inu 0) (itime 0) (k 0) (kk 0)
             ...
             (bk 0.0) (cki 0.0) (ckr 0.0) (cnormi 0.0) (cnormr 0.0) (fkap 0.0)
             (fkk 0.0) (flam 0.0) (fnf 0.0) (pti 0.0) (ptr 0.0) (p1i 0.0)
             (p1r 0.0) (p2i 0.0) (p2r 0.0) (raz 0.0) (rho 0.0) (rho2 0.0)
             (rzi 0.0) (rzr 0.0) (scle 0.0) (sti 0.0) (str 0.0) (sumi 0.0)
             (sumr 0.0) (tfnf 0.0) (tst 0.0))
        (declare
       ...
       label40
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf fkk (- fkk 1.0))
           label50))
        (setf (f2cl-lib:fref yr-%data% (n) ((1 n)) yr-%offset%) p2r)
        (setf (f2cl-lib:fref yi-%data% (n) ((1 n)) yi-%offset%) p2i)
        (if (= n 1)
            (go label70))
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref yr-%data% (m) ((1 n)) yr-%offset%) p2r)
            (setf (f2cl-lib:fref yi-%data% (m) ((1 n)) yi-%offset%) p2i)
           label60))
       label70
        (if (<= ifnu 0)
            (go label90))

...
(let ((nty1 0)
      ...
      (by1cs
       (make-array 20 :element-type 'double-float :initial-contents
                   '(0.032080471006119084 1.2627078974335004
                     0.006499961899923175 -0.08936164528860505
                     0.013250881221757096 -8.979059119648352e-4
                     3.647361487958307e-5 -1.0013743816660006e-6
                     1.994539657390174e-8 -3.023065601803382e-10
                     3.609878156947812e-12 -3.4874882972875824e-14
                     2.7838789715591767e-16 -1.8678709686194878e-18
                     1.0685315339116827e-20 -5.274721956684482e-23
                     2.2701994031556643e-25 -8.595390353945232e-28
                     2.8854043798337947e-30 -8.647541138937173e-33)))
      (twodpi 0.6366197723675814)
      (first$ nil))
  (declare (type (f2cl-lib:integer4) nty1)
           (type (double-float) xmin xsml twodpi)
           (type (array double-float (20)) by1cs)

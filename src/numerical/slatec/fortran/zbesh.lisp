...
(let ((hpi 1.5707963267948966))
  ...
  (defun zbesh (zr zi fnu kode m n cyr cyi nz ierr)
    (declare (type (array double-float (*)) cyi cyr)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (inu 0) (inuh 0) (ir 0) (k 0) (k1 0) (k2 0) (mm 0) (mr 0)
        ...
        (declare
         (type (double-float) csgni csgnr sti atol rtol ascle bb zti znr zni
          ufl tol str sgn r1m5 rl rhpi fnul fn fmm elim dig az arg aln alim aa)
       ...
       label60
        ...
        (if (= nn 0)
            (go label140))
       label70
        (if (or (< znr 0.0) (and (= znr 0.0) (< zni 0.0) (= m 2)))
            (go label80))
        (multiple-value-bind
          ...
          (declare
           (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-8 var-9
            var-10))
          (setf nz var-7))
        (go label110)
       label80
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zbesh fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :calls
                                            '(fortran-to-lisp::zbunk
                                              fortran-to-lisp::zacon
                                              fortran-to-lisp::zbknu

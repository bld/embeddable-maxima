...
(let ((x1 3.0)
      ...
      (cc
       (make-array 8 :element-type 'double-float :initial-contents
                   '(0.577215664901533 -0.0420026350340952 -0.0421977345555443
                     0.007218943246663 -2.152416741149e-4 -2.01348547807e-5
  ...
  (defun dbsynu (x fnu n y)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((a (make-array 120 :element-type 'double-float))
             ...
             (cb (make-array 120 :element-type 'double-float)) (ak 0.0)
             (arg 0.0) (a1 0.0) (a2 0.0) (bk 0.0) (cbk 0.0) (cck 0.0) (ck 0.0)
             (coef 0.0) (cpt 0.0) (cp1 0.0) (cp2 0.0) (cs 0.0) (cs1 0.0)
             (cs2 0.0) (cx 0.0) (dnu 0.0) (dnu2 0.0) (etest 0.0) (etx 0.0)
             (f 0.0) (fc 0.0) (fhs 0.0) (fk 0.0) (fks 0.0) (flrx 0.0) (fmu 0.0)
             (fn 0.0) (fx 0.0) (g 0.0) (g1 0.0) (g2 0.0) (p 0.0) (pt 0.0)
             (q 0.0) (rbk 0.0) (rck 0.0) (relb 0.0) (rpt 0.0) (rp1 0.0)
             (rp2 0.0) (rs 0.0) (rs1 0.0) (rs2 0.0) (rx 0.0) (s 0.0) (sa 0.0)
             (sb 0.0) (smu 0.0) (ss 0.0) (st 0.0) (s1 0.0) (s2 0.0) (tb 0.0)
             (tm 0.0) (tol 0.0) (t1 0.0) (t2 0.0) (i 0) (inu 0) (j 0) (k 0)
             (kk 0) (nn 0))
        (declare (type (f2cl-lib:integer4) nn kk k j inu i)
                 (type (double-float) t2 t1 tol tm tb s2 s1 st ss smu sb sa s
                  rx rs2 rs1 rs rp2 rp1 rpt relb rck rbk q pt p g2 g1 g fx fn
                  fmu flrx fks fk fhs fc f etx etest dnu2 dnu cx cs2 cs1 cs cp2
                  cp1 cpt coef ck cck cbk bk a2 a1 arg ak)
                 (type (array double-float (120)) rb cb a))
            ...
            (setf rp2
                    (/
                     (- (* (f2cl-lib:fref rb (kk) ((1 120))) rpt)
                        (* (f2cl-lib:fref cb (kk) ((1 120))) cpt) rp1)
       ...
       label150
        ...
        (setf rpt
                (+ dnu 0.5
                   (/ (- (+ (* rp1 (/ rp2 pt)) (* cp1 (/ cp2 pt)))) pt)))
        (setf cpt
                (+ x (/ (- (+ (* cp1 (/ rp2 pt)) (* -1 rp1 (/ cp2 pt)))) pt)))

...
(defun zwrsk (zrr zri fnu kode n yr yi nz cwr cwi tol elim alim)
  (declare (type (array double-float (*)) cwi cwr)
           (type (array double-float (*)) yi yr)
  ...
  (f2cl-lib:with-multi-array-data
      ((yr double-float yr-%data% yr-%offset%)
       ...
       (cwr double-float cwr-%data% cwr-%offset%)
       (cwi double-float cwi-%data% cwi-%offset%))
    (prog ((i 0) (nw 0) (act 0.0) (acw 0.0) (ascle 0.0) (cinui 0.0) (cinur 0.0)
     ...
     label10
      (setf acw
              (coerce
               (realpart
                (zabs (f2cl-lib:fref cwr-%data% (2) ((1 2)) cwr-%offset%)
     ...
     label20
      ...
      (setf csclr tol)
     label30
      (setf c1r (* (f2cl-lib:fref cwr-%data% (1) ((1 2)) cwr-%offset%) csclr))
      (setf c1i (* (f2cl-lib:fref cwi-%data% (1) ((1 2)) cwi-%offset%) csclr))
      (setf c2r (* (f2cl-lib:fref cwr-%data% (2) ((1 2)) cwr-%offset%) csclr))
      (setf c2i (* (f2cl-lib:fref cwi-%data% (2) ((1 2)) cwi-%offset%) csclr))
      ...
      (setf (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%) (* cinur csclr))
      (setf (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) (* cinui csclr))
      (if (= n 1)
          (go end_label))

  ...
  (defun zbinu (zr zi fnu kode n cyr cyi nz rl fnul tol elim alim)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cwr (make-array 2 :element-type 'double-float))
        ...
        (declare (type (array double-float (2)) cwr cwi)
       ...
       label80
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i nn) nil)
          (tagbody
            (setf (f2cl-lib:fref cyr-%data% (i) ((1 n)) cyr-%offset%) zeror)
            (setf (f2cl-lib:fref cyi-%data% (i) ((1 n)) cyi-%offset%) zeroi)
           label90))
        (go end_label)
       label100
        (if (> nw 0)
  ...
  (setf (gethash 'fortran-to-lisp::zbinu fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil
                                              ...
                                              nil nil)
                                            :calls
                                            '(fortran-to-lisp::zbuni
                                              fortran-to-lisp::zwrsk

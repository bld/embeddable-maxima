...
(let* ((newlin "$$"))
  ...
  (defun xerprn (prefix npref messg nwrap)
    ...
    (f2cl-lib:with-multi-array-data
        ((prefix character prefix-%data% prefix-%offset%)
      ...
      (prog ((iu (make-array 5 :element-type 'f2cl-lib:integer4)) (nunit 0)
             (cbuff
              (make-array '(148) :element-type 'character :initial-element
                          #\ ))
             (idelta 0) (lpiece 0) (nextc 0) (lenmsg 0) (lwrap 0) (lpref 0)
             (i 0) (n 0))
        (declare (type (array f2cl-lib:integer4 (5)) iu)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
           ...
           label10))
        (cond ((< npref 0) (setf lpref (f2cl-lib:len prefix)))
              (t (setf lpref npref)))
        (setf lpref
                (min (the f2cl-lib:integer4 16) (the f2cl-lib:integer4 lpref)))
        (if (/= lpref 0)
            (f2cl-lib:fset-string (f2cl-lib:fref-string cbuff (1 lpref))
                                  prefix))
        (setf lwrap
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (if (f2cl-lib:fstring-/=
                 (f2cl-lib:fref-string messg (lenmsg lenmsg)) " ")
                (go label30))
         ...
         ((= lenmsg 0)
          (f2cl-lib:fset-string
           (f2cl-lib:fref-string cbuff
                                 ((+ lpref 1) (f2cl-lib:int-add lpref 1)))
           " ")
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i nunit) nil)
            (tagbody
       ...
       label50
                   ...
                   ((f2cl-lib:fstring-=
                     (f2cl-lib:fref-string messg
                                           ((+ nextc i (f2cl-lib:int-sub 1))
                                            (f2cl-lib:int-add nextc i
                                                              (f2cl-lib:int-sub
                                                               1))))
                     " ")
                    (setf lpiece (f2cl-lib:int-sub i 1)) (setf idelta 1)
                    (go label54)))
                 label52))))
           label54
            (f2cl-lib:fset-string
             ...
             (f2cl-lib:fref-string messg
                                   (nextc
                                    (f2cl-lib:int-sub
                                     (f2cl-lib:int-add nextc lpiece) 1))))
            (setf nextc (f2cl-lib:int-add nextc lpiece idelta))))
         ((= lpiece 1) (setf nextc (f2cl-lib:int-add nextc 2)) (go label50))
             ...
             (f2cl-lib:fref-string messg
                                   (nextc
                                    (f2cl-lib:int-sub
                                     (f2cl-lib:int-add nextc lpiece) 1))))
            (setf nextc (f2cl-lib:int-add nextc lpiece idelta))))
         (t (setf lpiece (f2cl-lib:int-sub lpiece 1))
          (f2cl-lib:fset-string
           (f2cl-lib:fref-string cbuff
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i nunit) nil)
          (tagbody
            (f2cl-lib:fformat (f2cl-lib:fref iu (i) ((1 5))) (t (("~A")) "~%")
                              (f2cl-lib:fref-string cbuff
                                                    (1
                                                     (f2cl-lib:int-add lpref
                                                                       lpiece))))

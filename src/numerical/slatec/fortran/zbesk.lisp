...
(defun zbesk (zr zi fnu kode n cyr cyi nz ierr)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((k 0) (k1 0) (k2 0) (mr 0) (nn 0) (nuf 0) (nw 0) (aa 0.0) (alim 0.0)
           (aln 0.0) (arg 0.0) (az 0.0) (dig 0.0) (elim 0.0) (fn 0.0)
           (fnul 0.0) (rl 0.0) (r1m5 0.0) (tol 0.0) (ufl 0.0) (bb 0.0))
      (declare
       (type (double-float) bb ufl tol r1m5 rl fnul fn elim dig az arg aln alim
        aa)
       (type (f2cl-lib:integer4) nw nuf nn mr k2 k1 k))
      (setf ierr 0)
      (setf nz 0)
      (if (and (= zi 0.0f0) (= zr 0.0f0))
          (setf ierr 1))
      (if (< fnu 0.0)
          (setf ierr 1))
      (if (or (< kode 1) (> kode 2))

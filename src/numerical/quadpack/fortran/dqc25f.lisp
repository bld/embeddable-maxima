...
(let ((x
       (make-array 11 :element-type 'double-float :initial-contents
                   '(0.9914448613738104 0.9659258262890683 0.9238795325112867
                     0.8660254037844386 0.7933533402912352 0.7071067811865476
                     0.6087614290087207 0.5 0.3826834323650898
                     0.25881904510252074 0.1305261922200516))))
  ...
  (defun dqc25f
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cheb12 (make-array 13 :element-type 'double-float))
             ...
             (cons$ 0.0) (cospar 0.0) (dabs$ 0.0) (dcos$ 0.0) (dsin$ 0.0)
             (estc 0.0) (ests 0.0) (hlgth 0.0) (oflow 0.0) (parint 0.0)
             (par2 0.0) (par22 0.0) (p2 0.0) (p3 0.0) (p4 0.0) (resc12 0.0)
             (resc24 0.0) (ress12 0.0) (ress24 0.0) (sinpar 0.0))
        (declare (type (array double-float (28)) v)
                 ...
                 (type (double-float) sinpar ress24 ress12 resc24 resc12 p4 p3
                  p2 par22 par2 parint oflow hlgth ests estc dsin$ dcos$ dabs$
                  cospar cons$ conc centr ass asap as an2 an ac)
                 (type (f2cl-lib:integer4) noeq1 noequ m k j isym iers i))
        (setf oflow (f2cl-lib:d1mach 2))
        (setf centr (* 0.5 (+ b a)))
        (setf hlgth (* 0.5 (- b a)))
        (setf parint (* omega hlgth))
        (if (> (f2cl-lib:dabs parint) 2.0)
            (go label10))
        (multiple-value-bind
        ...
        (go label170)
       label10
        (setf conc (* hlgth (f2cl-lib:dcos (* centr omega))))
        (setf cons$ (* hlgth (f2cl-lib:dsin (* centr omega))))
        (setf resasc oflow)
        (setf neval 25)
        (if (or (< nrmom momcom) (= ksave 1))
            (go label120))
        (setf m (f2cl-lib:int-add momcom 1))
        (setf par2 (* parint parint))
        (setf par22 (+ par2 2.0))
        (setf sinpar (f2cl-lib:dsin parint))
        (setf cospar (f2cl-lib:dcos parint))
                    ...
                    (/
                     (+
                      (* (- an2 4.0)
                         (-
                          (* 2.0 (- par22 an2 an2)
                             (f2cl-lib:fref v ((f2cl-lib:int-sub i 1))
                                            ((1 28))))
                          ac))
                      as
                      (* (- par2) (+ an 1.0) (+ an 2.0)
       ...
       label100
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                      ((> j 12) nil)
          (tagbody
            (setf (f2cl-lib:fref chebmo-%data% (m (f2cl-lib:int-mul 2 j))
                                 ((1 maxp1) (1 25)) chebmo-%offset%)
                    (f2cl-lib:fref v (j) ((1 28))))
           label110))
       label120
        (if (< nrmom momcom)
            (setf m (f2cl-lib:int-add nrmom 1)))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref fval (i) ((1 25)))
                    (funcall f
                             (+
                              (* hlgth
                                 (f2cl-lib:fref x ((f2cl-lib:int-sub i 1))
                                                ((1 11))))
                              centr)))
        ...
        (setf resc12
                (* (f2cl-lib:fref cheb12 (13) ((1 13)))
                   (f2cl-lib:fref chebmo-%data% (m 13) ((1 maxp1) (1 25))
                                  chebmo-%offset%)))
        (setf ress12 0.0)
        (setf k 11)
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (setf resc12
                    (+ resc12
                       (* (f2cl-lib:fref cheb12 (k) ((1 13)))
                          (f2cl-lib:fref chebmo-%data% (m k) ((1 maxp1) (1 25))
                                         chebmo-%offset%))))
            (setf ress12
                    (+ ress12
                       (*
                        (f2cl-lib:fref cheb12 ((f2cl-lib:int-add k 1))
                                       ((1 13)))
                        (f2cl-lib:fref chebmo-%data% (m (f2cl-lib:int-add k 1))
                                       ((1 maxp1) (1 25)) chebmo-%offset%))))
            (setf k (f2cl-lib:int-sub k 2))
           label140))
        (setf resc24
                (* (f2cl-lib:fref cheb24 (25) ((1 25)))
                   (f2cl-lib:fref chebmo-%data% (m 25) ((1 maxp1) (1 25))
                                  chebmo-%offset%)))
        (setf ress24 0.0)
        (setf resabs (f2cl-lib:dabs (f2cl-lib:fref cheb24 (25) ((1 25)))))
        (setf k 23)
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                      ((> j 12) nil)
          (tagbody
            ...
            (setf ress24
                    (+ ress24
                       (*
                        (f2cl-lib:fref cheb24 ((f2cl-lib:int-add k 1))
                                       ((1 25)))
                        (f2cl-lib:fref chebmo-%data% (m (f2cl-lib:int-add k 1))
                                       ((1 maxp1) (1 25)) chebmo-%offset%))))
            (setf resabs
                    (+ (f2cl-lib:dabs (f2cl-lib:fref cheb24 (k) ((1 25))))
                       (f2cl-lib:dabs
                        (f2cl-lib:fref cheb24 ((f2cl-lib:int-add k 1))
                                       ((1 25))))))
            (setf k (f2cl-lib:int-sub k 2))
           label150))
        (setf estc (f2cl-lib:dabs (- resc24 resc12)))
        (setf ests (f2cl-lib:dabs (- ress24 ress12)))
        (setf resabs (* resabs (f2cl-lib:dabs hlgth)))
        (if (= integr 2)
            (go label160))
        (setf result (- (* conc resc24) (* cons$ ress24)))
        (setf abserr
                (+ (f2cl-lib:dabs (* conc estc))
                   (f2cl-lib:dabs (* cons$ ests))))
        (go label170)
       label160
        (setf result (+ (* conc ress24) (* cons$ resc24)))
        (setf abserr
                (+ (f2cl-lib:dabs (* conc ests))
                   (f2cl-lib:dabs (* cons$ estc))))
       label170
        (go end_label)
       end_label
        (return
         (values nil nil nil omega integr nil nil nil result abserr neval
                 resabs resasc momcom nil))))))

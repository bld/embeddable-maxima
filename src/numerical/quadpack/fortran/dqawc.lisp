    ...
    (prog ((lvl 0) (l1 0) (l2 0) (l3 0))
      ...
      (multiple-value-bind
          ...
          (dqawce f a b c epsabs epsrel limit result abserr neval ier
           ...
           iwork last$)
        (declare
         (ignore var-0 var-1 var-2 var-4 var-5 var-6 var-11 var-12 var-13
          var-14 var-15))
        (setf c var-3)
        (setf result var-7)
        (setf abserr var-8)
     ...
     end_label
      (return
       (values nil nil nil c nil nil result abserr neval ier nil nil last$ nil
               nil)))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dqawc fortran-to-lisp::*f2cl-function-info*)

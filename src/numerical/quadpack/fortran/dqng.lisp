...
(let ((x1
       (make-array 5 :element-type 'double-float :initial-contents
                   '(0.9739065285171717 0.8650633666889845 0.6794095682990244
                     0.4333953941292472 0.14887433898163122)))
      (w10
       (make-array 5 :element-type 'double-float :initial-contents
                   '(0.06667134430868814 0.1494513491505806 0.21908636251598204
                     0.26926671930999635 0.29552422471475287)))
      (x2
       (make-array 5 :element-type 'double-float :initial-contents
                   '(0.9956571630258081 0.9301574913557082 0.7808177265864169
                     0.5627571346686047 0.2943928627014602)))
      (w21a
       (make-array 5 :element-type 'double-float :initial-contents
                   '(0.032558162307964725 0.07503967481091996
                     0.10938715880229764 0.13470921731147334
                     0.14773910490133849)))
      (w21b
       (make-array 6 :element-type 'double-float :initial-contents
                   '(0.011694638867371874 0.054755896574351995
                     0.0931254545836976 0.12349197626206584 0.14277593857706009
                     0.1494455540029169)))
      (x3
       (make-array 11 :element-type 'double-float :initial-contents
                   '(0.999333360901932 0.9874334029080889 0.9548079348142663
                     0.9001486957483283 0.8251983149831141 0.732148388989305
                     0.6228479705377252 0.4994795740710565 0.36490166134658075
                     0.2222549197766013 0.07465061746138332)))
      (w43a
       (make-array 10 :element-type 'double-float :initial-contents
                   '(0.016296734289666565 0.0375228761208695
                     0.05469490205825544 0.06735541460947808
                     0.07387019963239395 0.005768556059769796
                     0.027371890593248842 0.04656082691042883
                     0.06174499520144257 0.07138726726869339)))
      (w43b
       (make-array 12 :element-type 'double-float :initial-contents
                   '(0.001844477640212414 0.010798689585891651
                     0.021895363867795427 0.032597463975345686
                     0.04216313793519181 0.050741939600184575
                     0.05837939554261925 0.06474640495144589
                     0.06956619791235648 0.07282444147183322
                     0.07450775101417512 0.07472214751740301)))
      (x4
       (make-array 22 :element-type 'double-float :initial-contents
                   '(0.9999029772627293 0.9979898959866788 0.9921754978606873
                     0.9813581635727128 0.9650576238583847 0.9431676131336706
                     0.9158064146855072 0.8832216577713164 0.8457107484624157
                     0.8035576580352309 0.7570057306854956 0.7062732097873218
                     0.6515894665011779 0.5932233740579611 0.531493605970832
                     0.46676362304202285 0.3994248478592188 0.3298748771061883
                     0.25850355920216156 0.18569539656834666
                     0.11184221317990747 0.03735212339461987)))
      (w87a
       (make-array 21 :element-type 'double-float :initial-contents
                   '(0.008148377384149173 0.018761438201562824
                     0.027347451050052287 0.03367770731163793
                     0.036935099820427905 0.0028848724302115306
                     0.013685946022712702 0.02328041350288831
                     0.03087249761171336 0.03569363363941877
                     9.152833452022414e-4 0.005399280219300471
                     0.01094767960111893 0.016298731696787336
                     0.021081568889203834 0.025370969769253827
      ...
      (w87b
       (make-array 23 :element-type 'double-float :initial-contents
                   '(2.7414556376207234e-4 0.0018071241550579428
                     0.0040968692827591646 0.006758290051847379
                     0.009549957672201646 0.012329447652244854
                     0.015010447346388952 0.01754896798624319
                     0.019938037786440887 0.022194935961012286
                     0.024339147126000805 0.026374505414839208
                     0.0282869107887712 0.030052581128092695
                     0.03164675137143993 0.033050413419978504
  ...
  (defun dqng (f a b epsabs epsrel result abserr neval ier)
    ...
    (prog ((fv1 (make-array 5 :element-type 'double-float))
           ...
           (l 0) (absc 0.0) (centr 0.0) (dabs$ 0.0) (dhlgth 0.0) (dmax1$ 0.0)
           (dmin1$ 0.0) (epmach 0.0) (fcentr 0.0) (fval 0.0) (fval1 0.0)
           (fval2 0.0) (hlgth 0.0) (res10 0.0) (res21 0.0) (res43 0.0)
           (res87 0.0) (resabs 0.0) (resasc 0.0) (reskh 0.0) (uflow 0.0))
      (declare (type (array double-float (21)) savfun)
               ...
               (type (double-float) uflow reskh resasc resabs res87 res43 res21
                res10 hlgth fval2 fval1 fval fcentr epmach dmin1$ dmax1$ dhlgth
                dabs$ centr absc)
         ...
         label65
          (if (and (/= resasc 0.0) (/= abserr 0.0))
              (setf abserr
                      (* resasc
                         (f2cl-lib:dmin1 1.0
                                         (expt (/ (* 200.0 abserr) resasc)
                                               1.5)))))
          (if (> resabs (/ uflow (* 50.0 epmach)))
              (setf abserr (f2cl-lib:dmax1 (* epmach 50.0 resabs) abserr)))
          (if (<= abserr

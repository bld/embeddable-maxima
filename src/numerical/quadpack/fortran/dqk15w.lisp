...
(let ((xgk
       (make-array 8 :element-type 'double-float :initial-contents
                   '(0.9914553711208126 0.9491079123427585 0.8648644233597691
                     0.7415311855993943 0.5860872354676911 0.4058451513773972
                     0.2077849550078985 0.0)))
      (wgk
       (make-array 8 :element-type 'double-float :initial-contents
                   '(0.02293532201052922 0.06309209262997854 0.1047900103222502
  ...
  (defun dqk15w (f w p1 p2 p3 p4 kp a b result abserr resabs resasc)
    ...
    (prog ((fv1 (make-array 7 :element-type 'double-float))
           ...
           (jtwm1 0) (absc 0.0) (absc1 0.0) (absc2 0.0) (centr 0.0) (dabs$ 0.0)
           (dhlgth 0.0) (dmax1$ 0.0) (dmin1$ 0.0) (epmach 0.0) (fc 0.0)
      ...
      (declare (type (array double-float (7)) fv2 fv1)
               (type (double-float) uflow reskh resk resg hlgth fval2 fval1
                fsum fc epmach dmin1$ dmax1$ dhlgth dabs$ centr absc2 absc1
                absc)

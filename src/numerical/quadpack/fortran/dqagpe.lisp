...
(defun dqagpe
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
           ...
           (b2 0.0) (correc 0.0) (dabs$ 0.0) (defabs 0.0) (defab1 0.0)
           (defab2 0.0) (dmax1$ 0.0) (dmin1$ 0.0) (dres 0.0) (epmach 0.0)
           (erlarg 0.0) (erlast 0.0) (errbnd 0.0) (errmax 0.0) (error1 0.0)
           (erro12 0.0) (error2 0.0) (errsum 0.0) (ertest 0.0) (oflow 0.0)
           (resa 0.0) (resabs 0.0) (reseps 0.0) (sign$ 0.0) (temp 0.0)
           (uflow 0.0) (nint$ 0))
      (declare (type (array double-float (52)) rlist2)
               ...
               (type (double-float) uflow temp sign$ reseps resabs resa oflow
                ...
                epmach dres dmin1$ dmax1$ defab2 defab1 defabs dabs$ correc b2
                b1 a2 a1 area2 area12 area1 area abseps)
               (type (f2cl-lib:integer4) nint$ numrl2 nrmax nres npts nintp1
                maxerr levmax levcur ktmin ksgn k jupbnd jlow j iroff3 iroff2
                iroff1 ip1 ind2 ind1 ierro id i)
      ...
      (setf (f2cl-lib:fref level-%data% (1) ((1 limit)) level-%offset%) 0)
      (setf npts (f2cl-lib:int-sub npts2 2))
      (if (or (< npts2 2) (<= limit npts)
              (and (<= epsabs 0.0)
      ...
      (if (> a b)
          (setf sign$ -1.0))
      (setf (f2cl-lib:fref pts-%data% (1) ((1 npts2)) pts-%offset%)
              (f2cl-lib:dmin1 a b))
      (if (= npts 0)
          (go label15))
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                    ((> i npts) nil)
        (tagbody
          (setf (f2cl-lib:fref pts-%data% ((f2cl-lib:int-add i 1)) ((1 npts2))
                               pts-%offset%)
                  (f2cl-lib:fref points-%data% (i) ((1 npts2))
                                 points-%offset%))
         label10))
     label15
      (setf (f2cl-lib:fref pts-%data% ((f2cl-lib:int-add npts 2)) ((1 npts2))
                           pts-%offset%)
              (f2cl-lib:dmax1 a b))
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (j ip1 (f2cl-lib:int-add j 1))
                        ((> j nintp1) nil)
            (tagbody
              (if (<= (f2cl-lib:fref pts-%data% (i) ((1 npts2)) pts-%offset%)
                      (f2cl-lib:fref pts-%data% (j) ((1 npts2)) pts-%offset%))
                  (go label20))
              (setf temp
                      (f2cl-lib:fref pts-%data% (i) ((1 npts2)) pts-%offset%))
              (setf (f2cl-lib:fref pts-%data% (i) ((1 npts2)) pts-%offset%)
                      (f2cl-lib:fref pts-%data% (j) ((1 npts2)) pts-%offset%))
              (setf (f2cl-lib:fref pts-%data% (j) ((1 npts2)) pts-%offset%)
                      temp)
             label20))))
     label20
      (if (or
     ...
     label40
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          (setf b1
                  (f2cl-lib:fref pts-%data% ((f2cl-lib:int-add i 1))
                                 ((1 npts2)) pts-%offset%))
          ...
          (setf (f2cl-lib:fref ndin-%data% (i) ((1 npts2)) ndin-%offset%) 0)
          (if (and (= error1 resa) (/= error1 0.0))
              (setf (f2cl-lib:fref ndin-%data% (i) ((1 npts2)) ndin-%offset%)
                      1))
          (setf resabs (+ resabs defabs))
          (setf (f2cl-lib:fref level-%data% (i) ((1 limit)) level-%offset%) 0)
          (setf (f2cl-lib:fref elist-%data% (i) ((1 limit)) elist-%offset%)
                  error1)
          (setf (f2cl-lib:fref alist-%data% (i) ((1 limit)) alist-%offset%) a1)
          (setf (f2cl-lib:fref blist-%data% (i) ((1 limit)) blist-%offset%) b1)
          (setf (f2cl-lib:fref rlist-%data% (i) ((1 limit)) rlist-%offset%)
                  area1)
          (setf (f2cl-lib:fref iord-%data% (i) ((1 limit)) iord-%offset%) i)
          (setf a1 b1)
         label50))
      (setf errsum 0.0)
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf errsum
                  (+ errsum
                     (f2cl-lib:fref elist-%data% (i) ((1 limit))
                                    elist-%offset%)))
         label55))
      (setf last$ nint$)
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (j jlow (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf ind2
                      (f2cl-lib:fref iord-%data% (j) ((1 limit))
                                     iord-%offset%))
              (if (>
                   (f2cl-lib:fref elist-%data% (ind1) ((1 limit))
                                  elist-%offset%)
                   (f2cl-lib:fref elist-%data% (ind2) ((1 limit))
                                  elist-%offset%))
                  (go label60))
              (setf ind1 ind2)
              (setf k j)
          ...
          (if (= ind1
              ...
              (go label70))
          (setf (f2cl-lib:fref iord-%data% (k) ((1 limit)) iord-%offset%)
                  (f2cl-lib:fref iord-%data% (i) ((1 limit)) iord-%offset%))
          (setf (f2cl-lib:fref iord-%data% (i) ((1 limit)) iord-%offset%) ind1)
         label70))
      (if (< limit npts2)
          (setf ier 1))
     label80
      ...
      (f2cl-lib:fdo (last$ npts2 (f2cl-lib:int-add last$ 1))
        ...
        (tagbody
          (setf levcur
                  (f2cl-lib:int-add
                   (f2cl-lib:fref level-%data% (maxerr) ((1 limit))
                                  level-%offset%)
                   1))
          (setf a1
         ...
         label95
          (setf (f2cl-lib:fref level-%data% (maxerr) ((1 limit))
                               level-%offset%)
                  levcur)
          (setf (f2cl-lib:fref level-%data% (last$) ((1 limit)) level-%offset%)
                  levcur)
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil nil result abserr neval ier nil nil
               nil nil nil nil nil nil last$)))))

  ...
  (defun dqc25s
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cheb12 (make-array 13 :element-type 'double-float))
             ...
             (centr 0.0) (dabs$ 0.0) (dc 0.0) (dlog$ 0.0) (factor 0.0)
             (fix 0.0) (hlgth 0.0) (resabs 0.0) (res12 0.0) (res24 0.0)
             (u 0.0))
        (declare (type (array double-float (25)) fval cheb24)
                 (type (array double-float (13)) cheb12)
                 (type (double-float) u res24 res12 resabs hlgth fix factor
                  dlog$ dc dabs$ centr)
       ...
       label70
        ...
        (setf (f2cl-lib:fref fval (13) ((1 25)))
                (* (f2cl-lib:fref fval (13) ((1 25))) (f2cl-lib:dlog fix)))
        (setf (f2cl-lib:fref fval (25) ((1 25)))
       ...
       end_label
        (return
         (values nil a b nil nil alfa beta nil nil nil nil result abserr resasc
                 integr nev))))))

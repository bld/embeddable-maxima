  ...
  (defun dqawfe
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((psum (make-array 52 :element-type 'double-float))
             ...
             (correc 0.0) (cycle 0.0) (c1 0.0) (c2 0.0) (dabs$ 0.0) (dl 0.0)
             (dla 0.0) (dmax1$ 0.0) (drl 0.0) (ep 0.0) (eps 0.0) (epsa 0.0)
             (errsum 0.0) (fact 0.0) (p1 0.0) (reseps 0.0) (uflow 0.0)
             (last$ 0))
        (declare (type (array double-float (3)) res3la)
                 ...
                 (type (double-float) uflow reseps p1 fact errsum epsa eps ep
                  drl dmax1$ dla dl dabs$ c2 c1 cycle correc abseps)
        ...
        (if (= integr 1)
            (multiple-value-bind
                ...
                (dqagie f 0.0 1 epsabs 0.0 limit result abserr neval ier alist
              ...
              (setf ier var-9)
              (setf last$ var-15)))
        (setf (f2cl-lib:fref rslst-%data% (1) ((1 limlst)) rslst-%offset%)
                result)
        (setf (f2cl-lib:fref erlst-%data% (1) ((1 limlst)) erlst-%offset%)
                abserr)
        (setf (f2cl-lib:fref ierlst-%data% (1) ((1 limlst)) ierlst-%offset%)
                ier)
        (setf lst 1)
        (go label999)
       label10
          ...
          (tagbody
            ...
            (multiple-value-bind
                ...
                (dqawoe f c1 c2 omega integr epsa 0.0 limit lst maxp1
                 ...
                 nev
                 (f2cl-lib:fref ierlst-%data% (lst) ((1 limlst))
                                ierlst-%offset%)
              ...
              (setf integr var-4)
              (setf (f2cl-lib:fref rslst-%data% (lst) ((1 limlst))
                                   rslst-%offset%)
                      var-10)
              (setf (f2cl-lib:fref erlst-%data% (lst) ((1 limlst))
                                   erlst-%offset%)
                      var-11)
              (setf nev var-12)
              (setf (f2cl-lib:fref ierlst-%data% (lst) ((1 limlst))
                                   ierlst-%offset%)
                      var-13)
              (setf last$ var-14)
              (setf momcom var-21))
            ...
            (setf errsum
                    (+ errsum
                       (f2cl-lib:fref erlst-%data% (lst) ((1 limlst))
                                      erlst-%offset%)))
            (setf drl
                    (* 50.0
                       (f2cl-lib:dabs
                        (f2cl-lib:fref rslst-%data% (lst) ((1 limlst))
                                       rslst-%offset%))))
            (if (and (<= (+ errsum drl) epsabs) (>= lst 6))
                (go label80))
            (setf correc
                    (f2cl-lib:dmax1 correc
                                    (f2cl-lib:fref erlst-%data% (lst)
                                                   ((1 limlst))
                                                   erlst-%offset%)))
            (if (/=
                 (f2cl-lib:fref ierlst-%data% (lst) ((1 limlst))
            ...
            (setf (f2cl-lib:fref psum (1) ((1 52)))
                    (f2cl-lib:fref rslst-%data% (1) ((1 limlst))
                                   rslst-%offset%))
            (go label40)
           label20
            ...
            (if (and (>= ktmin 15) (<= abserr (* 0.001 (+ errsum drl))))
                (setf ier 4))
            (if (and (> abseps abserr) (/= lst 3))
                (go label30))
            (setf abserr abseps)
            (setf result reseps)
            (setf ktmin 0)
            (if (or (<= (+ abserr (* 10.0 correc)) epsabs)
       ...
       label60
        ...
        (if (= ier 0)
            (go label999))
        (if (and (/= result 0.0)
                 (/= (f2cl-lib:fref psum (numrl2) ((1 52))) 0.0))
            (go label70))
        (if (> abserr errsum)
            (go label80))
        (if (= (f2cl-lib:fref psum (numrl2) ((1 52))) 0.0)
            (go label999))
       label70
        (if (> (/ abserr (f2cl-lib:dabs result))
               (/ (+ errsum drl)
                  (f2cl-lib:dabs (f2cl-lib:fref psum (numrl2) ((1 52))))))
            (go label80))
        (if (and (>= ier 1) (/= ier 7))
            (setf abserr (+ abserr drl)))
        (go label999)
       label80
       ...
       end_label
        (return
         (values nil nil nil integr nil nil nil nil result abserr neval ier nil
                 nil nil lst nil nil nil nil nil nil nil))))))
  ...
  (setf (gethash 'fortran-to-lisp::dqawfe
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil
                                              ...
                                              fortran-to-lisp::lst nil nil nil
                                              nil nil nil nil)
                                            :calls
                                            '(fortran-to-lisp::dqelg
                                              fortran-to-lisp::dqawoe
                                              fortran-to-lisp::d1mach
                                              fortran-to-lisp::dqagie))))

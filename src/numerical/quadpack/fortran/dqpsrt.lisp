...
(defun dqpsrt (limit last$ maxerr ermax elist iord nrmax)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ibeg 0) (ido 0) (isucc 0) (j 0) (jbnd 0) (jupbn 0) (k 0)
      ...
      (if (> last$ 2)
          (go label10))
      (setf (f2cl-lib:fref iord-%data% (1) ((1 last$)) iord-%offset%) 1)
      (setf (f2cl-lib:fref iord-%data% (2) ((1 last$)) iord-%offset%) 2)
      (go label90)
     label10
      (setf errmax
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          (setf isucc
                  (f2cl-lib:fref iord-%data% ((f2cl-lib:int-sub nrmax 1))
                                 ((1 last$)) iord-%offset%))
          (if (<= errmax
                  (f2cl-lib:fref elist-%data% (isucc) ((1 last$))
                                 elist-%offset%))
              (go label30))
          (setf (f2cl-lib:fref iord-%data% (nrmax) ((1 last$)) iord-%offset%)
                  isucc)
        ...
        (tagbody
          ...
          (if (>= errmax
                  (f2cl-lib:fref elist-%data% (isucc) ((1 last$))
                                 elist-%offset%))
              (go label60))
          (setf (f2cl-lib:fref iord-%data% ((f2cl-lib:int-sub i 1)) ((1 last$))
                               iord-%offset%)
                  isucc)
         label40))
     label50
      (setf (f2cl-lib:fref iord-%data% (jbnd) ((1 last$)) iord-%offset%)
              maxerr)
      (setf (f2cl-lib:fref iord-%data% (jupbn) ((1 last$)) iord-%offset%)
              last$)
      (go label90)
     label60
      (setf (f2cl-lib:fref iord-%data% ((f2cl-lib:int-sub i 1)) ((1 last$))
        ...
        (tagbody
          ...
          (if (< errmin
                 (f2cl-lib:fref elist-%data% (isucc) ((1 last$))
                                elist-%offset%))
              (go label80))
          (setf (f2cl-lib:fref iord-%data% ((f2cl-lib:int-add k 1)) ((1 last$))
                               iord-%offset%)
                  isucc)
          (setf k (f2cl-lib:int-sub k 1))
         label70))
      (setf (f2cl-lib:fref iord-%data% (i) ((1 last$)) iord-%offset%) last$)
      (go label90)
     label80
      (setf (f2cl-lib:fref iord-%data% ((f2cl-lib:int-add k 1)) ((1 last$))
                           iord-%offset%)
  ...
  (setf (gethash 'fortran-to-lisp::dqpsrt
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '((fortran-to-lisp::integer4)
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(nil nil fortran-to-lisp::maxerr

...
(let ((wg
       (make-array 8 :element-type 'double-float :initial-contents
                   '(0.0 0.1294849661688697 0.0 0.27970539148927664 0.0
                     0.3818300505051189 0.0 0.4179591836734694)))
      (xgk
       (make-array 8 :element-type 'double-float :initial-contents
      ...
      (wgk
       (make-array 8 :element-type 'double-float :initial-contents
                   '(0.022935322010529224 0.06309209262997856
                     0.10479001032225019 0.14065325971552592 0.1690047266392679
                     0.19035057806478542 0.20443294007529889
                     0.20948214108472782))))
  ...
  (defun dqk15i (f boun inf a b result abserr resabs resasc)
    ...
    (prog ((fv1 (make-array 7 :element-type 'double-float))
           ...
           (absc1 0.0) (absc2 0.0) (centr 0.0) (dabs$ 0.0) (dinf 0.0)
      ...
      (declare (type (array double-float (7)) fv2 fv1)
               (type (double-float) uflow tabsc2 tabsc1 reskh resk resg hlgth
                fval2 fval1 fsum fc epmach dmin1$ dmax1$ dinf dabs$ centr absc2
                absc1 absc)

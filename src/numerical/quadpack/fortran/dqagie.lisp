...
(defun dqagie
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
           ...
           (area2 0.0) (a1 0.0) (a2 0.0) (boun 0.0) (b1 0.0) (b2 0.0)
           (correc 0.0) (dabs$ 0.0) (defabs 0.0) (defab1 0.0) (defab2 0.0)
           (dmax1$ 0.0) (dres 0.0) (epmach 0.0) (erlarg 0.0) (erlast 0.0)
      ...
      (declare (type (array double-float (52)) rlist2)
               ...
               (type (double-float) uflow small reseps resabs oflow ertest
                errsum erro12 error2 error1 errmax errbnd erlast erlarg epmach
                dres dmax1$ defab2 defab1 defabs dabs$ correc b2 b1 boun a2 a1
      ...
      (setf result 0.0)
      (setf abserr 0.0)
      (setf (f2cl-lib:fref alist-%data% (1) ((1 limit)) alist-%offset%) 0.0)
      (setf (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%) 1.0)
      ...
      (if (= limit 1)
          (setf ier 1))
      (if (or (/= ier 0) (and (<= abserr errbnd) (/= abserr resabs))
              (= abserr 0.0))
          (go label130))
     ...
     label130
      ...
      (if (= inf 2)
          (setf neval (f2cl-lib:int-mul 2 neval)))
      (if (> ier 2)
     ...
     end_label
      (return
       (values nil nil nil nil nil nil result abserr neval ier nil nil nil nil
               nil last$)))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dqagie

...
(let ((wg
       (make-array 15 :element-type 'double-float :initial-contents
                   '(0.007968192496166605 0.01846646831109096
                     ...
                     0.08689978720108298 0.09212252223778612
                     0.09636873717464425 0.09959342058679527 0.1017623897484055
                     0.10285265289355884)))
      (xgk
       (make-array 31 :element-type 'double-float :initial-contents
                   '(0.9994844100504906 0.9968934840746495 0.9916309968704046
      ...
      (wgk
       (make-array 31 :element-type 'double-float :initial-contents
                   '(0.0013890136986770077 0.003890461127099884
                     0.0066307039159312926 0.009273279659517764
                     0.011823015253496341 0.014369729507045804
                     0.01692088918905327 0.019414141193942382
                     0.021828035821609193 0.0241911620780806 0.0265099548823331
                     0.02875404876504129 0.030907257562387762
                     0.03298144705748372 0.034979338028060025
                     0.03688236465182123 0.038678945624727595
                     0.040374538951535956 0.041969810215164244
                     0.04345253970135607 0.04481480013316266
                     0.04605923827100699 0.04718554656929915
                     0.04818586175708713 0.04905543455502978
                     0.04979568342707421 0.05040592140278235
                     0.05088179589874961 0.051221547849258774
                     0.05142612853745902 0.05149472942945157))))
  ...
  (defun dqk61 (f a b result abserr resabs resasc)
    ...
    (prog ((fv1 (make-array 30 :element-type 'double-float))
           ...
           (jtwm1 0) (dabsc 0.0) (centr 0.0) (dabs$ 0.0) (dhlgth 0.0)
      ...
      (declare (type (array double-float (30)) fv2 fv1)
               (type (double-float) uflow reskh resk resg hlgth fval2 fval1
                fsum fc epmach dmin1$ dmax1$ dhlgth dabs$ centr dabsc)

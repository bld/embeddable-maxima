...
(defun dqawf
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((last$ 0) (limit 0) (ll2 0) (lvl 0) (l1 0) (l2 0) (l3 0) (l4 0)
           (l5 0) (l6 0))
      (declare
       (type (f2cl-lib:integer4) l6 l5 l4 l3 l2 l1 lvl ll2 limit last$))
      (setf ier 6)
      (setf neval 0)
      (setf last$ 0)
      (setf result 0.0)
      (setf abserr 0.0)
      (if (or (< limlst 3) (< leniw (f2cl-lib:int-add limlst 2)) (< maxp1 1)
              (< lenw
      ...
      (multiple-value-bind
          ...
          (dqawfe f a omega integr epsabs limlst limit maxp1 result abserr
           ...
           (f2cl-lib:array-slice work-%data% double-float (l4) ((1 lenw))
                                 work-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l5) ((1 lenw))
                                 work-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (l1)
                                 ((1 leniw)) iwork-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (ll2)
                                 ((1 leniw)) iwork-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l6) ((1 lenw))
                                 work-%offset%))
        (declare
     ...
     end_label
      (return
       (values nil nil nil integr nil result abserr neval ier nil lst nil nil
               nil nil nil)))))

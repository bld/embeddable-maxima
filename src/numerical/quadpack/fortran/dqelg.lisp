...
(defun dqelg (n epstab result abserr res3la nres)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ib 0) (ib2 0) (ie 0) (indx 0) (k1 0) (k2 0) (k3 0) (limexp 0)
           (newelm 0) (num 0) (dabs$ 0.0) (delta1 0.0) (delta2 0.0)
           (delta3 0.0) (dmax1$ 0.0) (epmach 0.0) (epsinf 0.0) (error$ 0.0)
           (err1 0.0) (err2 0.0) (err3 0.0) (e0 0.0) (e1 0.0) (e1abs 0.0)
           (e2 0.0) (e3 0.0) (oflow 0.0) (res 0.0) (ss 0.0) (tol1 0.0)
           (tol2 0.0) (tol3 0.0))
      (declare
       (type (double-float) tol3 tol2 tol1 ss res oflow e3 e2 e1abs e1 e0 err3
        err2 err1 error$ epsinf epmach dmax1$ delta3 delta2 delta1 dabs$)
       (type (f2cl-lib:integer4) num newelm limexp k3 k2 k1 indx ie ib2 ib i))
      ...
      (if (< n 3)
          (go label100))
      (setf limexp 50)
      (setf (f2cl-lib:fref epstab-%data% ((f2cl-lib:int-add n 2)) ((1 52))
                           epstab-%offset%)
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf res
                  (f2cl-lib:fref epstab-%data% ((f2cl-lib:int-add k1 2))
                                 ((1 52)) epstab-%offset%))
          (setf e0 (f2cl-lib:fref epstab-%data% (k3) ((1 52)) epstab-%offset%))
          (setf e1 (f2cl-lib:fref epstab-%data% (k2) ((1 52)) epstab-%offset%))
          (setf e2 res)
          (setf e1abs (f2cl-lib:dabs e1))
          (setf delta2 (- e2 e1))
          (setf err2 (f2cl-lib:dabs delta2))
          (setf tol2 (* (f2cl-lib:dmax1 (f2cl-lib:dabs e2) e1abs) epmach))
          (setf delta3 (- e1 e0))
          (setf err3 (f2cl-lib:dabs delta3))
          (setf tol3 (* (f2cl-lib:dmax1 e1abs (f2cl-lib:dabs e0)) epmach))
          (if (or (> err2 tol2) (> err3 tol3))
              (go label10))
          (setf result res)
         ...
         label10
          ...
          (setf delta1 (- e1 e3))
          (setf err1 (f2cl-lib:dabs delta1))
          (setf tol1 (* (f2cl-lib:dmax1 e1abs (f2cl-lib:dabs e3)) epmach))
          (if (or (<= err1 tol1) (<= err2 tol2) (<= err3 tol3))
              (go label20))
          (setf ss (+ (/ 1.0 delta1) (/ 1.0 delta2) (/ -1.0 delta3)))
          (setf epsinf (f2cl-lib:dabs (* ss e1)))
          (if (> epsinf 1.e-4)
              (go label30))
         label20
         ...
         label30
          ...
          (setf error$ (+ err2 (f2cl-lib:dabs (- res e2)) err3))
          (if (> error$ abserr)
              (go label40))
          (setf abserr error$)
          (setf result res)
     ...
     label50
      ...
      (setf ib 1)
      (if (= (* (the f2cl-lib:integer4 (truncate num 2)) 2) num)
          (setf ib 2))
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          (setf (f2cl-lib:fref epstab-%data% (i) ((1 52)) epstab-%offset%)
                  (f2cl-lib:fref epstab-%data% (indx) ((1 52))
                                 epstab-%offset%))
     ...
     label90
      (setf abserr
              (+
               ...
               (f2cl-lib:dabs
                (- result
                   (f2cl-lib:fref res3la-%data% (1) ((1 3))
                                  res3la-%offset%)))))
     ...
     label100
      (setf abserr
              (f2cl-lib:dmax1 abserr (* 5.0 epmach (f2cl-lib:dabs result))))
      (go end_label)
     end_label
  ...
  (setf (gethash 'fortran-to-lisp::dqelg fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '((fortran-to-lisp::integer4)
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(fortran-to-lisp::n nil
                                              fortran-to-lisp::result
                                              fortran-to-lisp::abserr nil
                                              fortran-to-lisp::nres)

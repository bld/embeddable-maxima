...
(defun dqawse
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ri (make-array 25 :element-type 'double-float))
           ...
           (centre 0.0) (dabs$ 0.0) (dmax1$ 0.0) (epmach 0.0) (errbnd 0.0)
           (errmax 0.0) (error1 0.0) (erro12 0.0) (error2 0.0) (errsum 0.0)
           (resas1 0.0) (resas2 0.0) (uflow 0.0))
      (declare (type (array double-float (25)) rj ri rh rg)
               (type (double-float) uflow resas2 resas1 errsum error2 erro12
                error1 errmax errbnd epmach dmax1$ dabs$ centre b2 b1 a2 a1
                area2 area12 area1 area)
      ...
      (setf (f2cl-lib:fref alist-%data% (2) ((1 limit)) alist-%offset%) centre)
      (setf (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%) centre)
      (setf (f2cl-lib:fref blist-%data% (2) ((1 limit)) blist-%offset%) b)
      (setf (f2cl-lib:fref rlist-%data% (1) ((1 limit)) rlist-%offset%) area1)
      (setf (f2cl-lib:fref rlist-%data% (2) ((1 limit)) rlist-%offset%) area2)
      (setf (f2cl-lib:fref elist-%data% (1) ((1 limit)) elist-%offset%) error1)
      (setf (f2cl-lib:fref elist-%data% (2) ((1 limit)) elist-%offset%) error2)
      (go label20)
     label10
      (setf (f2cl-lib:fref alist-%data% (1) ((1 limit)) alist-%offset%) centre)
      (setf (f2cl-lib:fref alist-%data% (2) ((1 limit)) alist-%offset%) a)
      (setf (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%) b)
      (setf (f2cl-lib:fref blist-%data% (2) ((1 limit)) blist-%offset%) centre)
      (setf (f2cl-lib:fref rlist-%data% (1) ((1 limit)) rlist-%offset%) area2)
      (setf (f2cl-lib:fref rlist-%data% (2) ((1 limit)) rlist-%offset%) area1)
      (setf (f2cl-lib:fref elist-%data% (1) ((1 limit)) elist-%offset%) error2)
      (setf (f2cl-lib:fref elist-%data% (2) ((1 limit)) elist-%offset%) error1)
     label20
      (setf (f2cl-lib:fref iord-%data% (1) ((1 limit)) iord-%offset%) 1)
      (setf (f2cl-lib:fref iord-%data% (2) ((1 limit)) iord-%offset%) 2)
      (if (= limit 2)
          (setf ier 1))
      (if (or (<= abserr errbnd) (= ier 1))
          (go label999))
      (setf errmax (f2cl-lib:fref elist-%data% (1) ((1 limit)) elist-%offset%))
      (setf maxerr 1)
      (setf nrmax 1)
      (setf area result)
      (setf errsum abserr)
      ...
      (f2cl-lib:fdo (last$ 3 (f2cl-lib:int-add last$ 1))
        ...
        (tagbody
          ...
          (if (or (= a a1) (= b b2))
              (go label30))
          (if (or (= resas1 error1) (= resas2 error2))
              (go label30))
          (if (and
               (<
                (f2cl-lib:dabs
     ...
     end_label
      (return
       (values nil a b alfa beta integr nil nil nil result abserr neval ier nil
               nil nil nil nil last$)))))

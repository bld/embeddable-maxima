...
(defun dqawce
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((iroff1 0) (iroff2 0) (k 0) (krule 0) (maxerr 0) (nev 0) (nrmax 0)
           ...
           (a2 0.0) (bb 0.0) (b1 0.0) (b2 0.0) (dabs$ 0.0) (dmax1$ 0.0)
           (epmach 0.0) (errbnd 0.0) (errmax 0.0) (error1 0.0) (erro12 0.0)
           (error2 0.0) (errsum 0.0) (uflow 0.0))
      (declare
       (type (double-float) uflow errsum error2 erro12 error1 errmax errbnd
        epmach dmax1$ dabs$ b2 b1 bb a2 a1 area2 area12 area1 area aa)
     ...
     label10
      ...
      (if (= limit 1)
          (setf ier 1))
      (if (or
           (< abserr (f2cl-lib:dmin1 (* 0.01 (f2cl-lib:dabs result)) errbnd))
           (= ier 1))
          (go label70))
      (setf (f2cl-lib:fref alist-%data% (1) ((1 limit)) alist-%offset%) aa)
      (setf (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%) bb)
      (setf (f2cl-lib:fref rlist-%data% (1) ((1 limit)) rlist-%offset%) result)
      (setf errmax abserr)
      (setf maxerr 1)
      (setf area result)
     ...
     end_label
      (return
       (values nil nil nil c nil nil nil result abserr neval ier nil nil nil
               nil nil last$)))))

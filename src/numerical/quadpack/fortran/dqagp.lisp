...
(defun dqagp
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((limit 0) (lvl 0) (l1 0) (l2 0) (l3 0) (l4 0))
      ...
      (setf result 0.0)
      (setf abserr 0.0)
      (if (or (< leniw (f2cl-lib:int-sub (f2cl-lib:int-mul 3 npts2) 2))
      ...
      (multiple-value-bind
          ...
          (dqagpe f a b npts2 points epsabs epsrel limit result abserr neval
           ...
           (f2cl-lib:array-slice work-%data% double-float (1) ((1 *))
                                 work-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l1) ((1 *))
                                 work-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l2) ((1 *))
                                 work-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l3) ((1 *))
                                 work-%offset%)
           (f2cl-lib:array-slice work-%data% double-float (l4) ((1 *))
                                 work-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (1) ((1 *))
                                 iwork-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (l1) ((1 *))
                                 iwork-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (l2) ((1 *))
                                 iwork-%offset%)
           last$)
        (declare
         (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-12 var-13
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil result abserr neval ier nil nil
               last$ nil nil)))))

...
(defun dqagse
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
           ...
           (dabs$ 0.0) (defabs 0.0) (defab1 0.0) (defab2 0.0) (dmax1$ 0.0)
           (dres 0.0) (epmach 0.0) (erlarg 0.0) (erlast 0.0) (errbnd 0.0)
           (errmax 0.0) (error1 0.0) (error2 0.0) (erro12 0.0) (errsum 0.0)
           (ertest 0.0) (oflow 0.0) (resabs 0.0) (reseps 0.0) (small 0.0)
           (uflow 0.0))
      (declare (type (array double-float (52)) rlist2)
               ...
               (type (double-float) uflow small reseps resabs oflow ertest
                ...
                dres dmax1$ defab2 defab1 defabs dabs$ correc b2 b1 a2 a1 area2
      ...
      (f2cl-lib:fdo (last$ 2 (f2cl-lib:int-add last$ 1))
        ...
        (tagbody
         ...
         label70
          ...
          (go label90)
         label80
          (setf small (* (f2cl-lib:dabs (- b a)) 0.375))
          (setf erlarg errsum)
          (setf ertest errbnd)

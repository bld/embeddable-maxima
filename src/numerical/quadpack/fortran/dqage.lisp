...
(defun dqage
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((iroff1 0) (iroff2 0) (k 0) (keyf 0) (maxerr 0) (nrmax 0) (area 0.0)
           ...
           (b2 0.0) (dabs$ 0.0) (defabs 0.0) (defab1 0.0) (defab2 0.0)
           (dmax1$ 0.0) (epmach 0.0) (errbnd 0.0) (errmax 0.0) (error1 0.0)
           (error2 0.0) (erro12 0.0) (errsum 0.0) (resabs 0.0) (uflow 0.0))
      (declare
       (type (double-float) uflow resabs errsum erro12 error2 error1 errmax
        errbnd epmach dmax1$ defab2 defab1 defabs dabs$ b2 b1 a2 a1 area2
        area12 area1 area)
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil result abserr neval ier nil nil nil
               nil nil last$)))))
  ...
  (setf (gethash 'fortran-to-lisp::dqage fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::dqpsrt
                                              fortran-to-lisp::dqk61
                                              fortran-to-lisp::dqk51
                                              fortran-to-lisp::dqk41
                                              fortran-to-lisp::dqk31
                                              fortran-to-lisp::dqk21
                                              fortran-to-lisp::dqk15

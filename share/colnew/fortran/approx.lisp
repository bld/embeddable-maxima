      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((fact 0.0) (lb 0) (ll 0) (zsum 0.0) (ind 0) (mj 0) (jcomp 0)
         ...
         label30
          (if (and
               (>= x
                   (- (f2cl-lib:fref xi-%data% (1) ((1 1)) xi-%offset%)
                      precis))
               (<= x
                   (+
                    (f2cl-lib:fref xi-%data% ((f2cl-lib:int-add n 1)) ((1 1))
                                   xi-%offset%)
                    precis)))
              (go label40))
          (if (< iprint 1)
              (f2cl-lib:fformat iout
                                (" ****** DOMAIN ERROR IN APPROX ******" "~%"
                                 ...
                                 (("~20,10,2,0,'*,,'DE")) "~%")
                                x
                                (f2cl-lib:fref xi-%data% (1) ((1 1))
                                               xi-%offset%)
                                (f2cl-lib:fref xi-%data%
                                               ((f2cl-lib:int-add n 1)) ((1 1))
                                               xi-%offset%)))
         ...
         label40
          ...
          (f2cl-lib:fdo (l ileft (f2cl-lib:int-add l 1))
            ...
            (tagbody
              (setf i l)
              (if (< x
                     (f2cl-lib:fref xi-%data% ((f2cl-lib:int-add l 1)) ((1 1))
                                    xi-%offset%))
                  (go label80))
             label50))
          (go label80)
         ...
         label80
          (setf s
                  (/ (- x (f2cl-lib:fref xi-%data% (i) ((1 1)) xi-%offset%))
                     (-
                      (f2cl-lib:fref xi-%data% ((f2cl-lib:int-add i 1)) ((1 1))
                                     xi-%offset%)
         ...
         label100
          ...
          (setf iz
                  (f2cl-lib:int-add
                   (f2cl-lib:int-mul (f2cl-lib:int-sub i 1) mstar) 1))
                  ...
                  (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ...
                    (tagbody
                      (setf zsum
                              (+ zsum
                                 (*
                                  (f2cl-lib:fref a-%data% (j l) ((1 7) (1 1))
                                                 a-%offset%)
                                  (f2cl-lib:fref dmz-%data% (ind) ((1 1))
                                                 dmz-%offset%))))
                     label110
                      ...
                      (setf zsum
                              (+ (* zsum (f2cl-lib:fref bm (lb) ((1 4))))
                                 (f2cl-lib:fref z-%data%
                                                ...
                                                ((1 1)) z-%offset%)))))
                 label130
                  (setf (f2cl-lib:fref zval-%data% ((f2cl-lib:int-sub ir l))
                                       ((1 1)) zval-%offset%)
                          zsum)))
             label140))
          (if (= modm 0)
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (f2cl-lib:fdo (jcomp 1 (f2cl-lib:int-add jcomp 1))
                            ((> jcomp ncomp) nil)
                (tagbody
                  (setf (f2cl-lib:fref dmval-%data% (jcomp) ((1 1))
                                       dmval-%offset%)
                          (+
                           (f2cl-lib:fref dmval-%data% (jcomp) ((1 1))
                                          dmval-%offset%)
                           (* fact
         ...
         end_label
          (return
           (values i x nil nil nil nil nil nil nil nil nil nil nil nil nil nil
                   nil)))))))

  ...
  (let ((colloc-rho
        ...
        (colsid-zeta
         (make-array 40 :element-type 'double-float :displaced-to
                     ...
                     :displaced-index-offset 0))
        (colbas-acol
         (make-array 196 :element-type 'double-float :displaced-to
        ...
        (prog ((izet 0) (iz 0) (value 0.0) (jj 0) (xcol 0.0) (hrho 0.0) (j 0)
          ...
          (declare (type (array double-float (40)) zval f dgz)
                   ...
                   (type (f2cl-lib:integer4) m1 i idmz idmzo irhs ig iw iv
                    lside iold ncol nrow lw l j jj iz izet))
         ...
         label30
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
              (setf (f2cl-lib:fref integs-%data% (2 i) ((1 3) (1 1))
                                   integs-%offset%)
                      ncol)
              (if (< i n)
                  (go label40))
              (setf (f2cl-lib:fref integs-%data% (3 n) ((1 3) (1 1))
                                   integs-%offset%)
                      ncol)
              (setf lside mstar)
              (go label60)
             label40
              (setf (f2cl-lib:fref integs-%data% (3 i) ((1 3) (1 1))
                                   integs-%offset%)
                      mstar)
             label50
              (if (= lside mstar)
             ...
             label70
              (setf (f2cl-lib:fref integs-%data% (1 i) ((1 3) (1 1))
                                   integs-%offset%)
                      nrow)))
         label80
          (if (= mode 2)
            ...
            (tagbody
              ...
              (setf h
                      (-
                       ...
                       (f2cl-lib:fref xi-%data% (i) ((1 1)) xi-%offset%)))
              (setf nrow
                      (f2cl-lib:fref integs-%data% (1 i) ((1 3) (1 1))
                                     integs-%offset%))
             label100
              (if (> izeta mstar)
                  (go label140))
             ...
             label110
              (multiple-value-bind (var-0 var-1 var-2)
                ...
                (when var-2 (setf gval var-2)))
              (setf (f2cl-lib:fref rhs-%data% ((f2cl-lib:int-add ndmz izeta))
                                   ((1 1)) rhs-%offset%)
                      (- gval))
             ...
             label120
              (gderiv
               (f2cl-lib:array-slice g-%data% double-float (ig) ((1 1))
                                     g-%offset%)
               nrow izeta zval dgz 1 dgsub)
             label130
              ...
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                ...
                (tagbody
                  ...
                  (if (/= iguess 1)
                      (go label160))
                  (multiple-value-bind (var-0 var-1 var-2)
                      (funcall guess xcol zval
                               (f2cl-lib:array-slice dmzo-%data% double-float
                                                     (irhs) ((1 1))
                                                     dmzo-%offset%))
                    (declare (ignore var-1 var-2))
                    (when var-0 (setf xcol var-0)))
                  (go label170)
                 label160
                  (if (/= mode 1)
                      (go label190))
                  (multiple-value-bind
                      ...
                      (approx iold xcol zval at coef xiold nold z dmz k ncomp
                       mmax m mstar 2
                       (f2cl-lib:array-slice dmzo-%data% double-float (irhs)
                                             ((1 1)) dmzo-%offset%)
                       1)
                    (declare
                     (ignore var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                      var-10 var-11 var-12 var-13 var-14 var-15 var-16))
                    (setf iold var-0)
                    (setf xcol var-1))
                 label170
                  ...
                  (f2cl-lib:fdo (jj 1 (f2cl-lib:int-add jj 1))
                    ...
                    (tagbody
                      (setf value
                              (-
                               (f2cl-lib:fref dmzo-%data% (irhs) ((1 1))
                                              dmzo-%offset%)
                               (f2cl-lib:fref f (jj) ((1 40)))))
                      (setf (f2cl-lib:fref rhs-%data% (irhs) ((1 1))
                                           rhs-%offset%)
                              (- value))
                 ...
                 label190
                  (multiple-value-bind
                      (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                       var-9 var-10 var-11 var-12 var-13 var-14 var-15 var-16)
                      (approx i xcol zval
                       (f2cl-lib:array-slice acol double-float (1 j)
                                             ((1 28) (1 7)))
                  ...
                  (f2cl-lib:fdo (jj 1 (f2cl-lib:int-add jj 1))
                    ...
                    (tagbody
                      (setf value
                              (-
                               (f2cl-lib:fref dmz-%data% (irhs) ((1 1))
                                              dmz-%offset%)
                               (f2cl-lib:fref f (jj) ((1 40)))))
                      (setf (f2cl-lib:fref rhs-%data% (irhs) ((1 1))
                                           rhs-%offset%)
                 ...
                 label200
                  (multiple-value-bind (var-0 var-1 var-2)
                      (funcall fsub xcol zval
                               (f2cl-lib:array-slice rhs-%data% double-float
                                                     (irhs) ((1 1))
                                                     rhs-%offset%))
                    (declare (ignore var-1 var-2))
                    (when var-0 (setf xcol var-0)))
                 ...
                 label210
                  (multiple-value-bind
                      ...
                      (vwblok xcol hrho j
                       (f2cl-lib:array-slice w-%data% double-float (iw) ((1 1))
                                             w-%offset%)
                       (f2cl-lib:array-slice v-%data% double-float (iv) ((1 1))
                                             v-%offset%)
                       (f2cl-lib:array-slice ipvtw-%data% f2cl-lib:integer4
                                             (idmz) ((1 1)) ipvtw-%offset%)
                       kd zval df
                       (f2cl-lib:array-slice acol double-float (1 j)
                                             ((1 28) (1 7)))
                       (f2cl-lib:array-slice dmzo-%data% double-float (idmzo)
                                             ((1 1)) dmzo-%offset%)
                       ncomp dfsub msing)
                    (declare
                     (ignore var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
              ...
              (if (/= mode 2)
                  (gblock h
                   ...
                   (f2cl-lib:array-slice v-%data% double-float (iv) ((1 1))
                                         v-%offset%)
                   kd dummy
                   (f2cl-lib:array-slice deldmz-%data% double-float (idmz)
                                         ((1 1)) deldmz-%offset%)
                   (f2cl-lib:array-slice ipvtw-%data% f2cl-lib:integer4 (idmz)
                                         ((1 1)) ipvtw-%offset%)
                   1))
              (if (< i n)
                  (go label280))
             ...
             label260
              (gderiv
               (f2cl-lib:array-slice g-%data% double-float (ig) ((1 1))
                                     g-%offset%)
               nrow (f2cl-lib:int-add izeta mstar) zval dgz 2 dgsub)
             label270
              (setf izeta (f2cl-lib:int-add izeta 1))
              (go label240)
             label280
              ...
              (if (= mode 1)
                  (setf idmzo (f2cl-lib:int-add idmzo kd)))
             label290))
          (if (or (= mode 0) (= mode 3))
              (go label300))
          (setf rnorm
             ...
             label322
              ...
              (setf (f2cl-lib:fref delz-%data%
                                   ((f2cl-lib:int-add (f2cl-lib:int-sub iz 1)
                                                      izet))
                                   ((1 1)) delz-%offset%)
                      (f2cl-lib:fref rhs-%data% ((f2cl-lib:int-add ndmz izet))
                                     ((1 1)) rhs-%offset%))
             ...
             label324
              (setf h
                      (-
                       ...
                       (f2cl-lib:fref xi-%data% (i) ((1 1)) xi-%offset%)))
              (gblock h
               (f2cl-lib:array-slice g-%data% double-float (1) ((1 1))
                                     g-%offset%)
               nrow izeta
               (f2cl-lib:array-slice w-%data% double-float (iw) ((1 1))
                                     w-%offset%)
               (f2cl-lib:array-slice v-%data% double-float (1) ((1 1))
                                     v-%offset%)
               kd
               (f2cl-lib:array-slice delz-%data% double-float (iz) ((1 1))
                                     delz-%offset%)
               (f2cl-lib:array-slice deldmz-%data% double-float (idmz) ((1 1))
                                     deldmz-%offset%)
               (f2cl-lib:array-slice ipvtw-%data% f2cl-lib:integer4 (idmz)
                                     ((1 1)) ipvtw-%offset%)
               2)
             ...
             label340
              ...
              (gblock h
               ...
               (f2cl-lib:array-slice w-%data% double-float (iw) ((1 1))
                                     w-%offset%)
               df kd
               (f2cl-lib:array-slice z-%data% double-float (iz) ((1 1))
                                     z-%offset%)
               (f2cl-lib:array-slice dmz-%data% double-float (idmz) ((1 1))
                                     dmz-%offset%)
               (f2cl-lib:array-slice ipvtw-%data% f2cl-lib:integer4 (idmz)
                                     ((1 1)) ipvtw-%offset%)
               2)
         ...
         end_label
          (return
           (values msing nil nil nil nil nil nil nil nil nil nil nil nil nil
                   nil rnorm nil nil nil nil nil nil)))))))
  ...
  (setf (gethash 'fortran-to-lisp::lsyslv
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '((fortran-to-lisp::integer4)
                                              ...
                                              t t)
                                            :return-values
                                            '(fortran-to-lisp::msing nil nil
                                              nil nil nil nil nil nil nil nil
                                              nil nil nil nil
                                              fortran-to-lisp::rnorm nil nil
                                              nil nil nil nil)
                                            :calls
                                            '(fortran-to-lisp::dmzsol
                                              fortran-to-lisp::sbblok
                                              fortran-to-lisp::fcblok
                                              fortran-to-lisp::gblock
                                              fortran-to-lisp::vwblok
                                              fortran-to-lisp::gderiv

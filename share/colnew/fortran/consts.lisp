...
(let ((cnsts1
       (make-array 28 :element-type 'double-float :initial-contents
                   '(0.25 0.0625 0.072169 0.018342 0.019065 0.05819 0.0054658
                     0.005337 0.01889 0.027792 0.0016095 0.0014964 0.0075938
                     0.0057573 0.018342 0.004673 4.15e-4 0.001919 0.001468
                     0.006371 0.00461 1.342e-4 1.138e-4 4.889e-4 4.177e-4
                     0.001374 0.001654 0.002863)))
      (cnsts2
       (make-array 28 :element-type 'double-float :initial-contents
                   '(0.125 0.002604 0.008019 2.17e-5 7.453e-5 5.208e-4 9.689e-8
                     3.689e-7 3.1e-6 2.451e-5 2.691e-10 1.12e-9 1.076e-8
                     9.405e-8 1.033e-6 5.097e-13 2.29e-12 2.446e-11 2.331e-10
          ...
          (prog ((ltoli 0) (i 0) (mtot 0) (jcomp 0) (l 0) (mj 0) (j 0) (iz 0)
           ...
           label10
            ...
            (f2cl-lib:computed-goto
             (label50 label60 label70 label80 label90 label100 label110) k)
           label50
            ...
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                  ...
                  (tagbody
                   label135
                    (setf (f2cl-lib:fref coef-%data% (i j) ((1 k) (1 1))
                                         coef-%offset%)
                            0.0)))
                (setf (f2cl-lib:fref coef-%data% (j j) ((1 k) (1 1))
                                     coef-%offset%)
                        1.0)
                (vmonde rho
                 (f2cl-lib:array-slice coef-%data% double-float (1 j)
                                       ((1 k) (1 1)) coef-%offset%)
                 k)
               label140))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::consts
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :return-values '(nil nil nil)
                                            :calls
                                            '(fortran-to-lisp::rkbas
                                              fortran-to-lisp::vmonde))))

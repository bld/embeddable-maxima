    ...
    (prog ((dabs$ 0.0) (dmax1$ 0.0) (colmax 0.0) (t$ 0.0) (s 0.0) (i 0) (j 0)
            ...
            (tagbody
              (setf (f2cl-lib:fref d-%data% (i) ((1 nrow)) d-%offset%)
                      (f2cl-lib:dmax1
                       ...
                       (f2cl-lib:dabs
                        (f2cl-lib:fref w-%data% (i j) ((1 nrow) (1 ncol))
                                       w-%offset%))))
             label20))))
     label20
      (setf k 1)
      ...
      (f2cl-lib:fdo (i kp1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf colmax
                  (/
                   (f2cl-lib:dabs
                    (f2cl-lib:fref w-%data% (i k) ((1 nrow) (1 ncol))
                                   w-%offset%))
                   (f2cl-lib:fref d-%data% (i) ((1 nrow)) d-%offset%)))
          (setf l i)
         label40))
     ...
     label50
      ...
      (f2cl-lib:fdo (j kp1 (f2cl-lib:int-add j 1))
        ...
        (tagbody
          (setf t$
                  (f2cl-lib:fref w-%data% (l j) ((1 nrow) (1 ncol))
                                 w-%offset%))
          (if (= l k)
              (go label62))
          (setf (f2cl-lib:fref w-%data% (l j) ((1 nrow) (1 ncol)) w-%offset%)
                  (f2cl-lib:fref w-%data% (k j) ((1 nrow) (1 ncol))
                                 w-%offset%))
         ...
         label62
          ...
          (f2cl-lib:fdo (i kp1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
             label64
              (setf (f2cl-lib:fref w-%data% (i j) ((1 nrow) (1 ncol))
                                   w-%offset%)
                      (+
                       (f2cl-lib:fref w-%data% (i j) ((1 nrow) (1 ncol))
                                      w-%offset%)
     ...
     label80
      (if (>
           (+
            (f2cl-lib:dabs
             (f2cl-lib:fref w-%data% (nrow nrow) ((1 nrow) (1 ncol))
                            w-%offset%))

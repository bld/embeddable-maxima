      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((bl 0.0) (jdf 0) (ll 0) (lp1 0) (iw 0) (ajl 0.0) (jw 0) (jv 0)
          ...
          (f2cl-lib:fdo (id 1 (f2cl-lib:int-add id 1))
                        ((> id kd) nil)
            (tagbody
              (setf (f2cl-lib:fref wi-%data% (id id) ((1 kd) (1 1))
                                   wi-%offset%)
                      1.0)
             label10))
         label30
              ...
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                ...
                (tagbody
                  (setf (f2cl-lib:fref ha (j l) ((1 7) (1 4)))
                          (* fact
                             (f2cl-lib:fref acol-%data% (j l) ((1 7) (1 4))
                                            acol-%offset%)))
                 label150))))
         label150
          (f2cl-lib:fdo (jcol 1 (f2cl-lib:int-add jcol 1))
            ...
            (tagbody
              (f2cl-lib:fdo (ir 1 (f2cl-lib:int-add ir 1))
                            ((> ir ncomp) nil)
                (tagbody
                  (setf (f2cl-lib:fref df-%data% (ir jcol) ((1 ncomp) (1 1))
                                       df-%offset%)
                          0.0)))))
         label40
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (f2cl-lib:fdo (id 1 (f2cl-lib:int-add id 1))
                            ((> id ncomp) nil)
                (tagbody
                  (setf (f2cl-lib:fref dmzo-%data% ((f2cl-lib:int-add i0 id))
                                       ((1 1)) dmzo-%offset%)
                          (+
                           (f2cl-lib:fref dmzo-%data%
                                          ((f2cl-lib:int-add i0 id)) ((1 1))
                                          dmzo-%offset%)
                           (* fact
                              (f2cl-lib:fref df-%data% (id j) ((1 ncomp) (1 1))
                                             df-%offset%))))
                 label50))))
         label50
         label60
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (f2cl-lib:fdo (id 1 (f2cl-lib:int-add id 1))
                            ((> id ncomp) nil)
                (tagbody
                  (setf (f2cl-lib:fref vi-%data% ((f2cl-lib:int-add i0 id) j)
                                       ((1 kd) (1 1)) vi-%offset%)
                          (f2cl-lib:fref df-%data% (id j) ((1 ncomp) (1 1))
                                         df-%offset%))
                 label70))))
                ...
                (tagbody
                  ...
                  (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ...
                    (tagbody
                      ...
                      (f2cl-lib:fdo (iw i1 (f2cl-lib:int-add iw 1))
                                    ((> iw i2) nil)
                        (tagbody
                          (setf (f2cl-lib:fref wi-%data% (iw jw) ((1 kd) (1 1))
                                               wi-%offset%)
                                  (+
                                   (f2cl-lib:fref wi-%data% (iw jw)
                                                  ((1 kd) (1 1)) wi-%offset%)
                                   (* ajl
                                      (f2cl-lib:fref vi-%data% (iw jv)
                                                     ((1 kd) (1 1))
                                                     vi-%offset%))))
                         label80))
                     label90
                  ...
                  (f2cl-lib:fdo (ll lp1 (f2cl-lib:int-add ll 1))
                    ...
                    (tagbody
                      ...
                      (setf bl
                              (f2cl-lib:fref basm ((f2cl-lib:int-sub ll l))
                                             ((1 5))))
                      (f2cl-lib:fdo (iw i1 (f2cl-lib:int-add iw 1))
                                    ((> iw i2) nil)
                        (tagbody
                          (setf (f2cl-lib:fref vi-%data% (iw jv) ((1 kd) (1 1))
                                               vi-%offset%)
                                  (+
                                   (f2cl-lib:fref vi-%data% (iw jv)
                                                  ((1 kd) (1 1)) vi-%offset%)
                                   (* bl
                                      (f2cl-lib:fref vi-%data% (iw jdf)
                                                     ((1 kd) (1 1))
                                                     vi-%offset%))))
                         label100))
                     label110))
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (dgesl wi kd kd ipvtw
               (f2cl-lib:array-slice vi-%data% double-float (1 j)
                                     ((1 kd) (1 1)) vi-%offset%)
               0)
             label250))
          (go end_label)
         end_label
          (return
           (values xcol nil nil nil nil nil nil nil nil nil nil nil nil
                   msing)))))))
  ...
  (setf (gethash 'fortran-to-lisp::vwblok
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '(double-float double-float
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(fortran-to-lisp::xcol nil nil nil
                                              nil nil nil nil nil nil nil nil
                                              nil fortran-to-lisp::msing)
                                            :calls

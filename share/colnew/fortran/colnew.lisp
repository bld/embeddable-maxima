...
(labels ((multi-entry-colnew
           ...
           (let ((colloc-rho
                  (make-array 7 :element-type 'double-float :displaced-to
                 ...
                 (prog ((ic 0) (k2 0) (idmz 0) (np1 0) (linteg 0) (lpvtw 0)
                   ...
                   (declare (type (array double-float (1)) dummy)
                            ...
                            (type (f2cl-lib:integer4) i iread ndimf ndimi
                             nfxpnt ip nrec ib nfixi nsizei nfixf nsizef nmaxf
                             nmaxi lxi lg lxiold lw lv lz ldmz ldelz ldeldz
                             ldqz ldqdmz lrhs lvalst lslope laccum lscl ldscl
                             lpvtg lpvtw linteg np1 idmz k2 ic))
                   (if (eq %name% 'colsys)
                       (go colsys))
                  colsys
                   (if (<=
                  ...
                  label10
                   ...
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      ...
                      label20))
                   (setf nonlin
                           (f2cl-lib:fref ipar-%data% (1) ((1 1))
                                          ipar-%offset%))
                   (setf k
                           (f2cl-lib:fref ipar-%data% (2) ((1 1))
                                          ipar-%offset%))
                   (setf n
                           (f2cl-lib:fref ipar-%data% (3) ((1 1))
                                          ipar-%offset%))
                   (if (= n 0)
                       (setf n 5))
                   (setf iread
                           (f2cl-lib:fref ipar-%data% (8) ((1 1))
                                          ipar-%offset%))
                   (setf iguess
                           (f2cl-lib:fref ipar-%data% (9) ((1 1))
                                          ipar-%offset%))
                   (if (and (= nonlin 0) (= iguess 1))
                       (setf iguess 0))
                   (if (and (>= iguess 2) (= iread 0))
                       (setf iread 1))
                   (setf icare
                           (f2cl-lib:fref ipar-%data% (10) ((1 1))
                                          ipar-%offset%))
                   (setf ntol
                           (f2cl-lib:fref ipar-%data% (4) ((1 1))
                                          ipar-%offset%))
                   (setf ndimf
                           (f2cl-lib:fref ipar-%data% (5) ((1 1))
                                          ipar-%offset%))
                   (setf ndimi
                           (f2cl-lib:fref ipar-%data% (6) ((1 1))
                                          ipar-%offset%))
                   (setf nfxpnt
                           (f2cl-lib:fref ipar-%data% (11) ((1 1))
                                          ipar-%offset%))
                   (setf iprint
                           (f2cl-lib:fref ipar-%data% (7) ((1 1))
                                          ipar-%offset%))
                   (setf mstar 0)
                   (setf mmax 0)
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      label40
                       (setf (f2cl-lib:fref tzeta (i) ((1 40)))
                               (f2cl-lib:fref zeta-%data% (i) ((1 1))
                                              zeta-%offset%))))
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                 ((> i ntol) nil)
                     (tagbody
                       (setf (f2cl-lib:fref lttol (i) ((1 40)))
                               (f2cl-lib:fref ltol-%data% (i) ((1 1))
                                              ltol-%offset%))
                      label50
                       (setf (f2cl-lib:fref tolin (i) ((1 40)))
                               (f2cl-lib:fref tol-%data% (i) ((1 1))
                                              tol-%offset%))))
                   (setf tleft aleft)
                   (setf tright aright)
                   (setf nc ncomp)
                  ...
                  label70
                   (f2cl-lib:fformat iout
                                     ...
                                     (do ((ip 1 (f2cl-lib:int-add ip 1))
                                       ...
                                       (declare (type f2cl-lib:integer4 ip))
                                       (push
                                        (f2cl-lib:fref zeta-%data% (ip) ((1 1))
                                                       zeta-%offset%)
                                        %ret)))
                   (if (> nfxpnt 0)
                       (f2cl-lib:fformat iout
                                         ...
                                         (do ((ip 1 (f2cl-lib:int-add ip 1))
                                           ...
                                           (declare
                                            (type f2cl-lib:integer4 ip))
                                           (push
                                            (f2cl-lib:fref fixpnt-%data% (ip)
                                                           ((1 1))
                                                           fixpnt-%offset%)
                                            %ret))))
                   (f2cl-lib:fformat iout
                   ...
                   (f2cl-lib:fformat iout
                                     ...
                                     (do ((ip 1 (f2cl-lib:int-add ip 1))
                                       ...
                                       (declare (type f2cl-lib:integer4 ip))
                                       (push
                                        (f2cl-lib:fref ltol-%data% (ip) ((1 1))
                                                       ltol-%offset%)
                                        %ret)))
                   (f2cl-lib:fformat iout
                  ...
                  label80
                   ...
                   (if (< n 0)
                       (go end_label))
                   (if (or (< iread 0) (> iread 2))
                       (go end_label))
                   (if (or (< iguess 0) (> iguess 4))
                       (go end_label))
                   (if (or (< icare 0) (> icare 2))
                       (go end_label))
                   (if (or (< ntol 0) (> ntol mstar))
                       (go end_label))
                   (if (< nfxpnt 0)
                       (go end_label))
                   (if (or (< iprint -1) (> iprint 1))
                       (go end_label))
                   (if (or (< mstar 0) (> mstar 40))
                       (go end_label))
                   (setf ip 1)
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                 ((> i mstar) nil)
                       ...
                       (if (<
                            (-
                             (f2cl-lib:fref zeta-%data% (i) ((1 1))
                                            zeta-%offset%)
                             precis)
                            (f2cl-lib:fref fixpnt-%data% (ip) ((1 1))
                                           fixpnt-%offset%))
                           (go label95))
                   ...
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                       ...
                       (if (>=
                            (f2cl-lib:fref zeta-%data% (ib) ((1 1))
                                           zeta-%offset%)
                            aright)
                           (setf nrec i))
                      label110))
                   ...
                   (setf nfixf
                           (f2cl-lib:int-add
                            ...
                            (f2cl-lib:int-mul 5 mstar) 3))
                   (setf nsizef
                           (f2cl-lib:int-add 4 (f2cl-lib:int-mul 3 mstar)
                                             (f2cl-lib:int-mul
                                              (f2cl-lib:int-add kd 5)
                                              (f2cl-lib:int-add kd mstar))
                                             (f2cl-lib:int-mul
                                              (f2cl-lib:int-sub
                                               (f2cl-lib:int-mul 2 mstar) nrec)
                                              2 mstar)))
                   (setf nmaxf
                   ...
                   (if (< nmax n)
                       (go end_label))
                   (if (< nmax (f2cl-lib:int-add nfxpnt 1))
                       (go end_label))
                   (if (and
                        (< nmax
                           (f2cl-lib:int-add (f2cl-lib:int-mul 2 nfxpnt) 2))
                        (< iprint 1))
                       (f2cl-lib:fformat iout
                                         ("~%"
                   ...
                   (setf lrhs
                           (f2cl-lib:int-add ldqdmz
                                             (f2cl-lib:int-mul kd nmax)))
                   (setf lvalst
                           (f2cl-lib:int-add lrhs (f2cl-lib:int-mul kd nmax)
                                             mstar))
                   (setf lslope
                   ...
                   (if (= iguess 4)
                       (setf np1 (f2cl-lib:int-add np1 nold 1)))
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                 ((> i nz) nil)
                     (tagbody
                      label120
                   ...
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      label130
                       (setf (f2cl-lib:fref fspace-%data%
                                            ((f2cl-lib:int-sub
                                              (f2cl-lib:int-add lxiold i) 1))
                                            ((1 1)) fspace-%offset%)
                               (f2cl-lib:fref fspace-%data%
                                              ((f2cl-lib:int-sub
                                                (f2cl-lib:int-add lxi i) 1))
                                              ((1 1)) fspace-%offset%))))
                   (go label160)
                  label140
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                  ...
                  label160
                   ...
                   (newmsh (f2cl-lib:int-add 3 iread)
                    (f2cl-lib:array-slice fspace-%data% double-float (lxi)
                                          ((1 1)) fspace-%offset%)
                    (f2cl-lib:array-slice fspace-%data% double-float (lxiold)
                                          ((1 1)) fspace-%offset%)
                   ...
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      label210
                       (setf (f2cl-lib:fref fspace-%data%
                                            ((f2cl-lib:int-sub
                                              (f2cl-lib:int-add i lxiold) 1))
                                            ((1 1)) fspace-%offset%)
                               (f2cl-lib:fref fspace-%data%
                                              ((f2cl-lib:int-sub
                                                (f2cl-lib:int-add i lxi) 1))
                                              ((1 1)) fspace-%offset%))))
                   (setf nold n)
                   (if (or (= nonlin 0) (= iguess 1))
                       (go label230))
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                 ((> i nz) nil)
                     (tagbody
                  ...
                  label230
                   ...
                   (multiple-value-bind
                       ...
                       (contrl
                        (f2cl-lib:array-slice fspace-%data% double-float (lxi)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (lxiold) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lz)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (ldmz)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lrhs)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (ldelz) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (ldeldz) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (ldqz)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (ldqdmz) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lg)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lw)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lv)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (lvalst) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (lslope) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float (lscl)
                                              ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (ldscl) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice fspace-%data% double-float
                                              (laccum) ((1 1)) fspace-%offset%)
                        (f2cl-lib:array-slice ispace-%data% f2cl-lib:integer4
                                              (lpvtg) ((1 1)) ispace-%offset%)
                        (f2cl-lib:array-slice ispace-%data% f2cl-lib:integer4
                                              (linteg) ((1 1)) ispace-%offset%)
                        (f2cl-lib:array-slice ispace-%data% f2cl-lib:integer4
                                              (lpvtw) ((1 1)) ispace-%offset%)
                     ...
                     (declare
                      (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                       ...
                       var-16 var-17 var-18 var-19 var-20 var-21 var-23 var-24
                       var-25 var-26 var-27))
                     (setf iflag var-22))
                   (setf (f2cl-lib:fref ispace-%data% (1) ((1 1))
                                        ispace-%offset%)
                           n)
                   (setf (f2cl-lib:fref ispace-%data% (2) ((1 1))
                                        ispace-%offset%)
                           k)
                   (setf (f2cl-lib:fref ispace-%data% (3) ((1 1))
                                        ispace-%offset%)
                           ncomp)
                   (setf (f2cl-lib:fref ispace-%data% (4) ((1 1))
                                        ispace-%offset%)
                           mstar)
                   (setf (f2cl-lib:fref ispace-%data% (5) ((1 1))
                                        ispace-%offset%)
                           mmax)
                   (setf (f2cl-lib:fref ispace-%data% (6) ((1 1))
                                        ispace-%offset%)
                           (f2cl-lib:int-add nz ndmz n 2))
                   (setf k2 (f2cl-lib:int-mul k k))
                   (setf (f2cl-lib:fref ispace-%data% (7) ((1 1))
                                        ispace-%offset%)
                           (f2cl-lib:int-sub
                            (f2cl-lib:int-add
                             (f2cl-lib:fref ispace-%data% (6) ((1 1))
                                            ispace-%offset%)
                             k2)
                            1))
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      label240
                       (setf (f2cl-lib:fref ispace-%data%
                                            ((f2cl-lib:int-add 7 i)) ((1 1))
                                            ispace-%offset%)
                               (f2cl-lib:fref m-%data% (i) ((1 1))
                                              m-%offset%))))
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                 ((> i nz) nil)
                     (tagbody
                   ...
                   (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                     ...
                     (tagbody
                      label258
                       (setf (f2cl-lib:fref fspace-%data%
                                            ((f2cl-lib:int-add ic i)) ((1 1))
                                            fspace-%offset%)
                               (f2cl-lib:fref coef (i) ((1 49))))))
                   (go end_label)
                  end_label
                   (return
                    (values nil nil nil nil nil nil nil nil nil nil nil iflag
                            nil nil nil nil nil))))))))
  (defun colnew

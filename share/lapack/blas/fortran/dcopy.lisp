        ...
        (tagbody
          ...
          (setf (f2cl-lib:fref dy-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                  ...
                  (f2cl-lib:fref dx-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                                 dx-%offset%))
          (setf (f2cl-lib:fref dy-%data% ((f2cl-lib:int-add i 3)) ((1 *))
                               dy-%offset%)
                  (f2cl-lib:fref dx-%data% ((f2cl-lib:int-add i 3)) ((1 *))
                                 dx-%offset%))
          (setf (f2cl-lib:fref dy-%data% ((f2cl-lib:int-add i 4)) ((1 *))
                               dy-%offset%)
                  (f2cl-lib:fref dx-%data% ((f2cl-lib:int-add i 4)) ((1 *))
                                 dx-%offset%))
          (setf (f2cl-lib:fref dy-%data% ((f2cl-lib:int-add i 5)) ((1 *))
                               dy-%offset%)
                  (f2cl-lib:fref dx-%data% ((f2cl-lib:int-add i 5)) ((1 *))
                                 dx-%offset%))
          (setf (f2cl-lib:fref dy-%data% ((f2cl-lib:int-add i 6)) ((1 *))
                               dy-%offset%)
                  (f2cl-lib:fref dx-%data% ((f2cl-lib:int-add i 6)) ((1 *))
                                 dx-%offset%))
         label50))
      (go end_label)
     end_label

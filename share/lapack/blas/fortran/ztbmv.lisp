    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((noconj nil) (nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0)
        ...
        (cond
         ...
         ((< n 0) (setf info 4)) ((< k 0) (setf info 5))
         ((< lda (f2cl-lib:int-add k 1)) (setf info 7))
         ((= incx 0) (setf info 9)))
        (cond ((/= info 0) (xerbla "ZTBMV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
        ...
        (cond
         ((lsame trans "N")
          (cond
           ((lsame uplo "U") (setf kplus1 (f2cl-lib:int-add k 1))
            (cond
             ((= incx 1)
                ...
                (tagbody
                  (cond
                   ((/= (f2cl-lib:fref x (jx) ((1 *))) zero)
                    ...
                    (setf ix kx) (setf l (f2cl-lib:int-sub kplus1 j))
                    (f2cl-lib:fdo (i
                                   (max (the f2cl-lib:integer4 1)
                                        (the f2cl-lib:integer4
                                             (f2cl-lib:int-add j
                    ...
                    (if nounit
                        (setf (f2cl-lib:fref x-%data% (j) ((1 *)) x-%offset%)
                                (*
                                 (f2cl-lib:fref x-%data% (j) ((1 *))
                                                x-%offset%)
                                 (f2cl-lib:fref a-%data% (1 j) ((1 lda) (1 *))
                                                a-%offset%))))))
                 label60)))
             (t
              (setf kx
                ...
                (tagbody
                  (cond
                   ((/= (f2cl-lib:fref x (jx) ((1 *))) zero)
                    (setf temp
                            (f2cl-lib:fref x-%data% (jx) ((1 *)) x-%offset%))
                    (setf ix kx) (setf l (f2cl-lib:int-sub 1 j))
                    (f2cl-lib:fdo (i
                                   (min (the f2cl-lib:integer4 n)
                                        (the f2cl-lib:integer4
                                             (f2cl-lib:int-add j k)))

...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  ...
  (defun zhbmv (uplo n k alpha a lda x incx beta y incy)
    (declare (type (array f2cl-lib:complex16 (*)) y x a)
             ...
             (type (simple-array character (1)) uplo))
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (kplus1 0) (kx 0)
        ...
        (cond
         ...
         ((< n 0) (setf info 2)) ((< k 0) (setf info 3))
         ((< lda (f2cl-lib:int-add k 1)) (setf info 6))
         ((= incx 0) (setf info 8)) ((= incy 0) (setf info 11)))
        (cond ((/= info 0) (xerbla "ZHBMV " info) (go end_label)))
           ...
           (t (setf jx kx) (setf jy ky)
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                ...
                (cond
                 ((> j k) (setf kx (f2cl-lib:int-add kx incx))

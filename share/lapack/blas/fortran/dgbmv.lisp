...
(let* ((one 1.0) (zero 0.0))
  ...
  (defun dgbmv (trans m n kl ku alpha a lda x incx beta y incy)
    (declare (type (array double-float (*)) y x a)
             ...
             (type (simple-array character (1)) trans))
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (k 0) (kup1 0)
        ...
        (declare
         (type (f2cl-lib:integer4) i info ix iy j jx jy k kup1 kx ky lenx leny)
        ...
        (cond
         ...
         ((< kl 0) (setf info 4)) ((< ku 0) (setf info 5))
         ((< lda (f2cl-lib:int-add kl ku 1)) (setf info 8))
         ((= incx 0) (setf info 10)) ((= incy 0) (setf info 13)))
        (cond ((/= info 0) (xerbla "DGBMV " info) (go end_label)))
                ...
                (cond
                 ((/= (f2cl-lib:fref x (jx) ((1 *))) zero)
                  (setf temp
                          (* alpha
                             (f2cl-lib:fref x-%data% (jx) ((1 *)) x-%offset%)))
                  (setf iy ky) (setf k (f2cl-lib:int-sub kup1 j))
                  (f2cl-lib:fdo (i
                                 (max (the f2cl-lib:integer4 1)
                                      (the f2cl-lib:integer4
                                           (f2cl-lib:int-add j

  ...
  (defun dlaqtr (ltran lreal n t$ ldt b w scale x work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((d (make-array 4 :element-type 'double-float))
        ...
        (setf scale one)
        (cond
         ((> xmax bignum) (setf scale (/ bignum xmax)) (dscal n1 scale x 1)
          (setf xmax bignum)))
        (cond
         (lreal
          (cond
                 ...
                 ((= j1 j2)
                  ...
                  (setf tmp
                          (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *))
                                         t$-%offset%))
                  (cond
                   ((< tjj smin) (setf tmp smin) (setf tjj smin)
                    (setf info 1)))
                  (if (= xj zero)
                      (go label30))
                  (cond
                   ((< tjj one)
                    (cond
                     ((> xj (* bignum tjj)) (setf rec (/ one xj))
                      (dscal n rec x 1) (setf scale (* scale rec))
                      (setf xmax (* xmax rec))))))
                 ...
                 (t
                  ...
                  (setf xmax
                          (max
                           ...
                           xmax))))
               label40)))))
         (t (setf sminw (max (* eps (abs w)) smin))
          (cond
           (notran (setf jnext n)
            (f2cl-lib:fdo (j n (f2cl-lib:int-add j (f2cl-lib:int-sub 1)))
                          ((> j 1) nil)
              (tagbody
                ...
                (cond
                 ((= j1 j2) (setf z w)
                  (if (= j1 1)
                      (setf z (f2cl-lib:fref b-%data% (1) ((1 *)) b-%offset%)))
                  (setf xj
                          (+
                           (abs
                            (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%))
                           (abs
                            (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j1))
                                           ((1 *)) x-%offset%))))
                  (setf tjj
                          (+
                           (abs
                  ...
                  (setf tmp
                          (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *))
                                         t$-%offset%))
                  (cond
                   ((< tjj sminw) (setf tmp sminw) (setf tjj sminw)
                    (setf info 1)))
                  (if (= xj zero)
                      (go label70))
                  (cond
                   ((< tjj one)
                    (cond
                     ((> xj (* bignum tjj)) (setf rec (/ one xj))
                      (dscal n2 rec x 1) (setf scale (* scale rec))
                      (setf xmax (* xmax rec))))))
                  (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
                      (dladiv (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%)
                       (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j1))
                                      ((1 *)) x-%offset%)
                       tmp z sr si)
                  ...
                  (setf (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j1))
                                       ((1 *)) x-%offset%)
                          si)
                  (setf xj
                          (+
                  ...
                  (cond
                   ((> j1 1)
                    ...
                    (daxpy (f2cl-lib:int-sub j1 1)
                     (-
                      (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j1)) ((1 *))
                                     x-%offset%))
                     (f2cl-lib:array-slice t$-%data% double-float (1 j1)
                                           ((1 ldt) (1 *)) t$-%offset%)
                     1
                     (f2cl-lib:array-slice x-%data% double-float ((+ n 1))
                                           ((1 *)) x-%offset%)
                     1)
                    (setf (f2cl-lib:fref x-%data% (1) ((1 *)) x-%offset%)
                            (+ (f2cl-lib:fref x-%data% (1) ((1 *)) x-%offset%)
                               (*
                                (f2cl-lib:fref b-%data% (j1) ((1 *))
                                               b-%offset%)
                                (f2cl-lib:fref x-%data%
                                               ((f2cl-lib:int-add n j1))
                                               ((1 *)) x-%offset%))))
                    (setf (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n 1))
                                         ((1 *)) x-%offset%)
                            (-
                             (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n 1))
                                            ((1 *)) x-%offset%)
                             (*
                              (f2cl-lib:fref b-%data% (j1) ((1 *)) b-%offset%)
                              (f2cl-lib:fref x-%data% (j1) ((1 *))
                                             x-%offset%))))
                    (setf xmax zero)
                 ...
                 (t
                  ...
                  (setf (f2cl-lib:fref d (2 2) ((1 2) (1 2)))
                          (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j2))
                                         ((1 *)) x-%offset%))
                  (multiple-value-bind
                      (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                       var-9 var-10 var-11 var-12 var-13 var-14 var-15 var-16
                  ...
                  (if (/= ierr 0)
                      (setf info 2))
                  (cond
                   ((/= scaloc one) (dscal (f2cl-lib:int-mul 2 n) scaloc x 1)
                  ...
                  (setf (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j2))
                                       ((1 *)) x-%offset%)
                  ...
                  (cond
                   ((> j1 1)
                    ...
                    (daxpy (f2cl-lib:int-sub j1 1)
                     (-
                      (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n j2)) ((1 *))
                                     x-%offset%))
                     (f2cl-lib:array-slice t$-%data% double-float (1 j2)
                                           ((1 ldt) (1 *)) t$-%offset%)
                     1
                    ...
                    (setf (f2cl-lib:fref x-%data% ((f2cl-lib:int-add n 1))
                            ...
                            (-
                             ...
                             (*
                              ...
                              (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%))
                             (*
                              (f2cl-lib:fref b-%data% (j2) ((1 *)) b-%offset%)
                              (f2cl-lib:fref x-%data% (j2) ((1 *))
                                             x-%offset%))))
                    (setf xmax zero)
                    (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                                  ((> k
                ...
                (cond
                 ((= j1 j2)
                  (setf xj
                          (+
                           (abs
                            (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%))
                           (abs
                            (f2cl-lib:fref x-%data% ((f2cl-lib:int-add j1 n))
                                           ((1 *)) x-%offset%))))
                  (cond
                   ((> xmax one) (setf rec (/ one xmax))
                    (cond
                          ...
                          (-
                           ...
                           (ddot (f2cl-lib:int-sub j1 1)
                            (f2cl-lib:array-slice t$-%data% double-float (1 j1)
                                                  ((1 ldt) (1 *)) t$-%offset%)
                            1
                            (f2cl-lib:array-slice x-%data% double-float
                                                  ((+ n 1)) ((1 *)) x-%offset%)
                            1)))
                  (cond
                   ((> j1 1)
                  ...
                  (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
                    ...
                    (setf si var-5))
                  (setf (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%) sr)
                  (setf (f2cl-lib:fref x-%data% ((f2cl-lib:int-add j1 n))
                                       ((1 *)) x-%offset%)
                          si)
                  (setf xmax
                          (max
                 ...
                 (t
                  ...
                  (if (/= ierr 0)
                      (setf info 2))
                  (cond
                   ((/= scaloc one) (dscal n2 scaloc x 1)
                    (setf scale (* scaloc scale))))
                  (setf (f2cl-lib:fref x-%data% (j1) ((1 *)) x-%offset%)
                          (f2cl-lib:fref v (1 1) ((1 2) (1 2))))
                  (setf (f2cl-lib:fref x-%data% (j2) ((1 *)) x-%offset%)

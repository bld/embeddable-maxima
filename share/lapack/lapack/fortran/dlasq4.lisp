    ...
    (defun dlasq4 (i0 n0 z pp n0in dmin dmin1$ dmin2 dn dn1 dn2 tau ttype)
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((a2 0.0) (b1 0.0) (b2 0.0) (gam 0.0) (gap1 0.0) (gap2 0.0)
          ...
          (cond
           ((<= dmin zero) (setf tau (- dmin)) (setf ttype -1) (go end_label)))
                      ...
                      (*
                       (f2cl-lib:fsqrt
                        (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 7))
                                       ((1 *)) z-%offset%))
                       (f2cl-lib:fsqrt
                        (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 9))
                                       ((1 *)) z-%offset%))))
              (setf a2
                      (+
                       (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 7))
                ...
                (cond
                 ...
                 (t (setf s zero)
                  (if (> dn b1)
                      (setf s (- dn b1)))
                  (if (> a2 (+ b1 b2))
                      (setf s (min s (- a2 (+ b1 b2)))))
                  (setf s (max s (* third$ dmin))) (setf ttype -3))))
               (t
                (tagbody
                  (setf ttype -4)
                  (setf s (* qurtr dmin))
                  (cond
                   ((= dmin dn) (setf gam dn) (setf a2 zero)
                    (if (>
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 5))
                                        ((1 *)) z-%offset%)
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 7))
                   ...
                   (t (setf np (f2cl-lib:int-sub nn (f2cl-lib:int-mul 2 pp)))
                    (setf b2
                            (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 2))
                                           ((1 *)) z-%offset%))
                    (setf gam dn1)
                    (if (>
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 4))
                                        ((1 *)) z-%offset%)
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 2))
                                        ((1 *)) z-%offset%))
                        (go end_label))
                    ...
                    (if (>
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 9))
                                        ((1 *)) z-%offset%)
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 11))
                                        ((1 *)) z-%offset%))
                        (go end_label))
                    (setf b2
                            (/
                  ...
                  (f2cl-lib:fdo (i4 np
                                ...
                                ((> i4
                                    (f2cl-lib:int-add (f2cl-lib:int-mul 4 i0)
                                                      (f2cl-lib:int-sub 1) pp))
                                 nil)
                    (tagbody
                      (if (= b2 zero)
                          (go label20))
                      (setf b1 b2)
                      (if (> (f2cl-lib:fref z-%data% (i4) ((1 *)) z-%offset%)
                             (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 2))
                                            ((1 *)) z-%offset%))
                          (go end_label))
                      (setf b2
                              (* b2
                  ...
                  (if (< a2 cnst1)
                      (setf s
                              (/ (* gam (- one (f2cl-lib:fsqrt a2)))
                                 (+ one a2))))))))
             ((= dmin dn2) (setf ttype -5) (setf s (* qurtr dmin))
              (setf np (f2cl-lib:int-sub nn (f2cl-lib:int-mul 2 pp)))
              (setf b1
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 2)) ((1 *))
                                     z-%offset%))
              (setf b2
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 6)) ((1 *))
                                     z-%offset%))
              (setf gam dn2)
              (if (or
                   (>
                    (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 8)) ((1 *))
                                   z-%offset%)
                    b2)
                   (>
                    (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 4)) ((1 *))
                                   z-%offset%)
                    b1))
                  (go end_label))
              (setf a2
                      (*
                       (/
                        (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub np 8))
                                       ((1 *)) z-%offset%)
                        b2)
                       (+ one
                          (/
              ...
              (cond
               ((> (f2cl-lib:int-add n0 (f2cl-lib:int-sub i0)) 2)
                (tagbody
                  (setf b2
                          (/
                           (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 13))
                                          ((1 *)) z-%offset%)
                           (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub nn 15))
                                          ((1 *)) z-%offset%)))
                  (setf a2 (+ a2 b2))
                  (f2cl-lib:fdo (i4 (f2cl-lib:int-add nn (f2cl-lib:int-sub 17))
                                 (f2cl-lib:int-add i4 (f2cl-lib:int-sub 4)))
                                ((> i4
                                    (f2cl-lib:int-add (f2cl-lib:int-mul 4 i0)
                                                      (f2cl-lib:int-sub 1) pp))
                 ...
                 label40
                  (setf a2 (* cnst3 a2)))))
              (if (< a2 cnst1)
                  (setf s (/ (* gam (- one (f2cl-lib:fsqrt a2))) (+ one a2)))))
             (t
              (cond
               ((= ttype (f2cl-lib:int-sub 6))
                (setf g (+ g (* third$ (- one g)))))
               ((= ttype (f2cl-lib:int-sub 18)) (setf g (* qurtr third$)))
               (t (setf g qurtr)))
              (setf s (* g dmin)) (setf ttype -6))))
              ...
              (tagbody
               ...
               label60
                ...
                (cond
                 ...
                 (t (setf s (max s (* a2 (- one (* cnst2 b2)))))
                  (setf ttype -8)))))
             (t (setf s (* qurtr dmin1$))
              (if (= dmin1$ dn1)
                  (setf s (* half dmin1$)))
              (setf ttype -9))))
                  ...
                  (setf s
                          (max s
                               (* a2
                                  (+ one (* (- cnst2) a2 (/ b2 gap2) b2))))))
                 (t (setf s (max s (* a2 (- one (* cnst2 b2)))))))))
             (t (setf s (* qurtr dmin2)) (setf ttype -11))))
           ((> n0in (f2cl-lib:int-add n0 2)) (setf s zero) (setf ttype -12)))
          (setf tau s)
          (go end_label)
         end_label
          (return
  ...
  (setf (gethash 'fortran-to-lisp::dlasq4
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil nil nil fortran-to-lisp::tau
                                              fortran-to-lisp::ttype)
                                            :calls 'nil)))

        ...
        (cond
         ((>= m n)
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i nb) nil)
            (tagbody
              (dgemv "No transpose" (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
               (f2cl-lib:int-sub i 1) (- one)
               (f2cl-lib:array-slice a-%data% double-float (i 1)
                                     ((1 lda) (1 *)) a-%offset%)
               lda
               (f2cl-lib:array-slice y-%data% double-float (i 1)
                                     ((1 ldy) (1 *)) y-%offset%)
               ldy one
              ...
              (dgemv "No transpose" (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
               (f2cl-lib:int-sub i 1) (- one)
               (f2cl-lib:array-slice x-%data% double-float (i 1)
                                     ((1 ldx) (1 *)) x-%offset%)
               ldx
              ...
              (cond
               ((< i n)
                (setf (f2cl-lib:fref a-%data% (i i) ((1 lda) (1 *)) a-%offset%)
                        one)
                (dgemv "Transpose" (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
                 ...
                 (f2cl-lib:array-slice a-%data% double-float (i i)
                                       ((1 lda) (1 *)) a-%offset%)
                 1 zero
                 (f2cl-lib:array-slice y-%data% double-float ((+ i 1) i)
                                       ((1 ldy) (1 *)) y-%offset%)
                 1)
                (dgemv "Transpose" (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
                 (f2cl-lib:int-sub i 1) one
                 ...
                 (f2cl-lib:array-slice a-%data% double-float (i i)
                                       ((1 lda) (1 *)) a-%offset%)
                 1 zero
                 (f2cl-lib:array-slice y-%data% double-float (1 i)
                                       ((1 ldy) (1 *)) y-%offset%)
                 1)
                (dgemv "No transpose" (f2cl-lib:int-sub n i)
                 (f2cl-lib:int-sub i 1) (- one)
                 (f2cl-lib:array-slice y-%data% double-float ((+ i 1) 1)
                                       ((1 ldy) (1 *)) y-%offset%)
                 ldy
                 (f2cl-lib:array-slice y-%data% double-float (1 i)
                                       ((1 ldy) (1 *)) y-%offset%)
                ...
                (dgemv "No transpose" (f2cl-lib:int-sub m i)
                 ...
                 (f2cl-lib:array-slice a-%data% double-float
                                       ...
                                       ((1 lda) (1 *)) a-%offset%)
                 lda zero
                 (f2cl-lib:array-slice x-%data% double-float ((+ i 1) i)
                                       ((1 ldx) (1 *)) x-%offset%)
                 1)
                (dgemv "Transpose" (f2cl-lib:int-sub n i) i one
                 ...
                 (f2cl-lib:array-slice a-%data% double-float
                                       ...
                                       ((1 lda) (1 *)) a-%offset%)
                 lda zero
                 (f2cl-lib:array-slice x-%data% double-float (1 i)
                                       ((1 ldx) (1 *)) x-%offset%)
                 1)
                (dgemv "No transpose" (f2cl-lib:int-sub m i) i (- one)
                 (f2cl-lib:array-slice a-%data% double-float ((+ i 1) 1)
                                       ((1 lda) (1 *)) a-%offset%)
                 lda
                 (f2cl-lib:array-slice x-%data% double-float (1 i)
                                       ((1 ldx) (1 *)) x-%offset%)
                ...
                (dgemv "No transpose" (f2cl-lib:int-sub m i)
                 (f2cl-lib:int-sub i 1) (- one)
                 (f2cl-lib:array-slice x-%data% double-float ((+ i 1) 1)
                                       ((1 ldx) (1 *)) x-%offset%)
                 ldx
                 (f2cl-lib:array-slice x-%data% double-float (1 i)
                                       ((1 ldx) (1 *)) x-%offset%)
         ...
         (t
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i nb) nil)
            (tagbody
              (dgemv "No transpose" (f2cl-lib:int-add (f2cl-lib:int-sub n i) 1)
               (f2cl-lib:int-sub i 1) (- one)
               (f2cl-lib:array-slice y-%data% double-float (i 1)
                                     ((1 ldy) (1 *)) y-%offset%)
               ldy
               ...
               ((< i m)
                ...
                (dgemv "No transpose" (f2cl-lib:int-sub m i)
                 ...
                 (f2cl-lib:array-slice x-%data% double-float ((+ i 1) i)
                                       ((1 ldx) (1 *)) x-%offset%)
                 1)
                (dgemv "Transpose" (f2cl-lib:int-add (f2cl-lib:int-sub n i) 1)
                 (f2cl-lib:int-sub i 1) one
                 (f2cl-lib:array-slice y-%data% double-float (i 1)
                                       ((1 ldy) (1 *)) y-%offset%)
                 ldy

  ...
  (defun dorgbr (vect m n k a lda tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (iinfo 0) (j 0) (lwkopt 0) (mn 0) (nb 0) (lquery nil)
        ...
        (cond
         ((= info 0)
          (cond (wantq (setf nb (ilaenv 1 "DORGQR" " " m n k -1)))
                (t (setf nb (ilaenv 1 "DORGLQ" " " m n k -1))))
          (setf lwkopt
                  (f2cl-lib:int-mul
                   (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 mn))
                   nb))
        ...
        (cond
         ((/= info 0) (xerbla "DORGBR" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (cond
         ((or (= m 0) (= n 0))
          (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%)
             ...
             ((> m 1)
              (multiple-value-bind
                  ...
                  (dorgqr (f2cl-lib:int-sub m 1) (f2cl-lib:int-sub m 1)
                   ...
                   (f2cl-lib:array-slice a-%data% double-float (2 2)
                                         ((1 lda) (1 *)) a-%offset%)

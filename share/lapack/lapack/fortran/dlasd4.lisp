      ...
      (prog ((dd (make-array 3 :element-type 'double-float))
        ...
        (declare (type (array double-float (3)) dd zz)
                 (type (double-float) a b c delsq delsq2 dphi dpsi dtiim dtiip
                  dtipsq dtisq dtnsq dtnsq1 dw eps erretm eta phi prew psi
                  rhoinv sg2lb sg2ub tau temp temp1 temp2 w)
                  ...
                  (f2cl-lib:fsqrt
                   (+
                    (* (f2cl-lib:fref d-%data% (1) ((1 *)) d-%offset%)
                       (f2cl-lib:fref d-%data% (1) ((1 *)) d-%offset%))
                    (* rho (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%)
        ...
        (setf rhoinv (/ one rho))
        (cond
         ((= i n) (setf ii (f2cl-lib:int-sub n 1)) (setf niter 1)
          (setf temp (/ rho two))
          (setf temp1
                  (/ temp
          ...
          (cond
           ((<= w zero)
            ...
            (setf temp
                    (+
                     (/
                      (*
                       (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub n 1)) ((1 *))
                                      z-%offset%)
                       (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub n 1)) ((1 *))
                                      z-%offset%))
                      (*
                       (+
                        (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub n 1))
                                       ((1 *)) d-%offset%)
                        temp1)
                       (+
                        (- (f2cl-lib:fref d-%data% (n) ((1 *)) d-%offset%)
            ...
            (cond ((<= c temp) (setf tau rho))
                  (t
                   ...
                   (setf a
                           (+ (* (- c) delsq)
                              (*
                               (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub n 1))
                                              ((1 *)) z-%offset%)
                               (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub n 1))
                                              ((1 *)) z-%offset%))
                              (*
                               (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%)
                               (f2cl-lib:fref z-%data% (n) ((1 *))
                                              z-%offset%))))
                   (setf b
                           (* (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%)
                              (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%)
           ...
           (t
            ...
            (setf b
                    (* (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%)
                       (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%) delsq))
            (cond
             ((< a zero)
              (setf tau
                      (/ (* two b)
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                      (+ (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                         (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) eta))
             label30))
          (setf dpsi zero) (setf psi zero) (setf erretm zero)
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j ii) nil)
            (tagbody
              (setf temp
          ...
          (setf dphi (* temp temp))
          (setf erretm
                  (+ (- (+ (* eight (- (- psi) phi)) erretm) phi) rhoinv
                     (* (abs tau) (+ dpsi dphi))))
          (setf w (+ rhoinv phi psi))
          (cond ((<= (abs w) (* eps erretm)) (go label240)))
          (setf niter (f2cl-lib:int-add niter 1))
          (setf dtnsq1
                  (*
                   (f2cl-lib:fref work-%data% ((f2cl-lib:int-sub n 1)) ((1 *))
                                  work-%offset%)
                   (f2cl-lib:fref delta-%data% ((f2cl-lib:int-sub n 1)) ((1 *))
                                  delta-%offset%)))
          (setf dtnsq
          ...
          (if (< c zero)
              (setf c (abs c)))
          (cond ((= c zero) (setf eta (- rho (* sigma sigma))))
                ((>= a zero)
                 (setf eta
                         (/
                          (+ a
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                      (+ (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                         eta))
             label50))
          (setf sigma (+ sigma eta)) (setf dpsi zero) (setf psi zero)
          (setf erretm zero)
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j ii) nil)
            (tagbody
          ...
          (setf erretm
                  (+ (- (+ (* eight (- (- psi) phi)) erretm) phi) rhoinv
                     (* (abs tau) (+ dpsi dphi))))
          (setf w (+ rhoinv phi psi)) (setf iter (f2cl-lib:int-add niter 1))
          (f2cl-lib:fdo (niter iter (f2cl-lib:int-add niter 1))
            ...
            (tagbody
              ...
              (setf dtnsq1
                      (*
                       (f2cl-lib:fref work-%data% ((f2cl-lib:int-sub n 1))
                                      ((1 *)) work-%offset%)
                       (f2cl-lib:fref delta-%data% ((f2cl-lib:int-sub n 1))
                                      ((1 *)) delta-%offset%)))
              (setf dtnsq
                      (* (f2cl-lib:fref work-%data% (n) ((1 *)) work-%offset%)
                         (f2cl-lib:fref delta-%data% (n) ((1 *))
                      ...
                      (/ (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%)
                         (*
                          ...
                          (f2cl-lib:fref delta-%data% (n) ((1 *))
                                         delta-%offset%))))
              (setf phi
                      (* (f2cl-lib:fref z-%data% (n) ((1 *)) z-%offset%) temp))
              (setf dphi (* temp temp))
              (setf erretm
                      (+ (- (+ (* eight (- (- psi) phi)) erretm) phi) rhoinv
                         (* (abs tau) (+ dpsi dphi))))
              (setf w (+ rhoinv phi psi))
             label90))
          (setf info 1) (go label240))
         (t (setf niter 1) (setf ip1 (f2cl-lib:int-add i 1))
          (setf delsq
                  (*
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                      (+ (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                         (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) temp))
              (setf (f2cl-lib:fref delta-%data% (j) ((1 *)) delta-%offset%)
                      (- (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                         (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) temp))
             label100))
                  ...
                  (+ c
                     ...
                     (/
                      ...
                      (*
                       ...
                       (f2cl-lib:fref delta-%data% (ip1) ((1 *))
                                      delta-%offset%)))))
          (cond
           ((> w zero) (setf orgati f2cl-lib:%true%) (setf sg2lb zero)
            (setf sg2ub delsq2)
            (setf a
                    (+ (* c delsq)
                       (* (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
            ...
            (setf b
                    (* (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                       (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%) delsq))
            (cond
             ((> a zero)
              (setf tau
                      (/ (* two b)
                          ...
                          (f2cl-lib:fsqrt
                           (+
                            (* (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%)
                               (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%))
                            tau))))))
           (t (setf orgati f2cl-lib:%false%) (setf sg2lb (- delsq2))
            (setf sg2ub zero)
            (setf a
                    (- (* c delsq)
                       (* (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
            ...
            (cond
             ...
             (t
              (setf tau
                      (/
                       (-
                        (+ a (f2cl-lib:fsqrt (abs (+ (* a a) (* four b c))))))
                       (* two c)))))
            (setf eta
                    (/ tau
                       (+ (f2cl-lib:fref d-%data% (ip1) ((1 *)) d-%offset%)
              ...
              (tagbody
                ...
                (setf (f2cl-lib:fref delta-%data% (j) ((1 *)) delta-%offset%)
                        (- (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                           ...
                           eta))
               label130)))
           (t (setf ii (f2cl-lib:int-add i 1))
            (setf sigma
          ...
          (setf iip1 (f2cl-lib:int-add ii 1)) (setf dpsi zero) (setf psi zero)
          (setf erretm zero)
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j iim1) nil)
            (tagbody
              ...
              (setf erretm (+ erretm psi))
             label150))
          (setf erretm (abs erretm)) (setf dphi zero) (setf phi zero)
          (f2cl-lib:fdo (j n (f2cl-lib:int-add j (f2cl-lib:int-sub 1)))
                        ((> j iip1) nil)
            (tagbody
              (setf temp
             ...
             label160))
          (setf w (+ rhoinv phi psi)) (setf swtch3 f2cl-lib:%false%)
          (cond
           (orgati
            (if (< w zero)
                (setf swtch3 f2cl-lib:%true%)))
           (t
            (if (> w zero)
                (setf swtch3 f2cl-lib:%true%))))
          (if (or (= ii 1) (= ii n))
          ...
          (setf temp
                  (/ (f2cl-lib:fref z-%data% (ii) ((1 *)) z-%offset%)
                     (* (f2cl-lib:fref work-%data% (ii) ((1 *)) work-%offset%)
                        (f2cl-lib:fref delta-%data% (ii) ((1 *))
                                       delta-%offset%))))
          (setf dw (+ dpsi dphi (* temp temp)))
          (setf temp (* (f2cl-lib:fref z-%data% (ii) ((1 *)) z-%offset%) temp))
          (setf w (+ w temp))
          (setf erretm
                  (+ (* eight (- phi psi)) erretm (* two rhoinv)
                     (* three (abs temp)) (* (abs tau) dw)))
          (cond ((<= (abs w) (* eps erretm)) (go label240)))
          (cond ((<= w zero) (setf sg2lb (max sg2lb tau)))
                (t (setf sg2ub (min sg2ub tau))))
          (setf niter (f2cl-lib:int-add niter 1))
          (cond
           ((not swtch3)
            (setf dtipsq
           ...
           (t
            (setf dtiim
                    (* (f2cl-lib:fref work-%data% (iim1) ((1 *)) work-%offset%)
                       (f2cl-lib:fref delta-%data% (iim1) ((1 *))
                                      delta-%offset%)))
            (setf dtiip
                    (* (f2cl-lib:fref work-%data% (iip1) ((1 *)) work-%offset%)
                       (f2cl-lib:fref delta-%data% (iip1) ((1 *))
                                      delta-%offset%)))
              ...
              (setf c
                      (+ (- temp (* dtiip (+ dpsi dphi)))
                         (*
                          (-
                           (-
                            (f2cl-lib:fref d-%data% (iim1) ((1 *)) d-%offset%)
                            (f2cl-lib:fref d-%data% (iip1) ((1 *))
                                           d-%offset%)))
                          (+ (f2cl-lib:fref d-%data% (iim1) ((1 *)) d-%offset%)
                             (f2cl-lib:fref d-%data% (iip1) ((1 *))
                                            d-%offset%))
              ...
              (setf c
                      (+ (- temp (* dtiim (+ dpsi dphi)))
                         (*
                          (-
                           (-
                            (f2cl-lib:fref d-%data% (iip1) ((1 *)) d-%offset%)
                            (f2cl-lib:fref d-%data% (iim1) ((1 *))
                                           d-%offset%)))
                          (+ (f2cl-lib:fref d-%data% (iim1) ((1 *)) d-%offset%)
                             (f2cl-lib:fref d-%data% (iip1) ((1 *))
                                            d-%offset%))
          ...
          (cond
           ((or (> temp sg2ub) (< temp sg2lb))
            (cond ((< w zero) (setf eta (/ (- sg2ub tau) two)))
                  (t (setf eta (/ (- sg2lb tau) two))))))
          (setf tau (+ tau eta))
          (setf eta (/ eta (+ sigma (f2cl-lib:fsqrt (+ (* sigma sigma) eta)))))
          (setf prew w) (setf sigma (+ sigma eta))
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j n) nil)
            (tagbody
              (setf (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
            ...
            (tagbody
              ...
              (cond
                ...
                (cond
                 ...
                 (t
                  (setf temp
                          (/ (f2cl-lib:fref z-%data% (ii) ((1 *)) z-%offset%)
                             (*
                              (f2cl-lib:fref work-%data% (ii) ((1 *))
                                             work-%offset%)
                              (f2cl-lib:fref delta-%data% (ii) ((1 *))
                                             delta-%offset%))))
                  (cond (orgati (setf dpsi (+ dpsi (* temp temp))))
                        (t (setf dphi (+ dphi (* temp temp)))))
               ...
               (t
                (setf dtiim
                        (*
                         (f2cl-lib:fref work-%data% (iim1) ((1 *))
                                        work-%offset%)
                         (f2cl-lib:fref delta-%data% (iim1) ((1 *))
                                        delta-%offset%)))
                (setf dtiip
                        (*
                         (f2cl-lib:fref work-%data% (iip1) ((1 *))
                                        work-%offset%)
                         (f2cl-lib:fref delta-%data% (iip1) ((1 *))
                                        delta-%offset%)))
                (setf temp (+ rhoinv psi phi))
                (cond
                 (swtch (setf c (- temp (* dtiim dpsi) (* dtiip dphi)))
                  (setf (f2cl-lib:fref zz (1) ((1 3))) (* dtiim dtiim dpsi))
                  (setf (f2cl-lib:fref zz (3) ((1 3))) (* dtiip dtiip dphi)))
                 (t
                  (cond

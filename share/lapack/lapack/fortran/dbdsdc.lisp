      ...
      (prog ((cs 0.0) (eps 0.0) (orgnrm 0.0) (p 0.0) (r 0.0) (sn 0.0) (difl 0)
        ...
        (declare (type (double-float) cs eps orgnrm p r sn)
                 (type (f2cl-lib:integer4) difl difr givcol givnum givptr i ic
                  icompq ierr ii is iu iuplo ivt j k kk mlvl nm1 nsize perm
                  poles qstart smlsiz smlszp sqre start wstart z))
        (setf info 0)
        (setf iuplo 0)
        (if (lsame uplo "U")
            (setf iuplo 1))
        (if (lsame uplo "L")
            (setf iuplo 2))
        (cond ((lsame compq "N") (setf icompq 0))
              ((lsame compq "P") (setf icompq 1))
              ((lsame compq "I") (setf icompq 2)) (t (setf icompq -1)))
        (cond ((= iuplo 0) (setf info -1)) ((< icompq 0) (setf info -2))
              ((< n 0) (setf info -3))
              ((or (< ldu 1) (and (= icompq 2) (< ldu n))) (setf info -7))
              ((or (< ldvt 1) (and (= icompq 2) (< ldvt n))) (setf info -9)))
        (cond
         ((/= info 0) (xerbla "DBDSDC" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= n 0)
            (go end_label))
           ...
           ((= icompq 2)
            (setf (f2cl-lib:fref u-%data% (1 1) ((1 ldu) (1 *)) u-%offset%)
                    (f2cl-lib:sign one
                                   (f2cl-lib:fref d-%data% (1) ((1 *))
                                                  d-%offset%)))
            (setf (f2cl-lib:fref vt-%data% (1 1) ((1 ldvt) (1 *)) vt-%offset%)
                    one)))
        ...
        (cond
         ((= icompq 1)
          ...
          (dcopy (f2cl-lib:int-sub n 1) e 1
           (f2cl-lib:array-slice q-%data% double-float ((+ n 1)) ((1 *))
                                 q-%offset%)
           1)))
        (cond
         ((= iuplo 2) (setf qstart 5)
         ...
         ((= icompq 0)
          (multiple-value-bind
              ...
              (dlasdq "U" 0 n 0 0 0 d e vt ldvt u ldu u ldu
               (f2cl-lib:array-slice work-%data% double-float (wstart) ((1 *))
                                     work-%offset%)
               info)
            (declare
        ...
        (cond
         ((<= n smlsiz)
          (cond
           ((= icompq 2) (dlaset "A" n n zero one u ldu)
            (dlaset "A" n n zero one vt ldvt)
            (multiple-value-bind
                (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                 var-10 var-11 var-12 var-13 var-14 var-15)
                (dlasdq "U" 0 n n n 0 d e vt ldvt u ldu u ldu
                 (f2cl-lib:array-slice work-%data% double-float (wstart)
                                       ((1 *)) work-%offset%)
                 info)
              (declare
               (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                var-9 var-10 var-11 var-12 var-13 var-14))
              (setf info var-15)))
           ((= icompq 1) (setf iu 1) (setf ivt (f2cl-lib:int-add iu n))
            (dlaset "A" n n zero one
             (f2cl-lib:array-slice q-%data% double-float
                                   ((+ iu
                                       (f2cl-lib:int-mul
        ...
        (cond
         ((= icompq 1) (setf iu 1) (setf ivt (f2cl-lib:int-add 1 smlsiz))
          ...
          (setf ic (f2cl-lib:int-add z mlvl)) (setf is (f2cl-lib:int-add ic 1))
          (setf poles (f2cl-lib:int-add is 1))
          (setf givnum (f2cl-lib:int-add poles (f2cl-lib:int-mul 2 mlvl)))
          (setf k 1) (setf givptr 2) (setf perm 3)
            ...
            (cond
             ((or (< (abs (f2cl-lib:fref e (i) ((1 *)))) eps) (= i nm1))
              (cond
               ...
               (t (setf nsize (f2cl-lib:int-add (f2cl-lib:int-sub i start) 1))
                (cond
                 ((= icompq 2)
                  (setf (f2cl-lib:fref u-%data% (n n) ((1 ldu) (1 *))
                                       u-%offset%)
                          (f2cl-lib:sign one
                                         (f2cl-lib:fref d-%data% (n) ((1 *))
                                                        d-%offset%)))
                  (setf (f2cl-lib:fref vt-%data% (n n) ((1 ldvt) (1 *))
                                       vt-%offset%)
                          one))
                 ((= icompq 1)
                  (setf (f2cl-lib:fref q-%data%
               ...
               ((= icompq 2)
                (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                     var-9 var-10 var-11)
                    (dlasd0 nsize sqre
                     (f2cl-lib:array-slice d-%data% double-float (start)
                                           ((1 *)) d-%offset%)
                     (f2cl-lib:array-slice e-%data% double-float (start)
                                           ((1 *)) e-%offset%)
                     (f2cl-lib:array-slice u-%data% double-float (start start)
                                           ((1 ldu) (1 *)) u-%offset%)
                     ldu
                     (f2cl-lib:array-slice vt-%data% double-float (start start)
                                           ((1 ldvt) (1 *)) vt-%offset%)
                     ldvt smlsiz iwork
                     (f2cl-lib:array-slice work-%data% double-float (wstart)
                                           ((1 *)) work-%offset%)
                ...
                (multiple-value-bind
                    ...
                    (dlasda icompq smlsiz nsize sqre
                     ...
                     (f2cl-lib:array-slice q-%data% double-float
                                           ((+ start
                                               (f2cl-lib:int-mul
                                                (f2cl-lib:int-add ivt qstart
                                                                  (f2cl-lib:int-sub
                                                                   2))
                                                n)))
                                           ((1 *)) q-%offset%)
                     (f2cl-lib:array-slice iq-%data% f2cl-lib:integer4
                                           ((+ start (f2cl-lib:int-mul k n)))
                                           ((1 *)) iq-%offset%)
                     (f2cl-lib:array-slice q-%data% double-float
                                           ((+ start
                                               (f2cl-lib:int-mul
                                                (f2cl-lib:int-add difl qstart
                                                                  (f2cl-lib:int-sub
                                                                   2))
                                                n)))
                                           ((1 *)) q-%offset%)
                     ...
                     (f2cl-lib:array-slice q-%data% double-float
                                           ((+ start
                                               (f2cl-lib:int-mul
                                                (f2cl-lib:int-add givnum qstart
                                                                  (f2cl-lib:int-sub
                                                                   2))
                                                n)))
                                           ((1 *)) q-%offset%)
        ...
        (f2cl-lib:fdo (ii 2 (f2cl-lib:int-add ii 1))
          ...
          (tagbody
            ...
            (f2cl-lib:fdo (j ii (f2cl-lib:int-add j 1))
              ...
              (tagbody
                (cond
                 ((> (f2cl-lib:fref d (j) ((1 *))) p) (setf kk j)
               ...
               ((= icompq 2)
                (dswap n
                 (f2cl-lib:array-slice u-%data% double-float (1 i)
                                       ((1 ldu) (1 *)) u-%offset%)
                 1
                 (f2cl-lib:array-slice u-%data% double-float (1 kk)
                                       ((1 ldu) (1 *)) u-%offset%)
                 1)
                (dswap n
                 (f2cl-lib:array-slice vt-%data% double-float (i 1)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 ldvt
                 (f2cl-lib:array-slice vt-%data% double-float (kk 1)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 ldvt))))
             ((= icompq 1)
        ...
        (cond
         ((= icompq 1)
          (cond
           ...
           (t (setf (f2cl-lib:fref iq-%data% (n) ((1 *)) iq-%offset%) 0)))))
  ...
  (setf (gethash 'fortran-to-lisp::dbdsdc
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::dlasr
                                              ...
                                              fortran-to-lisp::dlasda
                                              fortran-to-lisp::dlasd0

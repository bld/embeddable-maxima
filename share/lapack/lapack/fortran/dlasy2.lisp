...
(let* ((zero 0.0) (one 1.0) (two 2.0) (half 0.5) (eight 8.0))
  ...
  (let ((bswpiv
        ...
        (locu22
         (make-array 4 :element-type 'f2cl-lib:integer4 :initial-contents
                     '(4 3 2 1)))
        (locl21
         (make-array 4 :element-type 'f2cl-lib:integer4 :initial-contents
                     '(2 1 4 3)))
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((btmp (make-array 4 :element-type 'double-float))
         ...
         label10
          (setf tau1
                  (+
                   ...
                   (* sgn
                      (f2cl-lib:fref tr-%data% (1 1) ((1 ldtr) (1 *))
                                     tr-%offset%))))
          (setf bet (abs tau1))
          (cond
           ((<= bet smlnum) (setf tau1 smlnum) (setf bet smlnum)
            (setf info 1)))
          (setf scale one)
          (setf gam
                  (abs
                      ...
                      (max
                       ...
                       (abs
                        (f2cl-lib:fref tr-%data% (1 1) ((1 ldtr) (1 *))
                                       tr-%offset%))
                       (abs
                        (f2cl-lib:fref tr-%data% (1 2) ((1 ldtr) (1 *))
                                       tr-%offset%))
                       (abs
                        (f2cl-lib:fref tr-%data% (2 1) ((1 ldtr) (1 *))
                                       tr-%offset%))
                       (abs
                        (f2cl-lib:fref tr-%data% (2 2) ((1 ldtr) (1 *))
                                       tr-%offset%))))
                   smlnum))
                      ...
                      (max
                       ...
                       (abs
                        (f2cl-lib:fref tl-%data% (1 1) ((1 ldtl) (1 *))
                                       tl-%offset%))
                       (abs
                        (f2cl-lib:fref tl-%data% (1 2) ((1 ldtl) (1 *))
                                       tl-%offset%))
                       (abs
                        (f2cl-lib:fref tl-%data% (2 1) ((1 ldtl) (1 *))
                                       tl-%offset%))
                       (abs
         ...
         label40
          ...
          (cond ((<= (abs u11) smin) (setf info 1) (setf u11 smin)))
          (setf u12
                  (f2cl-lib:fref tmp ((f2cl-lib:fref locu12 (ipiv) ((1 4))))
                                 ((1 4))))
          (setf l21
                  (/
                   (f2cl-lib:fref tmp ((f2cl-lib:fref locl21 (ipiv) ((1 4))))
                                  ((1 4)))
                   u11))
          (setf u22
                  (-
                   (f2cl-lib:fref tmp ((f2cl-lib:fref locu22 (ipiv) ((1 4))))
                                  ((1 4)))
                   (* u12 l21)))
          (setf xswap (f2cl-lib:fref xswpiv (ipiv) ((1 4))))
          (setf bswap (f2cl-lib:fref bswpiv (ipiv) ((1 4))))
          (cond ((<= (abs u22) smin) (setf info 1) (setf u22 smin)))
          (cond
           (bswap (setf temp (f2cl-lib:fref btmp (2) ((1 4))))
            (setf (f2cl-lib:fref btmp (2) ((1 4)))
          ...
          (cond
           (xswap (setf temp (f2cl-lib:fref x2 (2) ((1 2))))
            (setf (f2cl-lib:fref x2 (2) ((1 2)))
         ...
         label50
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
                    ...
                    (tagbody
                      (cond
                       ((>= (abs (f2cl-lib:fref t16 (ip jp) ((1 4) (1 4))))
                        ...
                        (setf ipsv ip) (setf jpsv jp)))
                     label60))
                 label70))
              (cond
               ((/= ipsv i)
                (dswap 4
                 (f2cl-lib:array-slice t16 double-float (ipsv 1) ((1 4) (1 4)))
              ...
              (if (/= jpsv i)
                  (dswap 4
                   (f2cl-lib:array-slice t16 double-float (1 jpsv)
                                         ((1 4) (1 4)))
                   1
                ...
                (tagbody
                  (setf (f2cl-lib:fref tmp (k) ((1 4)))
                          (- (f2cl-lib:fref tmp (k) ((1 4)))
                             (* temp (f2cl-lib:fref t16 (k j) ((1 4) (1 4)))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil nil nil nil nil scale nil nil
                   xnorm info)))))))

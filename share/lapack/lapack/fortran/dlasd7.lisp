    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((eps 0.0) (hlftol 0.0) (tau 0.0) (tol 0.0) (z1 0.0) (i 0) (idxi 0)
        ...
        (cond ((or (< icompq 0) (> icompq 1)) (setf info -1))
              ((< nl 1) (setf info -2)) ((< nr 1) (setf info -3))
              ((or (< sqre 0) (> sqre 1)) (setf info -4))
              ((< ldgcol n) (setf info -22)) ((< ldgnum n) (setf info -24)))
        (cond
         ((/= info 0) (xerbla "DLASD7" (f2cl-lib:int-sub info))
          (go end_label)))
        (setf nlp1 (f2cl-lib:int-add nl 1))
        (setf nlp2 (f2cl-lib:int-add nl 2))
        (cond ((= icompq 1) (setf givptr 0)))
        (setf z1
        ...
        (f2cl-lib:fdo (i nl (f2cl-lib:int-add i (f2cl-lib:int-sub 1)))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref vf-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                 vf-%offset%)
        ...
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref vfw-%data% (i) ((1 *)) vfw-%offset%)
                    (f2cl-lib:fref vf-%data% ((f2cl-lib:fref idxq (i) ((1 *))))
                                   ((1 *)) vf-%offset%))
            (setf (f2cl-lib:fref vlw-%data% (i) ((1 *)) vlw-%offset%)
                    (f2cl-lib:fref vl-%data% ((f2cl-lib:fref idxq (i) ((1 *))))
                                   ((1 *)) vl-%offset%))
           label40))
        (dlamrg nl nr
         ...
         (t
          (cond
           ((<=
            ...
            (setf c (/ c tau)) (setf s (/ (- s) tau))
            (cond
             ((= icompq 1) (setf givptr (f2cl-lib:int-add givptr 1))
              (setf idxjp
              ...
              (setf (f2cl-lib:fref givcol-%data% (givptr 2) ((1 ldgcol) (1 *))
                                   givcol-%offset%)
                      idxjp)
              (setf (f2cl-lib:fref givcol-%data% (givptr 1) ((1 ldgcol) (1 *))
                                   givcol-%offset%)
                      idxj)
              (setf (f2cl-lib:fref givnum-%data% (givptr 2) ((1 ldgnum) (1 *))
                                   givnum-%offset%)
                      c)
              (setf (f2cl-lib:fref givnum-%data% (givptr 1) ((1 ldgnum) (1 *))
                                   givnum-%offset%)
                      s)))
            (drot 1
             (f2cl-lib:array-slice vf-%data% double-float (jprev) ((1 *))
                                   vf-%offset%)
             1
             (f2cl-lib:array-slice vf-%data% double-float (j) ((1 *))
                                   vf-%offset%)
             1 c s)
            (drot 1
             (f2cl-lib:array-slice vl-%data% double-float (jprev) ((1 *))
                                   vl-%offset%)
             1
             (f2cl-lib:array-slice vl-%data% double-float (j) ((1 *))
                                   vl-%offset%)
             1 c s)
            (setf k2 (f2cl-lib:int-sub k2 1))
       ...
       label100
          ...
          (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref perm-%data% (j) ((1 *)) perm-%offset%)
                      (f2cl-lib:fref idxq-%data%
                                     ((f2cl-lib:int-add
                                       (f2cl-lib:fref idx (jp) ((1 *))) 1))
                                     ((1 *)) idxq-%offset%))
              (cond
               ((<= (f2cl-lib:fref perm (j) ((1 *))) nlp1)
                (setf (f2cl-lib:fref perm-%data% (j) ((1 *)) perm-%offset%)
                        (f2cl-lib:int-sub
                         (f2cl-lib:fref perm-%data% (j) ((1 *)) perm-%offset%)
                         1))))
             label120))))
        ...
        (cond
         ((> m n)
          ...
          (drot 1
           (f2cl-lib:array-slice vf-%data% double-float (m) ((1 *))
                                 vf-%offset%)
           1
           (f2cl-lib:array-slice vf-%data% double-float (1) ((1 *))
                                 vf-%offset%)
           1 c s)
          (drot 1
           (f2cl-lib:array-slice vl-%data% double-float (m) ((1 *))
                                 vl-%offset%)
           1
           (f2cl-lib:array-slice vl-%data% double-float (1) ((1 *))
                                 vl-%offset%)
           1 c s))
         (t
          (cond
        ...
        (dcopy (f2cl-lib:int-sub n 1)
         (f2cl-lib:array-slice vfw-%data% double-float (2) ((1 *))
                               vfw-%offset%)
         1
         (f2cl-lib:array-slice vf-%data% double-float (2) ((1 *)) vf-%offset%)
         1)
        (dcopy (f2cl-lib:int-sub n 1)
         (f2cl-lib:array-slice vlw-%data% double-float (2) ((1 *))
                               vlw-%offset%)
         1
       ...
       end_label
        (return
         (values nil nil nil nil k nil nil nil nil nil nil nil nil nil nil nil
                 nil nil nil givptr nil nil nil nil c s info))))))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlasd7
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :return-values
                                            '(nil nil nil nil
                                              fortran-to-lisp::k nil nil nil
                                              nil nil nil nil nil nil nil nil
                                              nil nil nil
                                              fortran-to-lisp::givptr nil nil
                                              nil nil fortran-to-lisp::c
                                              fortran-to-lisp::s

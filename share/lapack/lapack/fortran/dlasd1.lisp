    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((orgnrm 0.0) (coltyp 0) (i 0) (idx 0) (idxc 0) (idxp 0) (iq 0)
        ...
        (cond ((< nl 1) (setf info -1)) ((< nr 1) (setf info -2))
              ((or (< sqre 0) (> sqre 1)) (setf info -3)))
        (cond
         ((/= info 0) (xerbla "DLASD1" (f2cl-lib:int-sub info))
          (go end_label)))
        ...
        (multiple-value-bind
            ...
            (dlasd2 nl nr sqre k d
             (f2cl-lib:array-slice work-%data% double-float (iz) ((1 *))
                                   work-%offset%)
             alpha beta u ldu vt ldvt
             (f2cl-lib:array-slice work-%data% double-float (isigma) ((1 *))
                                   work-%offset%)
             (f2cl-lib:array-slice work-%data% double-float (iu2) ((1 *))
                                   work-%offset%)
             ldu2
             (f2cl-lib:array-slice work-%data% double-float (ivt2) ((1 *))
                                   work-%offset%)
             ldvt2
             ...
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (idx) ((1 *))
                                   iwork-%offset%)
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (idxc)
                                   ((1 *)) iwork-%offset%)
             idxq
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (coltyp)
                                   ((1 *)) iwork-%offset%)
             info)
          (declare
           (ignore var-0 var-1 var-2 var-4 var-5 var-6 var-7 var-8 var-9 var-10
            var-11 var-12 var-13 var-14 var-15 var-16 var-17 var-18 var-19
            var-20 var-21))
          (setf k var-3)
          (setf info var-22))
        ...
        (multiple-value-bind
            ...
            (dlasd3 nl nr sqre k d
             (f2cl-lib:array-slice work-%data% double-float (iq) ((1 *))
                                   work-%offset%)
             ldq
             (f2cl-lib:array-slice work-%data% double-float (isigma) ((1 *))
                                   work-%offset%)
       ...
       end_label
        (return
         (values nil nil nil nil alpha beta nil nil nil nil nil nil nil
                 info))))))
  ...
  (setf (gethash 'fortran-to-lisp::dlasd1
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil
                                              ...
                                              fortran-to-lisp::beta nil nil nil
                                              nil nil nil nil

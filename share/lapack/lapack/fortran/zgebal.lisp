        ...
        (prog ((cdum #C(0.0 0.0)) (c 0.0) (ca 0.0) (f 0.0) (g 0.0) (r 0.0)
          ...
          (cond
           ...
           ((< lda (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 n)))
            (setf info -4)))
          (cond
           ((/= info 0) (xerbla "ZGEBAL" (f2cl-lib:int-sub info))
            (go end_label)))
          (setf k 1)
          (setf l n)
          (if (= n 0)
         ...
         label20
          ...
          (if (= j m)
              (go label30))
          (zswap l
           (f2cl-lib:array-slice a-%data% f2cl-lib:complex16 (1 j)
                                 ((1 lda) (1 *)) a-%offset%)
           1
           (f2cl-lib:array-slice a-%data% f2cl-lib:complex16 (1 m)
                                 ((1 lda) (1 *)) a-%offset%)
           1)
          (zswap (f2cl-lib:int-add (f2cl-lib:int-sub n k) 1)
           (f2cl-lib:array-slice a-%data% f2cl-lib:complex16 (j k)
                                 ((1 lda) (1 *)) a-%offset%)
           lda
           (f2cl-lib:array-slice a-%data% f2cl-lib:complex16 (m k)
                                 ((1 lda) (1 *)) a-%offset%)
           lda)
         label30
            ...
            (tagbody
              ...
              (setf ira
                      (izamax (f2cl-lib:int-add (f2cl-lib:int-sub n k) 1)
                       (f2cl-lib:array-slice a-%data% f2cl-lib:complex16 (i k)
                                             ((1 lda) (1 *)) a-%offset%)
                       lda))
              (setf ra
                      (abs
              ...
              (setf s (+ c r))
             label160
              (if (or (>= c g) (>= (max f c ca) sfmax2)
                      (<= (min r g ra) sfmin2))
                  (go label170))
              (cond
               ((disnan (+ c f ca r g ra)) (setf info -3)
                (xerbla "ZGEBAL" (f2cl-lib:int-sub info)) (go end_label)))
              (setf f (* f sclfac))
              (setf c (* c sclfac))
              (setf ca (* ca sclfac))
              (setf r (/ r sclfac))

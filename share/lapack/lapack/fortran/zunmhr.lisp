  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i1 0) (i2 0) (iinfo 0) (lwkopt 0) (mi 0) (nb 0) (nh 0) (ni 0)
      ...
      (cond ((and (not left) (not (lsame side "R"))) (setf info -1))
            ...
            ((or
              (< ihi
                 (min (the f2cl-lib:integer4 ilo) (the f2cl-lib:integer4 nq)))
              (> ihi nq))
             (setf info -6))
      ...
      (cond
       ((/= info 0) (xerbla "ZUNMHR" (f2cl-lib:int-sub info)) (go end_label))
       (lquery (go end_label)))
      (cond
       ((or (= m 0) (= n 0) (= nh 0))
        (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%)
      ...
      (cond
       (left (setf mi nh) (setf ni n) (setf i1 (f2cl-lib:int-add ilo 1))
        (setf i2 1))
       (t (setf mi m) (setf ni nh) (setf i1 1)
      ...
      (multiple-value-bind
        ...
        (declare
         (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-10
          var-11))
        (setf ldc var-9)
        (setf iinfo var-12))
      (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%)
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil nil nil nil ldc nil nil info)))))

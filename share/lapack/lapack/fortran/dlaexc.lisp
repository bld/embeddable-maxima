...
(let* ((zero 0.0) (one 1.0) (ten 10.0) (ldd 4) (ldx 2))
  ...
  (defun dlaexc (wantq n t$ ldt q ldq j1 n1 n2 work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((d
              (make-array (the fixnum (reduce #'* (list ldd 4))) :element-type
                          'double-float))
             ...
             (x
              (make-array (the fixnum (reduce #'* (list ldx 2))) :element-type
                          'double-float))
        ...
        (cond
         ((and (= n1 1) (= n2 1))
          (setf t11
                  (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *))
                                 t$-%offset%))
          (setf t22
                  (f2cl-lib:fref t$-%data% (j2 j2) ((1 ldt) (1 *))
                                 t$-%offset%))
          ...
          (if (<= j3 n)
              (drot (f2cl-lib:int-sub n j1 1)
               (f2cl-lib:array-slice t$-%data% double-float (j1 j3)
                                     ((1 ldt) (1 *)) t$-%offset%)
               ldt
               (f2cl-lib:array-slice t$-%data% double-float (j2 j3)
                                     ((1 ldt) (1 *)) t$-%offset%)
               ldt cs sn))
          (drot (f2cl-lib:int-sub j1 1)
           (f2cl-lib:array-slice t$-%data% double-float (1 j1) ((1 ldt) (1 *))
                                 t$-%offset%)
           1
           (f2cl-lib:array-slice t$-%data% double-float (1 j2) ((1 ldt) (1 *))
                                 t$-%offset%)
           1 cs sn)
          ...
          (cond
           (wantq
            (drot n
             (f2cl-lib:array-slice q-%data% double-float (1 j1) ((1 ldq) (1 *))
                                   q-%offset%)
             1
             (f2cl-lib:array-slice q-%data% double-float (1 j2) ((1 ldq) (1 *))
                                   q-%offset%)
             1 cs sn))))
         (t
          (tagbody
            ...
            (dlacpy "Full" nd nd
             (f2cl-lib:array-slice t$-%data% double-float (j1 j1)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt d ldd)
            ...
            (multiple-value-bind
                ...
                (dlasy2 f2cl-lib:%false% f2cl-lib:%false% -1 n1 n2 d ldd
                 (f2cl-lib:array-slice d double-float
           ...
           label10
            ...
            (dlarfx "L" 3 (f2cl-lib:int-add (f2cl-lib:int-sub n j1) 1) u tau
             ...
             ldt work)
            (dlarfx "R" j2 3 u tau
             (f2cl-lib:array-slice t$-%data% double-float (1 j1)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt work)
            (setf (f2cl-lib:fref t$-%data% (j3 j1) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j3 j2) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j3 j3) ((1 ldt) (1 *)) t$-%offset%)
                    t11)
            (cond
             (wantq
              (dlarfx "R" n 3 u tau
               (f2cl-lib:array-slice q-%data% double-float (1 j1)
                                     ((1 ldq) (1 *)) q-%offset%)
               ldq work)))
            (go label40)
           label20
            ...
            (setf t33
                    (f2cl-lib:fref t$-%data% (j3 j3) ((1 ldt) (1 *))
                                   t$-%offset%))
            (dlarfx "L" 3 3 u tau d ldd work)
            (dlarfx "R" 3 3 u tau d ldd work)
            (if (>
            ...
            (dlarfx "L" 3 (f2cl-lib:int-sub n j1) u tau
             (f2cl-lib:array-slice t$-%data% double-float (j1 j2)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt work)
            (setf (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *)) t$-%offset%)
                    t33)
            (setf (f2cl-lib:fref t$-%data% (j2 j1) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j3 j1) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (cond
           ...
           label30
            ...
            (dlarfx "L" 3 (f2cl-lib:int-add (f2cl-lib:int-sub n j1) 1) u2 tau2
             (f2cl-lib:array-slice t$-%data% double-float (j2 j1)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt work)
            (dlarfx "R" j4 3 u2 tau2
             (f2cl-lib:array-slice t$-%data% double-float (1 j2)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt work)
            (setf (f2cl-lib:fref t$-%data% (j3 j1) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j3 j2) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j4 j1) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (setf (f2cl-lib:fref t$-%data% (j4 j2) ((1 ldt) (1 *)) t$-%offset%)
                    zero)
            (cond
             (wantq
              ...
              (dlarfx "R" n 3 u2 tau2
               (f2cl-lib:array-slice q-%data% double-float (1 j2)
                                     ((1 ldq) (1 *)) q-%offset%)
               ldq work)))
           label40
            (cond
             ((= n2 2)
              (multiple-value-bind
                  ...
                  (dlanv2
                   (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j1 j2) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j2 j1) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j2 j2) ((1 ldt) (1 *))
                                  t$-%offset%)
                   wr1 wi1 wr2 wi2 cs sn)
                (declare (ignore))
                (setf (f2cl-lib:fref t$-%data% (j1 j1) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-0)
                (setf (f2cl-lib:fref t$-%data% (j1 j2) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-1)
                (setf (f2cl-lib:fref t$-%data% (j2 j1) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-2)
                (setf (f2cl-lib:fref t$-%data% (j2 j2) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-3)
                (setf wr1 var-4)
                (setf wi1 var-5)
              ...
              (if wantq
                  (drot n
                   ...
                   1 cs sn))))
            (cond
             ((= n1 2) (setf j3 (f2cl-lib:int-add j1 n2))
              ...
              (multiple-value-bind
                  ...
                  (dlanv2
                   (f2cl-lib:fref t$-%data% (j3 j3) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j3 j4) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j4 j3) ((1 ldt) (1 *))
                                  t$-%offset%)
                   (f2cl-lib:fref t$-%data% (j4 j4) ((1 ldt) (1 *))
                                  t$-%offset%)
                   wr1 wi1 wr2 wi2 cs sn)
                (declare (ignore))
                (setf (f2cl-lib:fref t$-%data% (j3 j3) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-0)
                (setf (f2cl-lib:fref t$-%data% (j3 j4) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-1)
                (setf (f2cl-lib:fref t$-%data% (j4 j3) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-2)
                (setf (f2cl-lib:fref t$-%data% (j4 j4) ((1 ldt) (1 *))
                                     t$-%offset%)
                        var-3)
                (setf wr1 var-4)
                (setf wi1 var-5)
              ...
              (drot (f2cl-lib:int-sub j3 1)
               (f2cl-lib:array-slice t$-%data% double-float (1 j3)
                                     ((1 ldt) (1 *)) t$-%offset%)
               1
               (f2cl-lib:array-slice t$-%data% double-float (1 j4)
                                     ((1 ldt) (1 *)) t$-%offset%)
               1 cs sn)
              (if wantq
                  (drot n
                   (f2cl-lib:array-slice q-%data% double-float (1 j3)
                                         ((1 ldq) (1 *)) q-%offset%)
                   1
                   (f2cl-lib:array-slice q-%data% double-float (1 j4)
                                         ((1 ldq) (1 *)) q-%offset%)
                   1 cs sn)))))))
        (go end_label)
       label50
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlaexc
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :calls
                                            '(fortran-to-lisp::dlanv2
                                              fortran-to-lisp::dlarfx

      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((v (make-array 2 :element-type 'f2cl-lib:complex16)) (i 0)
          ...
          (f2cl-lib:fdo (j ilo (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add j 2) j)
                                   ((1 ldh) (1 *)) h-%offset%)
                      zero)
              (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add j 3) j)
                                   ((1 ldh) (1 *)) h-%offset%)
                      zero)
             label10))
          (if (<= ilo (f2cl-lib:int-sub ihi 2))
              (setf (f2cl-lib:fref h-%data% (ihi (f2cl-lib:int-sub ihi 2))
                                   ((1 ldh) (1 *)) h-%offset%)
                      zero))
              ...
              (cond
               ((/=
                ...
                (zscal (f2cl-lib:int-add (f2cl-lib:int-sub jhi i) 1) sc
                 (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (i i)
                                       ((1 ldh) (1 *)) h-%offset%)
                 ldh)
                (zscal
                 (f2cl-lib:int-add
                  ...
                  1)
                 (f2cl-lib:dconjg sc)
                 (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (jlo i)
                                       ((1 ldh) (1 *)) h-%offset%)
                 1)
                (if wantz
                    (zscal (f2cl-lib:int-add (f2cl-lib:int-sub ihiz iloz) 1)
                     (f2cl-lib:dconjg sc)
                     (f2cl-lib:array-slice z-%data% f2cl-lib:complex16 (iloz i)
                                           ((1 ldz) (1 *)) z-%offset%)
                     1))))
             label20))
               ...
               ((= its 10)
                (setf s
                        (* dat1
                           (abs
                            (f2cl-lib:dble
                             (f2cl-lib:fref h-%data% ((f2cl-lib:int-add l 1) l)
                                            ((1 ldh) (1 *)) h-%offset%)))))
                (setf t$
                        (+ s
                           (f2cl-lib:fref h-%data% (l l) ((1 ldh) (1 *))
                                          h-%offset%))))
               ((= its 20)
                (setf s
                        (* dat1
                ...
                (tagbody
                  ...
                  (cond
                   ((and (= k m) (> m l)) (setf temp (- one t1))
                    ...
                    (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add m 1) m)
                                         ((1 ldh) (1 *)) h-%offset%)
                            (*
                             (f2cl-lib:fref h-%data% ((f2cl-lib:int-add m 1) m)
                                            ((1 ldh) (1 *)) h-%offset%)
                          ...
                          (if (> i2 j)
                              (zscal (f2cl-lib:int-sub i2 j) temp
                               (f2cl-lib:array-slice h-%data%
                                                     ...
                                                     h-%offset%)
                               ldh))
                          (zscal (f2cl-lib:int-sub j i1) (f2cl-lib:dconjg temp)
                           (f2cl-lib:array-slice h-%data% f2cl-lib:complex16
                                                 (i1 j) ((1 ldh) (1 *))
                                                 h-%offset%)
                           1)
              ...
              (cond
               ((/= (f2cl-lib:dimag temp) rzero) (setf rtemp (abs temp))
                ...
                (zscal (f2cl-lib:int-sub i i1) temp
                 (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (i1 i)
                                       ((1 ldh) (1 *)) h-%offset%)
                 1)
                (cond
                 (wantz

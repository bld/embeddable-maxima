  ...
  (defun dbdsqr (uplo n ncvt nru ncc d e vt ldvt u ldu c ldc work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((abse 0.0) (abss 0.0) (cosl 0.0) (cosr 0.0) (cs 0.0) (eps 0.0)
        ...
        (declare
         (type (double-float) abse abss cosl cosr cs eps f g h mu oldcs oldsn r
          shift sigmn sigmx sinl sinr sll smax smin sminl sminlo sminoa sn
          thresh tol tolmul unfl)
         (type (f2cl-lib:integer4) i idir isub iter j ll lll m maxit nm1 nm12
          nm13 oldll oldm)
         (type f2cl-lib:logical lower rotate))
        (setf info 0)
        (setf lower (lsame uplo "L"))
        (cond ((and (not (lsame uplo "U")) (not lower)) (setf info -1))
              ((< n 0) (setf info -2)) ((< ncvt 0) (setf info -3))
              ((< nru 0) (setf info -4)) ((< ncc 0) (setf info -5))
              ((or (and (= ncvt 0) (< ldvt 1))
               ...
               (setf info -9))
              ((< ldu
                  (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 nru)))
               (setf info -11))
              ((or (and (= ncc 0) (< ldc 1))
                   (and (> ncc 0)
                        (< ldc
               ...
               (setf info -13)))
        (cond
         ((/= info 0) (xerbla "DBDSQR" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= n 0)
            (go end_label))
        (if (= n 1)
         ...
         (lower
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add nm1 i))
                                   ((1 *)) work-%offset%)
                      sn)
             label10))
          (if (> nru 0)
              (dlasr "R" "V" "F" nru n
               (f2cl-lib:array-slice work-%data% double-float (1) ((1 *))
                                     work-%offset%)
               (f2cl-lib:array-slice work-%data% double-float (n) ((1 *))
                                     work-%offset%)
               u ldu))
          (if (> ncc 0)
              (dlasr "L" "V" "F" n ncc
        ...
        (cond
         ((>= tol zero)
          (tagbody
            (setf sminoa (abs (f2cl-lib:fref d-%data% (1) ((1 *)) d-%offset%)))
            (if (= sminoa zero)
                (go label50))
            (setf mu sminoa)
         ...
         (t (setf thresh (max (* (abs tol) smax) (* maxitr n n unfl)))))
       ...
       label80
        ...
        (cond
         ((= ll (f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
          (setf m (f2cl-lib:int-sub m 1)) (go label60)))
       label90
        ...
        (cond
         ((= ll (f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
          (multiple-value-bind
              ...
              (dlasv2
               (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub m 1)) ((1 *))
                              d-%offset%)
               (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub m 1)) ((1 *))
                              e-%offset%)
               (f2cl-lib:fref d-%data% (m) ((1 *)) d-%offset%) sigmn sigmx sinr
               cosr sinl cosl)
            ...
            (setf sinl var-7)
            (setf cosl var-8))
          (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub m 1)) ((1 *))
                               d-%offset%)
                  sigmx)
          ...
          (if (> ncvt 0)
              (drot ncvt
               (f2cl-lib:array-slice vt-%data% double-float
                                     ((+ m (f2cl-lib:int-sub 1)) 1)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt
               (f2cl-lib:array-slice vt-%data% double-float (m 1)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt cosr sinr))
          (if (> nru 0)
              (drot nru
               (f2cl-lib:array-slice u-%data% double-float
                                     (1 (f2cl-lib:int-sub m 1)) ((1 ldu) (1 *))
                                     u-%offset%)
               1
               (f2cl-lib:array-slice u-%data% double-float (1 m)
                                     ((1 ldu) (1 *)) u-%offset%)
               1 cosl sinl))
          (if (> ncc 0)
              (drot ncc
               (f2cl-lib:array-slice c-%data% double-float
                                     ...
                                     ((1 ldc) (1 *)) c-%offset%)
               ldc
               (f2cl-lib:array-slice c-%data% double-float (m 1)
                                     ((1 ldc) (1 *)) c-%offset%)
               ldc cosl sinl))
          (setf m (f2cl-lib:int-sub m 2)) (go label60)))
        (cond
         ((or (> ll oldm) (< m oldll))
          (cond
         ...
         ((= idir 1)
          (cond
           ((or
             (<=
              (abs
               (f2cl-lib:fref e ((f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
                              ((1 *))))
              ...
              (tagbody
                (cond
                 ((<= (abs (f2cl-lib:fref e (lll) ((1 *)))) (* tol mu))
                  (setf (f2cl-lib:fref e-%data% (lll) ((1 *)) e-%offset%) zero)
                  (go label60)))
                (setf sminlo sminl)
                (setf mu
                        (*
                         (abs
                          (f2cl-lib:fref d-%data% ((f2cl-lib:int-add lll 1))
                                         ((1 *)) d-%offset%))
                         (/ mu
                            (+ mu
                               (abs
                                (f2cl-lib:fref e-%data% (lll) ((1 *))
                                               e-%offset%))))))
        ...
        (cond
         ...
         (t
          (cond
           ((= idir 1)
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
              ...
              (setf shift var-3)
              (setf r var-4)))
           (t (setf sll (abs (f2cl-lib:fref d-%data% (m) ((1 *)) d-%offset%)))
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                (dlas2 (f2cl-lib:fref d-%data% (ll) ((1 *)) d-%offset%)
                 (f2cl-lib:fref e-%data% (ll) ((1 *)) e-%offset%)
                 (f2cl-lib:fref d-%data% ((f2cl-lib:int-add ll 1)) ((1 *))
                                d-%offset%)
                 shift r)
              (declare (ignore var-0 var-1 var-2))
              (setf shift var-3)
          ...
          (cond
           ((> sll zero)
            (if (< (expt (/ shift sll) 2) eps)
                (setf shift zero))))))
        (setf iter (f2cl-lib:int-sub (f2cl-lib:int-add iter m) ll))
        (cond
         ((= shift zero)
          (cond
           ((= idir 1) (setf cs one) (setf oldcs one)
            (f2cl-lib:fdo (i ll (f2cl-lib:int-add i 1))
                          ((> i (f2cl-lib:int-add m (f2cl-lib:int-sub 1))) nil)
              (tagbody
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg (* oldcs r)
                     (*
                      (f2cl-lib:fref d-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                     d-%offset%)
                      sn)
                     oldcs oldsn
                     (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%))
                  ...
                  (setf oldcs var-2)
                  (setf oldsn var-3)
                  (setf (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) var-4))
                (setf (f2cl-lib:fref work-%data%
                                     ((f2cl-lib:int-add (f2cl-lib:int-sub i ll)
                                                        1))
                                     ((1 *)) work-%offset%)
                        cs)
                (setf (f2cl-lib:fref work-%data%
            ...
            (setf (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub m 1)) ((1 *))
                    ...
                    (* h oldsn))
            (if (> ncvt 0)
                (dlasr "L" "V" "F" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ncvt
                 (f2cl-lib:array-slice work-%data% double-float (1) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (n) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice vt-%data% double-float (ll 1)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 ldvt))
            (if (> nru 0)
                (dlasr "R" "V" "F" nru
                 (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 (f2cl-lib:array-slice work-%data% double-float ((+ nm12 1))
                                       ((1 *)) work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float ((+ nm13 1))
                                       ((1 *)) work-%offset%)
                 (f2cl-lib:array-slice u-%data% double-float (1 ll)
                                       ((1 ldu) (1 *)) u-%offset%)
                 ldu))
            (if (> ncc 0)
                (dlasr "L" "V" "F" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ...
                 (f2cl-lib:array-slice work-%data% double-float ((+ nm13 1))
                                       ((1 *)) work-%offset%)
                 (f2cl-lib:array-slice c-%data% double-float (ll 1)
                                       ((1 ldc) (1 *)) c-%offset%)
                 ldc))
            (if (<=
                 (abs
           ...
           (t (setf cs one) (setf oldcs one)
            (f2cl-lib:fdo (i m (f2cl-lib:int-add i (f2cl-lib:int-sub 1)))
              ...
              (tagbody
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg
                     (* (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) cs)
                     (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                                    e-%offset%)
                     cs sn r)
                  (declare (ignore var-0 var-1))
                  (setf cs var-2)
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg (* oldcs r)
                     (*
                      (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                                     d-%offset%)
                      sn)
                     oldcs oldsn
                     (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%))
                  ...
                  (setf oldsn var-3)
                  (setf (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) var-4))
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-sub i ll))
                                     ((1 *)) work-%offset%)
                        cs)
                (setf (f2cl-lib:fref work-%data%
                                     ((f2cl-lib:int-add (f2cl-lib:int-sub i ll)
            ...
            (setf (f2cl-lib:fref d-%data% (ll) ((1 *)) d-%offset%) (* h oldcs))
            (setf (f2cl-lib:fref e-%data% (ll) ((1 *)) e-%offset%) (* h oldsn))
            (if (> ncvt 0)
                (dlasr "L" "V" "B" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ncvt
                 (f2cl-lib:array-slice work-%data% double-float ((+ nm12 1))
                                       ((1 *)) work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float ((+ nm13 1))
            ...
            (if (> ncc 0)
                (dlasr "L" "V" "B" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ...
                 (f2cl-lib:array-slice c-%data% double-float (ll 1)
                                       ((1 ldc) (1 *)) c-%offset%)
                 ldc))
            (if (<= (abs (f2cl-lib:fref e-%data% (ll) ((1 *)) e-%offset%))
                    thresh)
              ...
              (tagbody
                ...
                (cond
                 ((< i (f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
                  (setf g
                          (* sinl
                             (f2cl-lib:fref e-%data% ((f2cl-lib:int-add i 1))
                                            ((1 *)) e-%offset%)))
              ...
              (tagbody
                ...
                (setf f
                        (+
                         (* cosr
                            (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%))
                         (* sinr
                            (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub i 1))
                                           ((1 *)) e-%offset%))))
                ...
                (setf g
                        (* sinr
                           (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub i 1))
                                          ((1 *)) d-%offset%)))
                (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                                     d-%offset%)
                        (* cosr
                           (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub i 1))
                                          ((1 *)) d-%offset%)))
                ...
                (cond
                 ((> i (f2cl-lib:int-add ll 1))
                  (setf g
                          (* sinl
                             (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub i 2))
                                            ((1 *)) e-%offset%)))
                  (setf (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub i 2))
                                       ((1 *)) e-%offset%)
                          (* cosl
                             (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub i 2))
                                            ((1 *)) e-%offset%)))))
          ...
          (tagbody
            (cond
             ((< (f2cl-lib:fref d (i) ((1 *))) zero)
              ...
              (if (> ncvt 0)
                  (dscal ncvt negone
                   (f2cl-lib:array-slice vt-%data% double-float (i 1)
                                         ((1 ldvt) (1 *)) vt-%offset%)
                   ldvt))))
           label170))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                (cond
                 ((<= (f2cl-lib:fref d (j) ((1 *))) smin) (setf isub j)
                  (setf smin (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%))))
               label180))
            (cond
             ((/= isub (f2cl-lib:int-add n 1 (f2cl-lib:int-sub i)))
              ...
              (if (> ncvt 0)
                  (dswap ncvt
                   (f2cl-lib:array-slice vt-%data% double-float (isub 1)
                                         ((1 ldvt) (1 *)) vt-%offset%)
                   ldvt
                   (f2cl-lib:array-slice vt-%data% double-float
              ...
              (if (> nru 0)
                  (dswap nru
                   (f2cl-lib:array-slice u-%data% double-float (1 isub)
                                         ((1 ldu) (1 *)) u-%offset%)
                   1
                   (f2cl-lib:array-slice u-%data% double-float
                                         (1
              ...
              (if (> ncc 0)
                  (dswap ncc
                   (f2cl-lib:array-slice c-%data% double-float (isub 1)
                                         ((1 ldc) (1 *)) c-%offset%)
                   ldc
                   (f2cl-lib:array-slice c-%data% double-float
                                         ((+ n 1 (f2cl-lib:int-sub i)) 1)

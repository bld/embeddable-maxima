  ...
  (defun dgeevx
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
        ...
        (cond
         ((not
           (or (lsame balanc "N") (lsame balanc "S") (lsame balanc "P")
               (lsame balanc "B")))
          (setf info -1))
         ((and (not wantvl) (not (lsame jobvl "N"))) (setf info -2))
         ((and (not wantvr) (not (lsame jobvr "N"))) (setf info -3))
         ...
         ((< lda (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 n)))
          (setf info -7))
         ((or (< ldvl 1) (and wantvl (< ldvl n))) (setf info -11))
         ((or (< ldvr 1) (and wantvr (< ldvr n))) (setf info -13)))
        (setf minwrk 1)
        (cond
                        ...
                        (max (the f2cl-lib:integer4 minwrk)
                             (the f2cl-lib:integer4
                                  (f2cl-lib:int-add (f2cl-lib:int-mul n n)
                                                    (f2cl-lib:int-mul 6 n))))))
            (setf maxb
                    (max
                     (the f2cl-lib:integer4 (ilaenv 8 "DHSEQR" "SN" n 1 n -1))
           ...
           (t
            ...
            (setf maxb
                    (max
                     ...
                     (the f2cl-lib:integer4 2)))
            (setf k
                    (min (the f2cl-lib:integer4 maxb) (the f2cl-lib:integer4 n)
                         (the f2cl-lib:integer4
                              (max (the f2cl-lib:integer4 2)
                                   (the f2cl-lib:integer4
        ...
        (cond ((and (< lwork minwrk) (not lquery)) (setf info -21)))
        (cond
         ((/= info 0) (xerbla "DGEEVX" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (if (= n 0)
            (go end_label))
        (setf eps (dlamch "P"))
        ...
        (cond
         (scalea (setf (f2cl-lib:fref dum (1) ((1 1))) abnrm)
          (multiple-value-bind
              (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
        ...
        (multiple-value-bind
            ...
            (dgehrd n ilo ihi a lda
             (f2cl-lib:array-slice work-%data% double-float (itau) ((1 *))
                                   work-%offset%)
             (f2cl-lib:array-slice work-%data% double-float (iwrk) ((1 *))
                                   work-%offset%)
        ...
        (cond
         ...
         (wantvr (f2cl-lib:f2cl-set-string side "R" (string 1))
          ...
          (multiple-value-bind
            ...
            (setf info var-13)))
         (t
          (cond (wntsnn (f2cl-lib:f2cl-set-string job "E" (string 1)))
                (t (f2cl-lib:f2cl-set-string job "S" (string 1))))
          (setf iwrk itau)
          (multiple-value-bind
              (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
               var-10 var-11 var-12 var-13)
        ...
        (cond
         ((not wntsnn)
          (multiple-value-bind
            ...
            (declare
             (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
              var-9 var-10 var-11 var-12 var-14 var-15 var-16))
            (setf nout var-13)
            (setf icond var-17))))
        (cond
         (wantvl
              ...
              (cond
               ((= (f2cl-lib:fref wi (i) ((1 *))) zero)
                (setf scl
                        (/ one
                           (dnrm2 n
                            (f2cl-lib:array-slice vl-%data% double-float (1 i)
                                                  ((1 ldvl) (1 *)) vl-%offset%)
                            1)))
                (dscal n scl
                 (f2cl-lib:array-slice vl-%data% double-float (1 i)
               ...
               ((> (f2cl-lib:fref wi (i) ((1 *))) zero)
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg
                     (f2cl-lib:fref vl-%data% (k i) ((1 ldvl) (1 *))
                                    vl-%offset%)
                     (f2cl-lib:fref vl-%data% (k (f2cl-lib:int-add i 1))
                                    ((1 ldvl) (1 *)) vl-%offset%)
                     cs sn r)
                ...
                (drot n
                 ...
                 (f2cl-lib:array-slice vl-%data% double-float
                                       ...
                                       ((1 ldvl) (1 *)) vl-%offset%)
                 1 cs sn)
                (setf (f2cl-lib:fref vl-%data% (k (f2cl-lib:int-add i 1))
                                     ((1 ldvl) (1 *)) vl-%offset%)
                        zero)))
             label20))))
        (cond
              ...
              (cond
               ((= (f2cl-lib:fref wi (i) ((1 *))) zero)
                (setf scl
                        (/ one
                           (dnrm2 n
                            (f2cl-lib:array-slice vr-%data% double-float (1 i)
                                                  ((1 ldvr) (1 *)) vr-%offset%)
                            1)))
                (dscal n scl
                 (f2cl-lib:array-slice vr-%data% double-float (1 i)
               ...
               ((> (f2cl-lib:fref wi (i) ((1 *))) zero)
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlartg
                     (f2cl-lib:fref vr-%data% (k i) ((1 ldvr) (1 *))
                                    vr-%offset%)
                     (f2cl-lib:fref vr-%data% (k (f2cl-lib:int-add i 1))
                                    ((1 ldvr) (1 *)) vr-%offset%)
                     cs sn r)
                  (declare (ignore var-0 var-1))
                  (setf cs var-2)
                ...
                (drot n
                 ...
                 (f2cl-lib:array-slice vr-%data% double-float
                                       ...
                                       ((1 ldvr) (1 *)) vr-%offset%)
                 1 cs sn)
                (setf (f2cl-lib:fref vr-%data% (k (f2cl-lib:int-add i 1))
                                     ((1 ldvr) (1 *)) vr-%offset%)
                        zero)))
             label40))))
       label50
         ...
         (scalea
          (multiple-value-bind
              ...
              (dlascl "G" 0 0 cscale anrm (f2cl-lib:int-sub n info) 1
               (f2cl-lib:array-slice wr-%data% double-float ((+ info 1))
                                     ((1 *)) wr-%offset%)
          ...
          (multiple-value-bind
              (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
              (dlascl "G" 0 0 cscale anrm (f2cl-lib:int-sub n info) 1
               (f2cl-lib:array-slice wi-%data% double-float ((+ info 1))
                                     ((1 *)) wi-%offset%)
               (max (the f2cl-lib:integer4 (f2cl-lib:int-sub n info))
                    (the f2cl-lib:integer4 1))
               ierr)
       ...
       end_label
        (return
         (values nil nil nil nil nil nil nil nil nil nil nil nil nil ilo ihi
                 nil abnrm nil nil nil nil nil info))))))
  ...
  (setf (gethash 'fortran-to-lisp::dgeevx
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil nil nil nil nil
                                              fortran-to-lisp::ilo
                                              fortran-to-lisp::ihi nil
                                              fortran-to-lisp::abnrm nil nil
                                              nil nil nil

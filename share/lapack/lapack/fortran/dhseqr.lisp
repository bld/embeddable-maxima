  ...
  (defun dhseqr (job compz n ilo ihi h ldh wr wi z ldz work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((s
             ...
             (v
              (make-array (f2cl-lib:int-add nsmax 1) :element-type
                          'double-float))
             (vv
              (make-array (f2cl-lib:int-add nsmax 1) :element-type
                          'double-float))
        ...
        (cond ((and (not (lsame job "E")) (not wantt)) (setf info -1))
              ((and (not (lsame compz "N")) (not wantz)) (setf info -2))
              ((< n 0) (setf info -3))
              ((or (< ilo 1)
                   (> ilo
                      (max (the f2cl-lib:integer4 1)
              ...
              ((or
                (< ihi
                   (min (the f2cl-lib:integer4 ilo) (the f2cl-lib:integer4 n)))
                (> ihi n))
               (setf info -5))
              ((< ldh
              ...
              ((and
               ...
               (setf info -13)))
        (cond
         ((/= info 0) (xerbla "DHSEQR" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (if initz
        ...
        (setf ns
                (min (the f2cl-lib:integer4 ns) (the f2cl-lib:integer4 maxb)
                             ...
                             (+
                              (abs
                               (f2cl-lib:fref h-%data%
                                              ...
                                              ((1 ldh) (1 *)) h-%offset%))
                              (abs
                               (f2cl-lib:fref h-%data% (ii ii) ((1 ldh) (1 *))
                                              h-%offset%)))))
              ...
              (dlacpy "Full" ns ns
               (f2cl-lib:array-slice h-%data% double-float
                                     ((+ i (f2cl-lib:int-sub ns) 1)
                                      (f2cl-lib:int-add (f2cl-lib:int-sub i ns)
                                                        1))
                                     ((1 ldh) (1 *)) h-%offset%)
               ldh s lds)
              (multiple-value-bind
                  ...
                  (dlahqr f2cl-lib:%false% f2cl-lib:%false% ns 1 ns s lds
                   (f2cl-lib:array-slice wr-%data% double-float
                                         ((+ i (f2cl-lib:int-sub ns) 1))
                                         ((1 *)) wr-%offset%)
                   (f2cl-lib:array-slice wi-%data% double-float
                                         ((+ i (f2cl-lib:int-sub ns) 1))
                                         ((1 *)) wi-%offset%)
                   1 ns z ldz ierr)
                (declare
              ...
              (tagbody
                (cond
                 ((>= (f2cl-lib:fref wi (j) ((1 *))) zero)
                   ...
                   ((= (f2cl-lib:fref wi (j) ((1 *))) zero)
                    ...
                    (dgemv "No transpose" (f2cl-lib:int-add nv 1) nv one
                     (f2cl-lib:array-slice h-%data% double-float (l l)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh vv 1
                     (- (f2cl-lib:fref wr-%data% (j) ((1 *)) wr-%offset%)) v 1)
                  ...
                  (setf temp
                          (abs
                           (f2cl-lib:fref v (itemp)
                                          ((1 (f2cl-lib:int-add nsmax 1))))))
                  (cond
                   ((= temp zero)
                    (setf (f2cl-lib:fref v (1)
                                         ((1 (f2cl-lib:int-add nsmax 1))))
                            one)
                    (f2cl-lib:fdo (ii 2 (f2cl-lib:int-add ii 1))
                                  ((> ii nv) nil)
                      (tagbody
                        (setf (f2cl-lib:fref v (ii)
                                             ((1 (f2cl-lib:int-add nsmax 1))))
                                zero)
                       label110)))
                   (t (setf temp (max temp smlnum))
              ...
              (tagbody
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                    (dlarfg nr
                     ...
                     (f2cl-lib:array-slice v double-float (2)
                                           ((1 (f2cl-lib:int-add nsmax 1))))
                     1 tau)
                ...
                (cond
                 ((> k l)
                  ...
                  (f2cl-lib:fdo (ii (f2cl-lib:int-add k 1)
                                ...
                                ((> ii i) nil)
                    (tagbody
                      (setf (f2cl-lib:fref h-%data% (ii (f2cl-lib:int-sub k 1))
                                           ((1 ldh) (1 *)) h-%offset%)
                              zero)
                     label130))))
                (setf (f2cl-lib:fref v (1) ((1 (f2cl-lib:int-add nsmax 1))))
                ...
                (dlarfx "Left" nr (f2cl-lib:int-add (f2cl-lib:int-sub i2 k) 1)
                 v tau
                 (f2cl-lib:array-slice h-%data% double-float (k k)
                                       ((1 ldh) (1 *)) h-%offset%)
                 ldh work)
                (dlarfx "Right"
                 (f2cl-lib:int-add
                  ...
                  1)
                 nr v tau
                 (f2cl-lib:array-slice h-%data% double-float (i1 k)
                                       ((1 ldh) (1 *)) h-%offset%)
                 ldh work)
                (cond
                 (wantz
                  (dlarfx "Right" nh nr v tau
                   (f2cl-lib:array-slice z-%data% double-float (ilo k)
                                         ((1 ldz) (1 *)) z-%offset%)
                   ldz work)))
               label140))
           label150))

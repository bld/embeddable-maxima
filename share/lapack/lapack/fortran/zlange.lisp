        ...
        (cond
            ...
            (tagbody
              (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                ...
                (tagbody
                 ...
                 label10))
             label20)))
         ((or (lsame norm "O") (f2cl-lib:fstring-= norm "1")) (setf value zero)
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j n) nil)
            (tagbody
              (setf sum zero)
         ...
         ((lsame norm "I")
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i m) nil)
            (tagbody
              (setf (f2cl-lib:fref work-%data% (i) ((1 *)) work-%offset%) zero)
             label50))
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j n) nil)
            (tagbody
              ...
              (setf value
                      (max value
                           (f2cl-lib:fref work-%data% (i) ((1 *))
                                          work-%offset%)))
             label80)))
         ((or (lsame norm "F") (lsame norm "E")) (setf scale zero)
          (setf sum one)
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j n) nil)
            (tagbody

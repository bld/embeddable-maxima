      ...
      (prog ((j 0) (jp 0))
        ...
        (cond ((< m 0) (setf info -1)) ((< n 0) (setf info -2))
              ((< lda
               ...
               (setf info -4)))
        (cond
         ((/= info 0) (xerbla "DGETF2" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (or (= m 0) (= n 0))
            (go end_label))
          ...
          (tagbody
            ...
            (cond
             ((/= (f2cl-lib:fref a (jp j) ((1 lda) (1 *))) zero)
              (if (/= jp j)
                  (dswap n
                   (f2cl-lib:array-slice a-%data% double-float (j 1)
                                         ((1 lda) (1 *)) a-%offset%)
                   lda
                   (f2cl-lib:array-slice a-%data% double-float (jp 1)
                                         ((1 lda) (1 *)) a-%offset%)
                   lda))
              (if (< j m)
                  (dscal (f2cl-lib:int-sub m j)
                   (/ one
                      (f2cl-lib:fref a-%data% (j j) ((1 lda) (1 *))
                                     a-%offset%))
                   (f2cl-lib:array-slice a-%data% double-float ((+ j 1) j)
                                         ((1 lda) (1 *)) a-%offset%)
                   1)))
             ((= info 0) (setf info j)))
            (cond

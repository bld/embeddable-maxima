      ...
      (prog ((initz nil) (lquery nil) (wantt nil) (wantz nil) (kbot 0) (nmin 0)
        ...
        (cond ((and (not (lsame job "E")) (not wantt)) (setf info -1))
              ...
              ((and
               ...
               (setf info -12)))
        (cond
         ((/= info 0) (xerbla "ZHSEQR" (f2cl-lib:int-sub info)) (go end_label))
         ((= n 0) (go end_label))
         (lquery
          (multiple-value-bind
         ...
         (t
          ...
          (if (< ihi n)
              (zcopy (f2cl-lib:int-sub n ihi)
               ...
               (f2cl-lib:array-slice w-%data% f2cl-lib:complex16 ((+ ihi 1))
                                     ((1 *)) w-%offset%)
               1))
          (if initz
              ...
              (cond
               ...
               (t (zlacpy "A" n n h ldh hl nl)
                ...
                (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                     var-9 var-10 var-11 var-12 var-13 var-14)
                    (zlaqr0 wantt wantz nl ilo kbot hl nl w ilo ihi z ldz workl
                     nl info)
                  (declare
                   (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-7 var-8
                    var-9 var-10 var-11 var-12 var-13))
          ...
          (if (and (or wantt (/= info 0)) (> n 2))
              (zlaset "L" (f2cl-lib:int-sub n 2) (f2cl-lib:int-sub n 2) zero
               zero
               (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (3 1)
                                     ((1 ldh) (1 *)) h-%offset%)
               ldh))
          (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%)
                  (f2cl-lib:dcmplx

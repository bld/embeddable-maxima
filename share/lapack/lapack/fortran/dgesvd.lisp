      ...
      (prog ((dum (make-array 1 :element-type 'double-float)) (anrm 0.0)
        ...
        (declare (type (array double-float (1)) dum)
                 ...
                 (type (f2cl-lib:integer4) bdspac blk chunk i ie ierr ir iscl
                  itau itaup itauq iu iwork ldwrkr ldwrku maxwrk minmn minwrk
        ...
        (cond
         ((and (= info 0) (or (>= lwork 1) lquery) (> m 0) (> n 0))
          (cond
           ((>= m n) (setf bdspac (f2cl-lib:int-mul 5 n))
            (cond
             ((>= m mnthr)
              (cond
               (wntun
             ...
             (t
              ...
              (setf maxwrk
                      (max (the f2cl-lib:integer4 maxwrk)
                           (the f2cl-lib:integer4 minwrk))))))
           (t (setf bdspac (f2cl-lib:int-mul 5 m))
            (cond
             ((>= n mnthr)
              (cond
               (wntvn
        ...
        (cond
         ((/= info 0) (xerbla "DGESVD" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (cond
         ((or (= m 0) (= n 0))
          (if (>= lwork 1)
              ...
              (multiple-value-bind
                  ...
                  (dgeqrf m n a lda
                   (f2cl-lib:array-slice work-%data% double-float (itau)
                                         ((1 *)) work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (iwork)
                                         ((1 *)) work-%offset%)
                ...
                (multiple-value-bind
                    ...
                    (dgebrd n n
                     (f2cl-lib:array-slice work-%data% double-float (ir)
                                           ((1 *)) work-%offset%)
                     ldwrkr s
                     (f2cl-lib:array-slice work-%data% double-float (ie)
                                           ((1 *)) work-%offset%)
                     (f2cl-lib:array-slice work-%data% double-float (itauq)
                                           ((1 *)) work-%offset%)
                     (f2cl-lib:array-slice work-%data% double-float (itaup)
             ...
             ((and wntuo wntvas)
              (cond
               ((>= lwork
                ...
                (dlaset "L" (f2cl-lib:int-sub n 1) (f2cl-lib:int-sub n 1) zero
                 zero
                 (f2cl-lib:array-slice vt-%data% double-float (2 1)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 ldvt)
                (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8)
            ...
            (multiple-value-bind
                ...
                (dgebrd m n a lda s
                 ...
                 (f2cl-lib:array-slice work-%data% double-float (itaup) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (iwork) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:int-add (f2cl-lib:int-sub lwork iwork) 1) ierr)
              (declare
               (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
              ...
              (setf ierr var-10))
            (cond
             (wntuas (dlacpy "L" m n a lda u ldu)
              (if wntus
                  (setf ncu n))
              (if wntua
                  (setf ncu m))
              (multiple-value-bind
                ...
                (setf ierr var-9))))
            (cond
             (wntvas (dlacpy "U" n n a lda vt ldvt)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
                  (dorgbr "P" n n n vt ldvt
                   (f2cl-lib:array-slice work-%data% double-float (itaup)
          ...
          (cond
                ...
                (multiple-value-bind
                  ...
                  (declare
                   (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                    var-8))
                  (setf ierr var-9))))
              (setf iwork (f2cl-lib:int-add ie m)) (setf nru 0)
              (if (or wntuo wntuas)
                  (setf nru m))
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
             ...
             ((and wntvo wntun)
              (cond
               ((>= lwork
                ...
                (dlaset "U" (f2cl-lib:int-sub m 1) (f2cl-lib:int-sub m 1) zero
                 zero
                 (f2cl-lib:array-slice work-%data% double-float ((+ ir ldwrkr))
                                       ((1 *)) work-%offset%)
                 ldwrkr)
                (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8)
             ...
             ((and wntvo wntuas)
              (cond
               ((>= lwork
                ...
                (dlaset "U" (f2cl-lib:int-sub m 1) (f2cl-lib:int-sub m 1) zero
                 zero
                 (f2cl-lib:array-slice u-%data% double-float (1 2)
                                       ((1 ldu) (1 *)) u-%offset%)
                 ldu)
                (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8)
           ...
           (t (setf ie 1) (setf itauq (f2cl-lib:int-add ie m))
            ...
            (multiple-value-bind
              ...
              (setf ierr var-10))
            (cond
             (wntuas (dlacpy "L" m m a lda u ldu)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
                ...
                (setf ierr var-9))))
            (cond
             (wntvas (dlacpy "U" m n a lda vt ldvt)
              (if wntva
                  (setf nrvt n))
              (if wntvs
                  (setf nrvt m))
          ...
          (cond
           ((> ie 2)
            (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                          ((> i (f2cl-lib:int-add minmn (f2cl-lib:int-sub 1)))
                           nil)
              (tagbody
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add i 1))
                                     ((1 *)) work-%offset%)
                        (f2cl-lib:fref work-%data%
                                       ((f2cl-lib:int-sub
                                         (f2cl-lib:int-add i ie) 1))
                                       ((1 *)) work-%offset%))
               label50))))
          (cond
           ((< ie 2)
          ...
          (if (and (/= info 0) (> anrm bignum))
              (multiple-value-bind
                  ...
                  (dlascl "G" 0 0 bignum anrm (f2cl-lib:int-sub minmn 1) 1
                   (f2cl-lib:array-slice work-%data% double-float (2) ((1 *))
                                         work-%offset%)
                   minmn ierr)
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7

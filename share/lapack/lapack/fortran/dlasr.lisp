  ...
  (defun dlasr (side pivot direct m n c s a lda)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((ctemp 0.0) (stemp 0.0) (temp 0.0) (i 0) (info 0) (j 0))
        ...
        (setf info 0)
        (cond ((not (or (lsame side "L") (lsame side "R"))) (setf info 1))
              ((not (or (lsame pivot "V") (lsame pivot "T") (lsame pivot "B")))
               (setf info 2))
              ((not (or (lsame direct "F") (lsame direct "B"))) (setf info 3))
              ((< m 0) (setf info 4)) ((< n 0) (setf info 5))
              ((< lda
                  (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 m)))
               (setf info 9)))
        (cond ((/= info 0) (xerbla "DLASR " info) (go end_label)))
        (if (or (= m 0) (= n 0))
            (go end_label))
        (cond
         ((lsame side "L")
             ...
             ((lsame direct "F")
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                            ((> j (f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
                             nil)
                (tagbody
                  (setf ctemp (f2cl-lib:fref c-%data% (j) ((1 *)) c-%offset%))
                  (setf stemp (f2cl-lib:fref s-%data% (j) ((1 *)) s-%offset%))
                  (cond
                    ...
                    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ...
                      (tagbody
                        ...
                        (setf (f2cl-lib:fref a-%data%
                                ...
                                (- (* ctemp temp)
                                   (* stemp
                                      (f2cl-lib:fref a-%data% (j i)
                                                     ((1 lda) (1 *))
                                                     a-%offset%))))
                        (setf (f2cl-lib:fref a-%data% (j i) ((1 lda) (1 *))
                                             a-%offset%)
                                (+ (* stemp temp)
                                   (* ctemp
                                      (f2cl-lib:fref a-%data% (j i)
            ...
            (cond
             ((lsame direct "F")
              (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
                ...
                (tagbody
                  (setf ctemp
                          (f2cl-lib:fref c-%data% ((f2cl-lib:int-sub j 1))
                                         ((1 *)) c-%offset%))
                  (setf stemp
                          (f2cl-lib:fref s-%data% ((f2cl-lib:int-sub j 1))
                                         ((1 *)) s-%offset%))
                  (cond
                   ((or (/= ctemp one) (/= stemp zero))
                    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ...
                      (tagbody
                        ...
                        (setf (f2cl-lib:fref a-%data% (j i) ((1 lda) (1 *))
                                ...
                                (- (* ctemp temp)
                                   (* stemp
                                      (f2cl-lib:fref a-%data% (1 i)
                                                     ((1 lda) (1 *))
                                                     a-%offset%))))
                        (setf (f2cl-lib:fref a-%data% (1 i) ((1 lda) (1 *))
                                             a-%offset%)
                                (+ (* stemp temp)
                                   (* ctemp
                                      (f2cl-lib:fref a-%data% (1 i)
                    ...
                    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ...
                      (tagbody
                        ...
                        (setf (f2cl-lib:fref a-%data% (j i) ((1 lda) (1 *))
                                ...
                                (+
                                 (* stemp
                                    (f2cl-lib:fref a-%data% (m i)
                                                   ((1 lda) (1 *)) a-%offset%))
                                 (* ctemp temp)))
                        (setf (f2cl-lib:fref a-%data% (m i) ((1 lda) (1 *))
                                             a-%offset%)
                                (-
                                 (* ctemp
                                    (f2cl-lib:fref a-%data% (m i)
                    ...
                    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ...
                      (tagbody
                        ...
                        (setf (f2cl-lib:fref a-%data% (i j) ((1 lda) (1 *))
                                ...
                                (- (* ctemp temp)
                                   (* stemp
                                      (f2cl-lib:fref a-%data% (i 1)
                                                     ((1 lda) (1 *))
                                                     a-%offset%))))
                        (setf (f2cl-lib:fref a-%data% (i 1) ((1 lda) (1 *))
                                             a-%offset%)
                                (+ (* stemp temp)
                                   (* ctemp
                                      (f2cl-lib:fref a-%data% (i 1)
                    ...
                    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ...
                      (tagbody
                        ...
                        (setf (f2cl-lib:fref a-%data% (i j) ((1 lda) (1 *))
                                ...
                                (+
                                 (* stemp
                                    (f2cl-lib:fref a-%data% (i n)
                                                   ((1 lda) (1 *)) a-%offset%))
                                 (* ctemp temp)))
                        (setf (f2cl-lib:fref a-%data% (i n) ((1 lda) (1 *))
                                             a-%offset%)
                                (-
                                 (* ctemp
                                    (f2cl-lib:fref a-%data% (i n)

  ...
  (defun ddisna (job m n d sep info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((anorm 0.0) (eps 0.0) (newgap 0.0) (oldgap 0.0) (safmin 0.0)
        ...
        (cond ((and (not eigen) (not sing)) (setf info -1))
              ((< m 0) (setf info -2)) ((< k 0) (setf info -3))
              (t (setf incr f2cl-lib:%true%) (setf decr f2cl-lib:%true%)
               (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                             ((> i (f2cl-lib:int-add k (f2cl-lib:int-sub 1)))
                              nil)
                 (tagbody
                   (if incr
                       (setf incr
                ...
                ((and sing (> k 0))
                 ...
                 (if decr
                     (setf decr
                             (and decr
                                  (>=
                                   (f2cl-lib:fref d-%data% (k) ((1 *))
                                                  d-%offset%)
                                   zero))))))
               (if (not (or incr decr))
                   (setf info -4))))
        (cond
         ((/= info 0) (xerbla "DDISNA" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= k 0)
            (go end_label))
        (cond
        ...
        (cond ((= anorm zero) (setf thresh eps))
              (t (setf thresh (max (* eps anorm) safmin))))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i k) nil)
          (tagbody
            (setf (f2cl-lib:fref sep-%data% (i) ((1 *)) sep-%offset%)

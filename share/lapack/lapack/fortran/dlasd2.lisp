  ...
  (defun dlasd2
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((c 0.0) (eps 0.0) (hlftol 0.0) (s 0.0) (tau 0.0) (tol 0.0)
        ...
        (setf info 0)
        (cond ((< nl 1) (setf info -1)) ((< nr 1) (setf info -2))
              ((and (/= sqre 1) (/= sqre 0)) (setf info -3)))
        (setf n (f2cl-lib:int-add nl nr 1))
        (setf m (f2cl-lib:int-add n sqre))
        (cond ((< ldu n) (setf info -10)) ((< ldvt m) (setf info -12))
              ((< ldu2 n) (setf info -15)) ((< ldvt2 m) (setf info -17)))
        (cond
         ((/= info 0) (xerbla "DLASD2" (f2cl-lib:int-sub info))
          (go end_label)))
        (setf nlp1 (f2cl-lib:int-add nl 1))
        (setf nlp2 (f2cl-lib:int-add nl 2))
        (setf z1
                (* alpha
                   (f2cl-lib:fref vt-%data% (nlp1 nlp1) ((1 ldvt) (1 *))
                                  vt-%offset%)))
        (setf (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%) z1)
        (f2cl-lib:fdo (i nl (f2cl-lib:int-add i (f2cl-lib:int-sub 1)))
                      ((> i 1) nil)
          (tagbody
            (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                 z-%offset%)
                    (* alpha
                       (f2cl-lib:fref vt-%data% (i nlp1) ((1 ldvt) (1 *))
                                      vt-%offset%)))
            (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                 d-%offset%)
                    (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%))
            (setf (f2cl-lib:fref idxq-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                 idxq-%offset%)
                    (f2cl-lib:int-add
                     (f2cl-lib:fref idxq-%data% (i) ((1 *)) idxq-%offset%) 1))
           label10))
        (f2cl-lib:fdo (i nlp2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                    (* beta
                       (f2cl-lib:fref vt-%data% (i nlp2) ((1 ldvt) (1 *))
                                      vt-%offset%)))
           label20))
        ...
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (setf (f2cl-lib:fref dsigma-%data% (i) ((1 *)) dsigma-%offset%)
                    (f2cl-lib:fref d-%data% ((f2cl-lib:fref idxq (i) ((1 *))))
                                   ((1 *)) d-%offset%))
            (setf (f2cl-lib:fref u2-%data% (i 1) ((1 ldu2) (1 *)) u2-%offset%)
                    (f2cl-lib:fref z-%data% ((f2cl-lib:fref idxq (i) ((1 *))))
                                   ((1 *)) z-%offset%))
            (setf (f2cl-lib:fref idxc-%data% (i) ((1 *)) idxc-%offset%)
                    (f2cl-lib:fref coltyp-%data%
                                   ((f2cl-lib:fref idxq (i) ((1 *)))) ((1 *))
                                   coltyp-%offset%))
           label60))
        (dlamrg nl nr
         (f2cl-lib:array-slice dsigma-%data% double-float (2) ((1 *))
                               dsigma-%offset%)
         1 1
         (f2cl-lib:array-slice idx-%data% f2cl-lib:integer4 (2) ((1 *))
                               idx-%offset%))
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
                      ((> i n) nil)
          (tagbody
            (setf idxi
                    (f2cl-lib:int-add 1
                                      (f2cl-lib:fref idx-%data% (i) ((1 *))
                                                     idx-%offset%)))
            (setf (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%)
                    (f2cl-lib:fref dsigma-%data% (idxi) ((1 *))
                                   dsigma-%offset%))
            (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                    (f2cl-lib:fref u2-%data% (idxi 1) ((1 ldu2) (1 *))
                                   u2-%offset%))
         ...
         (t
          (cond
           ((<=
            ...
            (setf tau (dlapy2 c s)) (setf c (/ c tau)) (setf s (/ (- s) tau))
            (setf (f2cl-lib:fref z-%data% (j) ((1 *)) z-%offset%) tau)
            (setf (f2cl-lib:fref z-%data% (jprev) ((1 *)) z-%offset%) zero)
            (setf idxjp
                    (f2cl-lib:fref idxq-%data%
                                   ((f2cl-lib:int-add
                                     (f2cl-lib:fref idx (jprev) ((1 *))) 1))
                                   ((1 *)) idxq-%offset%))
            (setf idxj
                    (f2cl-lib:fref idxq-%data%
                                   ((f2cl-lib:int-add
                                     (f2cl-lib:fref idx (j) ((1 *))) 1))
                                   ((1 *)) idxq-%offset%))
            (cond ((<= idxjp nlp1) (setf idxjp (f2cl-lib:int-sub idxjp 1))))
            (cond ((<= idxj nlp1) (setf idxj (f2cl-lib:int-sub idxj 1))))
            (drot n
             (f2cl-lib:array-slice u-%data% double-float (1 idxjp)
                                   ((1 ldu) (1 *)) u-%offset%)
             1
             (f2cl-lib:array-slice u-%data% double-float (1 idxj)
                                   ((1 ldu) (1 *)) u-%offset%)
             1 c s)
            (drot m
             (f2cl-lib:array-slice vt-%data% double-float (idxjp 1)
                                   ((1 ldvt) (1 *)) vt-%offset%)
             ldvt
             (f2cl-lib:array-slice vt-%data% double-float (idxj 1)
                                   ((1 ldvt) (1 *)) vt-%offset%)
             ldvt c s)
            (cond
             ((/= (f2cl-lib:fref coltyp (j) ((1 *)))
              ...
              (setf (f2cl-lib:fref coltyp-%data% (j) ((1 *)) coltyp-%offset%)
                      3)))
            (setf (f2cl-lib:fref coltyp-%data% (jprev) ((1 *)) coltyp-%offset%)
                    4)
            (setf k2 (f2cl-lib:int-sub k2 1))
            (setf (f2cl-lib:fref idxp-%data% (k2) ((1 *)) idxp-%offset%) jprev)
            (setf jprev j))
           (t (setf k (f2cl-lib:int-add k 1))
       ...
       label120
        ...
        (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref idxc-%data% ((f2cl-lib:fref psm (ct) ((1 4))))
                                 ((1 *)) idxc-%offset%)
                    j)
          ...
          (tagbody
            ...
            (dcopy n
             (f2cl-lib:array-slice u-%data% double-float (1 idxj)
                                   ((1 ldu) (1 *)) u-%offset%)
             1
             (f2cl-lib:array-slice u2-%data% double-float (1 j)
                                   ((1 ldu2) (1 *)) u2-%offset%)
             1)
            (dcopy m
             (f2cl-lib:array-slice vt-%data% double-float (idxj 1)
                                   ((1 ldvt) (1 *)) vt-%offset%)
             ldvt
             (f2cl-lib:array-slice vt2-%data% double-float (j 1)
                                   ((1 ldvt2) (1 *)) vt2-%offset%)
             ldvt2)
           label160))
        (setf (f2cl-lib:fref dsigma-%data% (1) ((1 *)) dsigma-%offset%) zero)
        (setf hlftol (/ tol two))
        (if (<= (abs (f2cl-lib:fref dsigma-%data% (2) ((1 *)) dsigma-%offset%))
                hlftol)
        ...
        (cond
         ((> m n)
          ...
          (cond
           ((<= (f2cl-lib:fref z (1) ((1 *))) tol) (setf c one) (setf s zero)
            (setf (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%) tol))
           (t (setf c (/ z1 (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%)))
            (setf s
         ...
         (t
          (cond
           ((<= (abs z1) tol)
            (setf (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%) tol))
           (t (setf (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%) z1)))))
        (dcopy (f2cl-lib:int-sub k 1)
         (f2cl-lib:array-slice u2-%data% double-float (2 1) ((1 ldu2) (1 *))
                               u2-%offset%)
        ...
        (cond
         ((> m n)
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i nlp1) nil)
            (tagbody
              (setf (f2cl-lib:fref vt-%data% (m i) ((1 ldvt) (1 *))
                                   vt-%offset%)
                      (* (- s)
                         (f2cl-lib:fref vt-%data% (nlp1 i) ((1 ldvt) (1 *))
                                        vt-%offset%)))
              (setf (f2cl-lib:fref vt2-%data% (1 i) ((1 ldvt2) (1 *))
                                   vt2-%offset%)
                      (* c
                         (f2cl-lib:fref vt-%data% (nlp1 i) ((1 ldvt) (1 *))
                                        vt-%offset%)))
          ...
          (f2cl-lib:fdo (i nlp2 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              (setf (f2cl-lib:fref vt2-%data% (1 i) ((1 ldvt2) (1 *))
                                   vt2-%offset%)
                      (* s
                         (f2cl-lib:fref vt-%data% (m i) ((1 ldvt) (1 *))
                                        vt-%offset%)))
              (setf (f2cl-lib:fref vt-%data% (m i) ((1 ldvt) (1 *))
                                   vt-%offset%)
                      (* c
         ...
         (t
          (dcopy m
           (f2cl-lib:array-slice vt-%data% double-float (nlp1 1)
                                 ((1 ldvt) (1 *)) vt-%offset%)
           ldvt
           (f2cl-lib:array-slice vt2-%data% double-float (1 1)
                                 ((1 ldvt2) (1 *)) vt2-%offset%)
           ldvt2)))
        (cond
         ((> m n)
          (dcopy m
           (f2cl-lib:array-slice vt-%data% double-float (m 1) ((1 ldvt) (1 *))
                                 vt-%offset%)
           ldvt
           (f2cl-lib:array-slice vt2-%data% double-float (m 1)
                                 ((1 ldvt2) (1 *)) vt2-%offset%)
           ldvt2)))
        (cond
         ((> n k)
          (dcopy (f2cl-lib:int-sub n k)
           (f2cl-lib:array-slice dsigma-%data% double-float ((+ k 1)) ((1 *))
                                 dsigma-%offset%)
           1
           (f2cl-lib:array-slice d-%data% double-float ((+ k 1)) ((1 *))
                                 d-%offset%)
           1)
          (dlacpy "A" n (f2cl-lib:int-sub n k)
           (f2cl-lib:array-slice u2-%data% double-float
                                 (1 (f2cl-lib:int-add k 1)) ((1 ldu2) (1 *))
                                 u2-%offset%)
           ldu2
           (f2cl-lib:array-slice u-%data% double-float
                                 (1 (f2cl-lib:int-add k 1)) ((1 ldu) (1 *))
                                 u-%offset%)
           ldu)
          (dlacpy "A" (f2cl-lib:int-sub n k) m
           (f2cl-lib:array-slice vt2-%data% double-float ((+ k 1) 1)
                                 ((1 ldvt2) (1 *)) vt2-%offset%)
           ldvt2
           (f2cl-lib:array-slice vt-%data% double-float ((+ k 1) 1)
                                 ((1 ldvt) (1 *)) vt-%offset%)
           ldvt)))
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                      ((> j 4) nil)
       ...
       end_label
        (return
         (values nil nil nil k nil nil nil nil nil nil nil nil nil nil nil nil

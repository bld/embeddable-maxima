      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((cdum #C(0.0 0.0)) (ovfl 0.0) (remax 0.0) (scale 0.0) (smin 0.0)
          ...
          (cond ((and (not rightv) (not leftv)) (setf info -1))
                ...
                ((< mm m) (setf info -11)))
          (cond
           ((/= info 0) (xerbla "ZTREVC" (f2cl-lib:int-sub info))
            (go end_label)))
          (if (= n 0)
              (go end_label))
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
              (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add i n)) ((1 *))
                                   work-%offset%)
            ...
            (tagbody
              (setf (f2cl-lib:fref rwork-%data% (j) ((1 *)) rwork-%offset%)
                      (dzasum (f2cl-lib:int-sub j 1)
                       (f2cl-lib:array-slice t$-%data% f2cl-lib:complex16 (1 j)
                                             ((1 ldt) (1 *)) t$-%offset%)
                       1))
             label30))
          (cond
              ...
              (tagbody
                ...
                (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                              ((> k (f2cl-lib:int-add ki (f2cl-lib:int-sub 1)))
                               nil)
                  (tagbody
                    (setf (f2cl-lib:fref t$-%data% (k k) ((1 ldt) (1 *))
                                         t$-%offset%)
                            (-
                             (f2cl-lib:fref t$-%data% (k k) ((1 ldt) (1 *))
                                            t$-%offset%)
                             (f2cl-lib:fref t$-%data% (ki ki) ((1 ldt) (1 *))
                                            t$-%offset%)))
                    (if (<
                 ...
                 ((> ki 1)
                  (multiple-value-bind
                      ...
                      (zlatrs "Upper" "No transpose" "Non-unit" "Y"
                       ...
                       (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (1)
                                             ((1 *)) work-%offset%)
                       scale rwork info)
                    (declare
                    ...
                    (setf scale var-8)
                    (setf info var-10))
                  (setf (f2cl-lib:fref work-%data% (ki) ((1 *)) work-%offset%)
                 ...
                 ((not over)
                  (zcopy ki
                   (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (1)
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vr-%data% f2cl-lib:complex16 (1 is)
                                         ((1 ldvr) (1 *)) vr-%offset%)
                   1)
                  (setf ii
                          (izamax ki
                          ...
                          (/ one
                             (cabs1
                              (f2cl-lib:fref vr-%data% (ii ki) ((1 ldvr) (1 *))
                                             vr-%offset%))))
                  (zdscal n remax
                   (f2cl-lib:array-slice vr-%data% f2cl-lib:complex16 (1 ki)
                                         ((1 ldvr) (1 *)) vr-%offset%)
                   1)))
                (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                              ((> k (f2cl-lib:int-add ki (f2cl-lib:int-sub 1)))
                  ...
                  (tagbody
                    (setf (f2cl-lib:fref t$-%data% (k k) ((1 ldt) (1 *))
                                         t$-%offset%)
                            (f2cl-lib:fref work-%data% ((f2cl-lib:int-add k n))
                                           ((1 *)) work-%offset%))
                   label70))
                ...
                (cond
                 ((not over)
                  (zcopy (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1)
                   (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (ki)
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vl-%data% f2cl-lib:complex16 (ki is)
                                         ((1 ldvl) (1 *)) vl-%offset%)
                   1)
                  (setf ii
                          (f2cl-lib:int-sub
                          ...
                          (/ one
                             (cabs1
                              (f2cl-lib:fref vl-%data% (ii ki) ((1 ldvl) (1 *))
                                             vl-%offset%))))
                  (zdscal n remax
                   (f2cl-lib:array-slice vl-%data% f2cl-lib:complex16 (1 ki)
                                         ((1 ldvl) (1 *)) vl-%offset%)
                   1)))
                (f2cl-lib:fdo (k (f2cl-lib:int-add ki 1) (f2cl-lib:int-add k 1))
                              ((> k n) nil)
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil nil nil nil nil m nil nil
                   info)))))))

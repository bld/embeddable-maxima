    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((diflj 0.0) (difrj 0.0) (dj 0.0) (dsigj 0.0) (dsigjp 0.0)
        ...
        (cond ((or (< icompq 0) (> icompq 1)) (setf info -1))
              ((< k 1) (setf info -2)) ((< lddifr k) (setf info -9)))
        (cond
         ((/= info 0) (xerbla "DLASD8" (f2cl-lib:int-sub info))
          (go end_label)))
        (cond
         ((= k 1)
          ...
          (cond
           ((= icompq 1)
            ...
            (setf (f2cl-lib:fref difr-%data% (1 2) ((1 lddifr) (1 *))
                                 difr-%offset%)
                    one)))
          (go end_label)))
        ...
        (dlaset "A" k 1 one one
         (f2cl-lib:array-slice work-%data% double-float (iwk3) ((1 *))
                               work-%offset%)
         k)
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
          ...
          (tagbody
            (multiple-value-bind
                ...
                (dlasd4 k j dsigma z
                 (f2cl-lib:array-slice work-%data% double-float (iwk1) ((1 *))
                                       work-%offset%)
                 rho (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (iwk2) ((1 *))
                                       work-%offset%)
                 info)
            ...
            (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk3i j))
                                 ((1 *)) work-%offset%)
                    (*
                     (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk3i j))
                                    ((1 *)) work-%offset%)
                     (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                     (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk2i j))
                                    ((1 *)) work-%offset%)))
            (setf (f2cl-lib:fref difl-%data% (j) ((1 *)) difl-%offset%)
                    (- (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)))
            (setf (f2cl-lib:fref difr-%data% (j 1) ((1 lddifr) (1 *))
                                 difr-%offset%)
                    (-
                     (f2cl-lib:fref work-%data% ((f2cl-lib:int-add j 1))
                                    ((1 *)) work-%offset%)))
            (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                          ((> i (f2cl-lib:int-add j (f2cl-lib:int-sub 1))) nil)
              (tagbody
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk3i i))
                                     ((1 *)) work-%offset%)
                        (/
                         (/
                          (*
                           (f2cl-lib:fref work-%data%
                                          ((f2cl-lib:int-add iwk3i i)) ((1 *))
                                          work-%offset%)
                           (f2cl-lib:fref work-%data% (i) ((1 *))
                                          work-%offset%)
                           (f2cl-lib:fref work-%data%
                                          ((f2cl-lib:int-add iwk2i i)) ((1 *))
                                          work-%offset%))
                          (-
                           (f2cl-lib:fref dsigma-%data% (i) ((1 *))
                                          dsigma-%offset%)
          ...
          (tagbody
            (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                    (f2cl-lib:sign
                     (f2cl-lib:fsqrt
                      (abs
                       (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk3i i))
                                      ((1 *)) work-%offset%)))
          ...
          (tagbody
            ...
            (cond
             ((< j k)
              (setf difrj
                      (-
                       (f2cl-lib:fref difr-%data% (j 1) ((1 lddifr) (1 *))
                                      difr-%offset%)))
              (setf dsigjp
                      (-
                       (f2cl-lib:fref dsigma-%data% ((f2cl-lib:int-add j 1))
                                      ((1 *)) dsigma-%offset%)))))
            ...
            (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add iwk2i j))
                                 ((1 *)) work-%offset%)
            ...
            (cond
             ((= icompq 1)
              (setf (f2cl-lib:fref difr-%data% (j 2) ((1 lddifr) (1 *))
                                   difr-%offset%)
                      temp)))
           label80))
        (dcopy k

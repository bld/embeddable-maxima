  ...
  (defun dlasdq (uplo sqre n ncvt nru ncc d e vt ldvt u ldu c ldc work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cs 0.0) (r 0.0) (smin 0.0) (sn 0.0) (i 0) (isub 0) (iuplo 0)
        ...
        (if (lsame uplo "L")
            (setf iuplo 2))
        (cond ((= iuplo 0) (setf info -1))
              ((or (< sqre 0) (> sqre 1)) (setf info -2))
              ((< n 0) (setf info -3)) ((< ncvt 0) (setf info -4))
              ((< nru 0) (setf info -5)) ((< ncc 0) (setf info -6))
              ...
              ((or (and (= ncc 0) (< ldc 1))
               ...
               (setf info -14)))
        (cond
         ((/= info 0) (xerbla "DLASDQ" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= n 0)
            (go end_label))
         ...
         ((and (= iuplo 1) (= sqre1 1))
            ...
            (tagbody
              ...
              (cond
               (rotate
                ...
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add n i))
                                     ((1 *)) work-%offset%)
                        sn)))
             label10))
          (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
          ...
          (cond
           (rotate
            ...
            (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add n n)) ((1 *))
                                 work-%offset%)
                    sn)))
          (setf iuplo 2) (setf sqre1 0)
          (if (> ncvt 0)
              (dlasr "L" "V" "F" np1 ncvt
               (f2cl-lib:array-slice work-%data% double-float (1) ((1 *))
                                     work-%offset%)
               (f2cl-lib:array-slice work-%data% double-float (np1) ((1 *))
                                     work-%offset%)
               vt ldvt))))
        (cond
         ((= iuplo 2)
              ...
              (if (> ncc 0)
                  (dswap ncc
                   (f2cl-lib:array-slice c-%data% double-float (isub 1)
                                         ((1 ldc) (1 *)) c-%offset%)
                   ldc
                   (f2cl-lib:array-slice c-%data% double-float (i 1)
                                         ((1 ldc) (1 *)) c-%offset%)
                   ldc))))
           label40))
        (go end_label)

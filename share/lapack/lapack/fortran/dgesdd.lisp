      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
        ...
        (declare (type (array double-float (1)) dum)
                 ...
                 (type (f2cl-lib:integer4) bdspac blk chunk i ie ierr il ir
                  iscl itau itaup itauq iu ivt ldwkvt ldwrkl ldwrkr ldwrku
                  maxwrk minmn minwrk mnthr nwork wrkbl)
        ...
        (cond ((not (or wntqa wntqs wntqo wntqn)) (setf info -1))
              ((< m 0) (setf info -2)) ((< n 0) (setf info -3))
              ((< lda
                  (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 m)))
               (setf info -5))
              ((or (< ldu 1) (and wntqas (< ldu m))
                   (and wntqo (< m n) (< ldu m)))
               (setf info -8))
              ((or (< ldvt 1) (and wntqa (< ldvt n)) (and wntqs (< ldvt minmn))
        ...
        (cond
         ((and (= info 0) (> m 0) (> n 0))
          (cond
           ((>= m n)
            (cond (wntqn (setf bdspac (f2cl-lib:int-mul 7 n)))
                  (t
                   (setf bdspac
             ...
             ((>= m mnthr)
              (cond
               ...
               (wntqo
                ...
                (setf maxwrk (f2cl-lib:int-add wrkbl (f2cl-lib:int-mul 2 n n)))
                (setf minwrk
                        (f2cl-lib:int-add bdspac (f2cl-lib:int-mul 2 n n)
                                          (f2cl-lib:int-mul 3 n))))
               (wntqs
                (setf wrkbl
                        (f2cl-lib:int-add n
                ...
                (setf wrkbl
                        (max (the f2cl-lib:integer4 wrkbl)
                             (the f2cl-lib:integer4
                                  (f2cl-lib:int-add bdspac
                                                    (f2cl-lib:int-mul 3 n)))))
                (setf maxwrk (f2cl-lib:int-add wrkbl (f2cl-lib:int-mul n n)))
                (setf minwrk
                        (f2cl-lib:int-add bdspac (f2cl-lib:int-mul n n)
                                          (f2cl-lib:int-mul 3 n))))
               (wntqa
                (setf wrkbl
                        (f2cl-lib:int-add n
                ...
                (setf wrkbl
                        (max (the f2cl-lib:integer4 wrkbl)
                             (the f2cl-lib:integer4
                                  (f2cl-lib:int-add bdspac
                                                    (f2cl-lib:int-mul 3 n)))))
                (setf maxwrk (f2cl-lib:int-add wrkbl (f2cl-lib:int-mul m n)))
                (setf minwrk
                        (f2cl-lib:int-add (f2cl-lib:int-mul 3 n)
                                          (max (the f2cl-lib:integer4 m)
                                               (the f2cl-lib:integer4
                        ...
                        (f2cl-lib:int-add (f2cl-lib:int-mul 3 n)
                                          (max (the f2cl-lib:integer4 m)
                                               (the f2cl-lib:integer4
                                                    bdspac)))))))))
           (t
            (cond (wntqn (setf bdspac (f2cl-lib:int-mul 7 m)))
                  (t
                   (setf bdspac
             ...
             ((>= n mnthr)
              (cond
               ...
               (wntqo
                ...
                (setf maxwrk (f2cl-lib:int-add wrkbl (f2cl-lib:int-mul 2 m m)))
                (setf minwrk
                        (f2cl-lib:int-add bdspac (f2cl-lib:int-mul 2 m m)
                                          (f2cl-lib:int-mul 3 m))))
               (wntqs
                (setf wrkbl
                        (f2cl-lib:int-add m
                ...
                (setf wrkbl
                        (max (the f2cl-lib:integer4 wrkbl)
                             (the f2cl-lib:integer4
                                  (f2cl-lib:int-add bdspac
                                                    (f2cl-lib:int-mul 3 m)))))
                (setf maxwrk (f2cl-lib:int-add wrkbl (f2cl-lib:int-mul m m)))
                (setf minwrk
                        (f2cl-lib:int-add bdspac (f2cl-lib:int-mul m m)
                                          (f2cl-lib:int-mul 3 m))))
               (wntqa
                (setf wrkbl
                        (f2cl-lib:int-add m
        ...
        (cond
         ((/= info 0) (xerbla "DGESDD" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (cond
         ((or (= m 0) (= n 0))
          (if (>= lwork 1)
        ...
        (cond
         ((>= m n)
          (cond
           ((>= m mnthr)
            (cond
             (wntqn (setf itau 1) (setf nwork (f2cl-lib:int-add itau n))
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7)
                  (dgeqrf m n a lda
                   (f2cl-lib:array-slice work-%data% double-float (itau)
                                         ((1 *)) work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (nwork)
                                         ((1 *)) work-%offset%)
              ...
              (dlaset "L" (f2cl-lib:int-sub n 1) (f2cl-lib:int-sub n 1) zero
               zero
               (f2cl-lib:array-slice a-%data% double-float (2 1)
                                     ((1 lda) (1 *)) a-%offset%)
               lda)
              (setf ie 1) (setf itauq (f2cl-lib:int-add ie n))
              ...
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   var-10)
                  (dgebrd n n a lda s
                   (f2cl-lib:array-slice work-%data% double-float (ie) ((1 *))
                                         work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (itauq)
                                         ((1 *)) work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (itaup)
                                         ((1 *)) work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (nwork)
                                         ((1 *)) work-%offset%)
                   (f2cl-lib:int-add (f2cl-lib:int-sub lwork nwork) 1) ierr)
             ...
             (wntqo (setf ir 1)
              (cond
               ((>= lwork
                    (f2cl-lib:int-add (f2cl-lib:int-mul lda n)
                                      (f2cl-lib:int-mul n n)
                                      (f2cl-lib:int-mul 3 n) bdspac))
                (setf ldwrkr lda))
               (t
                (setf ldwrkr
                        (the f2cl-lib:integer4
                             (truncate (- lwork (* n n) (* 3 n) bdspac) n)))))
              ...
              (multiple-value-bind
                ...
                (setf ierr var-7))
              (dlacpy "U" n n a lda
               (f2cl-lib:array-slice work-%data% double-float (ir) ((1 *))
                                     work-%offset%)
               ldwrkr)
              (dlaset "L" (f2cl-lib:int-sub n 1) (f2cl-lib:int-sub n 1) zero
               zero
              ...
              (multiple-value-bind
                ...
                (setf ierr var-8))
              (setf ie itau) (setf itauq (f2cl-lib:int-add ie n))
              (setf itaup (f2cl-lib:int-add itauq n))
              (setf nwork (f2cl-lib:int-add itaup n))
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (multiple-value-bind
                  ...
                  (dbdsdc "U" "I" n s
                   (f2cl-lib:array-slice work-%data% double-float (ie) ((1 *))
                                         work-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (iu) ((1 *))
                                         work-%offset%)
                   n vt ldvt dum idum
                   (f2cl-lib:array-slice work-%data% double-float (nwork)
                                         ((1 *)) work-%offset%)
              ...
              (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i ldwrkr))
                ...
                (tagbody
                  ...
                  (dgemm "N" "N" chunk n n one
                   (f2cl-lib:array-slice a-%data% double-float (i 1)
                                         ((1 lda) (1 *)) a-%offset%)
                   lda
                   (f2cl-lib:array-slice work-%data% double-float (iu) ((1 *))
                                         work-%offset%)
           ...
           (t (setf ie 1) (setf itauq (f2cl-lib:int-add ie n))
            (setf itaup (f2cl-lib:int-add itauq n))
            (setf nwork (f2cl-lib:int-add itaup n))
            (multiple-value-bind
                (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                ...
                (dgebrd m n a lda s
                 (f2cl-lib:array-slice work-%data% double-float (ie) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (itauq) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (itaup) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:array-slice work-%data% double-float (nwork) ((1 *))
                                       work-%offset%)
                 (f2cl-lib:int-add (f2cl-lib:int-sub lwork nwork) 1) ierr)
              (declare
               (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
               ...
               ((>= lwork
                ...
                (multiple-value-bind
                    ...
                    (dormbr "Q" "L" "N" m n n a lda
                     (f2cl-lib:array-slice work-%data% double-float (itauq)
                                           ((1 *)) work-%offset%)
                     (f2cl-lib:array-slice work-%data% double-float (iu)
                                           ((1 *)) work-%offset%)
                     ldwrku
                     (f2cl-lib:array-slice work-%data% double-float (nwork)
                                           ((1 *)) work-%offset%)
                  ...
                  (tagbody
                    ...
                    (dgemm "N" "N" chunk n n one
                     ...
                     (f2cl-lib:array-slice work-%data% double-float (iu)
                                           ((1 *)) work-%offset%)
                     ldwrku zero
                     (f2cl-lib:array-slice work-%data% double-float (ir)
                                           ((1 *)) work-%offset%)
                     ldwrkr)
                    (dlacpy "F" chunk n
                     (f2cl-lib:array-slice work-%data% double-float (ir)
                     ...
                     lda)
                   label20)))))
             (wntqs (dlaset "F" m n zero zero u ldu)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   var-10 var-11 var-12 var-13)
                  (dbdsdc "U" "I" n s
              ...
              (multiple-value-bind
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                  var-9 var-10 var-11 var-12))
                (setf ierr var-13)))
             (wntqa (dlaset "F" m m zero zero u ldu)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   var-10 var-11 var-12 var-13)
                  (dbdsdc "U" "I" n s
         ...
         (t
          (cond
           ((>= n mnthr)
            (cond
             (wntqn (setf itau 1) (setf nwork (f2cl-lib:int-add itau m))
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7)
                  (dgelqf m n a lda
                   (f2cl-lib:array-slice work-%data% double-float (itau)
              ...
              (dlaset "U" (f2cl-lib:int-sub m 1) (f2cl-lib:int-sub m 1) zero
               zero
               (f2cl-lib:array-slice a-%data% double-float (1 2)
                                     ((1 lda) (1 *)) a-%offset%)
               lda)
              (setf ie 1) (setf itauq (f2cl-lib:int-add ie m))
             ...
             (wntqo (setf ivt 1)
              ...
              (cond
               ((>= lwork
                    (f2cl-lib:int-add (f2cl-lib:int-mul m n)
                                      (f2cl-lib:int-mul m m)
                                      (f2cl-lib:int-mul 3 m) bdspac))
                (setf ldwrkl m) (setf chunk n))
               (t (setf ldwrkl m)
                (setf chunk
                        (the f2cl-lib:integer4
              ...
              (multiple-value-bind
                ...
                (setf ierr var-7))
              (dlacpy "L" m m a lda
               (f2cl-lib:array-slice work-%data% double-float (il) ((1 *))
                                     work-%offset%)
               ldwrkl)
              (dlaset "U" (f2cl-lib:int-sub m 1) (f2cl-lib:int-sub m 1) zero
               zero
               (f2cl-lib:array-slice work-%data% double-float ((+ il ldwrkl))
                                     ((1 *)) work-%offset%)
               ldwrkl)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8)
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7))
                (setf ierr var-8))
              (setf ie itau) (setf itauq (f2cl-lib:int-add ie m))
              (setf itaup (f2cl-lib:int-add itauq m))
              (setf nwork (f2cl-lib:int-add itaup m))
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (multiple-value-bind
                  ...
                  (dbdsdc "U" "I" m s
                   (f2cl-lib:array-slice work-%data% double-float (ie) ((1 *))
                                         work-%offset%)
                   u ldu
                   (f2cl-lib:array-slice work-%data% double-float (ivt) ((1 *))
                                         work-%offset%)
                   m dum idum
                   (f2cl-lib:array-slice work-%data% double-float (nwork)
                                         ((1 *)) work-%offset%)
                ...
                (tagbody
                  ...
                  (dgemm "N" "N" m blk m one
                   (f2cl-lib:array-slice work-%data% double-float (ivt) ((1 *))
                                         work-%offset%)
                   m
                   (f2cl-lib:array-slice a-%data% double-float (1 i)
                                         ((1 lda) (1 *)) a-%offset%)
                   lda zero
                   (f2cl-lib:array-slice work-%data% double-float (il) ((1 *))
                                         work-%offset%)
             ...
             (wntqa (setf ivt 1) (setf ldwkvt m)
           ...
           (t (setf ie 1) (setf itauq (f2cl-lib:int-add ie m))
            (setf itaup (f2cl-lib:int-add itauq m))
            (setf nwork (f2cl-lib:int-add itaup m))
            (multiple-value-bind
                (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (multiple-value-bind
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                  var-9 var-10 var-11 var-12))
                (setf info var-13)))
             (wntqo (setf ldwkvt m) (setf ivt nwork)
              (cond
               ((>= lwork
                    (f2cl-lib:int-add (f2cl-lib:int-mul m n)
                                      (f2cl-lib:int-mul 3 m) bdspac))
               ...
               (t
                (setf nwork (f2cl-lib:int-add ivt (f2cl-lib:int-mul ldwkvt m)))
                (setf il nwork)
                (setf chunk
                        (the f2cl-lib:integer4
               ...
               ((>= lwork
                ...
                (multiple-value-bind
                    ...
                    (dormbr "P" "R" "T" m n m a lda
                     (f2cl-lib:array-slice work-%data% double-float (itaup)
                                           ((1 *)) work-%offset%)
                     (f2cl-lib:array-slice work-%data% double-float (ivt)
                                           ((1 *)) work-%offset%)
                     ldwkvt
                     (f2cl-lib:array-slice work-%data% double-float (nwork)
                                           ((1 *)) work-%offset%)
                  ...
                  (tagbody
                    ...
                    (dgemm "N" "N" m blk m one
                     ...
                     (f2cl-lib:array-slice a-%data% double-float (1 i)
                                           ((1 lda) (1 *)) a-%offset%)
                     lda zero
                     (f2cl-lib:array-slice work-%data% double-float (il)
                                           ((1 *)) work-%offset%)
                     m)
                    (dlacpy "F" m blk
                     (f2cl-lib:array-slice work-%data% double-float (il)
                     ...
                     lda)
                   label40)))))
             (wntqs (dlaset "F" m n zero zero vt ldvt)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   var-10 var-11 var-12 var-13)
                  (dbdsdc "L" "I" m s
              ...
              (multiple-value-bind
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                  var-9 var-10 var-11 var-12))
                (setf ierr var-13)))
             (wntqa (dlaset "F" n n zero zero vt ldvt)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   var-10 var-11 var-12 var-13)
                  (dbdsdc "L" "I" m s

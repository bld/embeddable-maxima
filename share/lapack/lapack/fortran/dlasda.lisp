      ...
      (prog ((alpha 0.0) (beta 0.0) (i 0) (i1 0) (ic 0) (idxq 0) (idxqi 0)
        ...
        (declare (type (double-float) alpha beta)
                 (type (f2cl-lib:integer4) i i1 ic idxq idxqi im1 inode itemp
                  iwk j lf ll lvl lvl2 m ncc nd ndb1 ndiml ndimr nl nlf nlp1
                  nlvl nr nrf nrp1 nru nwork1 nwork2 smlszp sqrei vf vfi vl
                  vli))
        (setf info 0)
        (cond ((or (< icompq 0) (> icompq 1)) (setf info -1))
              ((< smlsiz 3) (setf info -2)) ((< n 0) (setf info -3))
              ((or (< sqre 0) (> sqre 1)) (setf info -4))
              ((< ldu (f2cl-lib:int-add n sqre)) (setf info -8))
              ((< ldgcol n) (setf info -17)))
        (cond
         ((/= info 0) (xerbla "DLASDA" (f2cl-lib:int-sub info))
          (go end_label)))
        ...
        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
            (dlasdt n nlvl nd
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (inode)
                                   ((1 *)) iwork-%offset%)
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (ndiml)
                                   ((1 *)) iwork-%offset%)
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (ndimr)
                                   ((1 *)) iwork-%offset%)
             smlsiz)
        ...
        (f2cl-lib:fdo (i ndb1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf ic
                    (f2cl-lib:fref iwork-%data% ((f2cl-lib:int-add inode i1))
                                   ((1 *)) iwork-%offset%))
            (setf nl
                    (f2cl-lib:fref iwork-%data% ((f2cl-lib:int-add ndiml i1))
                                   ((1 *)) iwork-%offset%))
            (setf nlp1 (f2cl-lib:int-add nl 1))
            (setf nr
                    (f2cl-lib:fref iwork-%data% ((f2cl-lib:int-add ndimr i1))
                                   ((1 *)) iwork-%offset%))
            ...
            (cond
             ((= icompq 0)
              (dlaset "A" nlp1 nlp1 zero one
               (f2cl-lib:array-slice work-%data% double-float (nwork1) ((1 *))
                                     work-%offset%)
               smlszp)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                  ...
                  (dlasdq "U" sqrei nl nlp1 nru ncc
                   (f2cl-lib:array-slice d-%data% double-float (nlf) ((1 *))
                                         d-%offset%)
                   (f2cl-lib:array-slice e-%data% double-float (nlf) ((1 *))
                                         e-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (nwork1)
                                         ((1 *)) work-%offset%)
                   smlszp
                   (f2cl-lib:array-slice work-%data% double-float (nwork2)
                                         ((1 *)) work-%offset%)
                   nl
                   (f2cl-lib:array-slice work-%data% double-float (nwork2)
                                         ((1 *)) work-%offset%)
              ...
              (dcopy nlp1
               (f2cl-lib:array-slice work-%data% double-float (nwork1) ((1 *))
                                     work-%offset%)
               1
               (f2cl-lib:array-slice work-%data% double-float (vfi) ((1 *))
                                     work-%offset%)
               1)
              (dcopy nlp1
               (f2cl-lib:array-slice work-%data% double-float (itemp) ((1 *))
                                     work-%offset%)
               1
               (f2cl-lib:array-slice work-%data% double-float (vli) ((1 *))
                                     work-%offset%)
               1))
             (t
              (dlaset "A" nl nl zero one
               (f2cl-lib:array-slice u-%data% double-float (nlf 1)
                                     ((1 ldu) (1 *)) u-%offset%)
               ldu)
              (dlaset "A" nlp1 nlp1 zero one
               (f2cl-lib:array-slice vt-%data% double-float (nlf 1)
                                     ((1 ldu) (1 *)) vt-%offset%)
               ldu)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (dcopy nlp1
               ...
               1)
              (dcopy nlp1
               (f2cl-lib:array-slice vt-%data% double-float (nlf nlp1)
                                     ((1 ldu) (1 *)) vt-%offset%)
               1
               (f2cl-lib:array-slice work-%data% double-float (vli) ((1 *))
                                     work-%offset%)
               1)))
            (cond ((/= info 0) (go end_label)))
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                          ((> j nl) nil)
              (tagbody
                (setf (f2cl-lib:fref iwork-%data% ((f2cl-lib:int-add idxqi j))
                                     ((1 *)) iwork-%offset%)
                        j)
               label10))
            (cond ((and (= i nd) (= sqre 0)) (setf sqrei 0))
                  (t (setf sqrei 1)))
            ...
            (cond
             ((= icompq 0)
              ...
              (multiple-value-bind
                  ...
                  (dlasdq "U" sqrei nr nrp1 nru ncc
                   (f2cl-lib:array-slice d-%data% double-float (nrf) ((1 *))
                                         d-%offset%)
                   (f2cl-lib:array-slice e-%data% double-float (nrf) ((1 *))
                                         e-%offset%)
                   (f2cl-lib:array-slice work-%data% double-float (nwork1)
                                         ((1 *)) work-%offset%)
                   smlszp
              ...
              (setf itemp
                      (f2cl-lib:int-add nwork1
                                        (f2cl-lib:int-mul
                                         (f2cl-lib:int-sub nrp1 1) smlszp)))
              (dcopy nrp1
               (f2cl-lib:array-slice work-%data% double-float (nwork1) ((1 *))
                                     work-%offset%)
               1
             ...
             (t
              (dlaset "A" nr nr zero one
               (f2cl-lib:array-slice u-%data% double-float (nrf 1)
                                     ((1 ldu) (1 *)) u-%offset%)
               ldu)
              (dlaset "A" nrp1 nrp1 zero one
               (f2cl-lib:array-slice vt-%data% double-float (nrf 1)
                                     ((1 ldu) (1 *)) vt-%offset%)
               ldu)
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (dcopy nrp1
               ...
               1)
              (dcopy nrp1
               (f2cl-lib:array-slice vt-%data% double-float (nrf nrp1)
                                     ((1 ldu) (1 *)) vt-%offset%)
               1
               (f2cl-lib:array-slice work-%data% double-float (vli) ((1 *))
                                     work-%offset%)
        ...
        (f2cl-lib:fdo (lvl nlvl (f2cl-lib:int-add lvl (f2cl-lib:int-sub 1)))
          ...
          (tagbody
            ...
            (cond ((= lvl 1) (setf lf 1) (setf ll 1))
                  (t (setf lf (expt 2 (f2cl-lib:int-sub lvl 1)))
              ...
              (tagbody
                ...
                (setf ic
                        (f2cl-lib:fref iwork-%data%
                                       ((f2cl-lib:int-add inode im1)) ((1 *))
                                       iwork-%offset%))
                (setf nl
                        (f2cl-lib:fref iwork-%data%
                                       ((f2cl-lib:int-add ndiml im1)) ((1 *))
                                       iwork-%offset%))
                (setf nr
                        (f2cl-lib:fref iwork-%data%
                                       ((f2cl-lib:int-add ndimr im1)) ((1 *))
                                       iwork-%offset%))
                (setf nlf (f2cl-lib:int-sub ic nl))
                (setf nrf (f2cl-lib:int-add ic 1))
                (cond ((= i ll) (setf sqrei sqre)) (t (setf sqrei 1)))
                (setf vfi (f2cl-lib:int-sub (f2cl-lib:int-add vf nlf) 1))
                (setf vli (f2cl-lib:int-sub (f2cl-lib:int-add vl nlf) 1))
                 ...
                 ((= icompq 0)
                  (multiple-value-bind
                      ...
                      (dlasd6 icompq nl nr sqrei
                       (f2cl-lib:array-slice d-%data% double-float (nlf)
                                             ((1 *)) d-%offset%)
                       (f2cl-lib:array-slice work-%data% double-float (vfi)
                                             ((1 *)) work-%offset%)
                       (f2cl-lib:array-slice work-%data% double-float (vli)
                                             ((1 *)) work-%offset%)
                       alpha beta
                       (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4
                                             (idxqi) ((1 *)) iwork-%offset%)
                       perm
                       (f2cl-lib:fref givptr-%data% (1) ((1 *))
                                      givptr-%offset%)
                       ...
                       info)
                    (declare
                     (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-9
                      var-10 var-12 var-13 var-14 var-15 var-16 var-17 var-18
                      var-19 var-23 var-24))
                    (setf alpha var-7)
                    (setf beta var-8)
                    (setf (f2cl-lib:fref givptr-%data% (1) ((1 *))
                                         givptr-%offset%)
                            var-11)
                 ...
                 (t (setf j (f2cl-lib:int-sub j 1))
                  (multiple-value-bind
                      ...
                      (dlasd6 icompq nl nr sqrei
                       ...
                       (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4
                                             (idxqi) ((1 *)) iwork-%offset%)
                       (f2cl-lib:array-slice perm-%data% f2cl-lib:integer4
                                             (nlf lvl) ((1 ldgcol) (1 *))
                                             perm-%offset%)
                       (f2cl-lib:fref givptr-%data% (j) ((1 *))
                                      givptr-%offset%)
                       (f2cl-lib:array-slice givcol-%data% f2cl-lib:integer4
                                             (nlf lvl2) ((1 ldgcol) (1 *))
                                             givcol-%offset%)
                       ldgcol
                       (f2cl-lib:array-slice givnum-%data% double-float
                                             (nlf lvl2) ((1 ldu) (1 *))
                                             givnum-%offset%)
                       ldu
                       (f2cl-lib:array-slice poles-%data% double-float
                                             (nlf lvl2) ((1 ldu) (1 *))
                                             poles-%offset%)
                       (f2cl-lib:array-slice difl-%data% double-float (nlf lvl)
                                             ((1 ldu) (1 *)) difl-%offset%)
                       (f2cl-lib:array-slice difr-%data% double-float
                                             (nlf lvl2) ((1 ldu) (1 *))
                                             difr-%offset%)
                       (f2cl-lib:array-slice z-%data% double-float (nlf lvl)
                                             ((1 ldu) (1 *)) z-%offset%)
                    ...
                    (setf alpha var-7)
                    (setf beta var-8)
                    (setf (f2cl-lib:fref givptr-%data% (j) ((1 *))
                                         givptr-%offset%)
                            var-11)
       ...
       end_label
        (return
         (values nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil
                 nil nil nil nil nil nil nil nil info))))))

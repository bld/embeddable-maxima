        ...
        (prog ((vt (make-array 3 :element-type 'f2cl-lib:complex16))
          ...
          (declare (type (array f2cl-lib:complex16 (3)) vt)
                   ...
                   (type (f2cl-lib:integer4) i2 i4 incol j j2 j4 jbot jcol jlen
                    jrow jtop k k1 kdu kms knz krcol kzs m m22 mbot mend mstart
          ...
          (if (<= (f2cl-lib:int-add ktop 2) kbot)
              (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add ktop 2) ktop)
                                   ((1 ldh) (1 *)) h-%offset%)
                      zero))
                       ...
                       ((= k (f2cl-lib:int-add ktop (f2cl-lib:int-sub 1)))
                        (zlaqr1 3
                         ...
                         (f2cl-lib:fref s-%data%
                                        ((f2cl-lib:int-sub
                                          (f2cl-lib:int-mul 2 m) 1))
                                        ((1 *)) s-%offset%)
                         (f2cl-lib:fref s-%data% ((f2cl-lib:int-mul 2 m))
                                        ((1 *)) s-%offset%)
                        ...
                        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                          ...
                          (setf alpha var-1)
                          (setf (f2cl-lib:fref v-%data% (1 m) ((1 ldv) (1 *))
                                               v-%offset%)
                                  var-4)))
                       (t
                        (setf beta
                                (f2cl-lib:fref h-%data%
                                               ...
                                               ((1 ldh) (1 *)) h-%offset%))
                        (setf (f2cl-lib:fref v-%data% (2 m) ((1 ldv) (1 *))
                                             v-%offset%)
                                (f2cl-lib:fref h-%data%
                                               ((f2cl-lib:int-add k 2) k)
                                               ((1 ldh) (1 *)) h-%offset%))
                        (setf (f2cl-lib:fref v-%data% (3 m) ((1 ldv) (1 *))
                                             v-%offset%)
                                (f2cl-lib:fref h-%data%
                        ...
                        (cond
                         ((or
                           (/=
                            (f2cl-lib:fref h ((f2cl-lib:int-add k 3) k)
                                           ((1 ldh) (1 *)))
                            zero)
                           (/=
                            (f2cl-lib:fref h
                         ...
                         (t
                          ...
                          (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                              (zlarfg 3 alpha
                               (f2cl-lib:array-slice vt f2cl-lib:complex16 (2)
                                                     ((1 3)))
                          ...
                          (cond
                           ((>
                             (+
                              (cabs1
                               (+
                                (f2cl-lib:fref h ((f2cl-lib:int-add k 2) k)
                                               ((1 ldh) (1 *)))
                                (* -1 refsum (f2cl-lib:fref vt (2) ((1 3))))))
                              (cabs1
                    ...
                    (cond
                     ((= k (f2cl-lib:int-add ktop (f2cl-lib:int-sub 1)))
                      (zlaqr1 2
                       ...
                       (f2cl-lib:fref s-%data%
                                      ((f2cl-lib:int-sub
                                        (f2cl-lib:int-mul 2 m22) 1))
                                      ((1 *)) s-%offset%)
                       (f2cl-lib:fref s-%data% ((f2cl-lib:int-mul 2 m22))
                                      ((1 *)) s-%offset%)
                       (f2cl-lib:array-slice v-%data% f2cl-lib:complex16
                                             (1 m22) ((1 ldv) (1 *))
                                             v-%offset%))
                      (setf beta
                              (f2cl-lib:fref v-%data% (1 m22) ((1 ldv) (1 *))
                                             v-%offset%))
                      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                          (zlarfg 2 beta
                           (f2cl-lib:array-slice v-%data% f2cl-lib:complex16
                        ...
                        (declare (ignore var-0 var-2 var-3))
                        (setf beta var-1)
                        (setf (f2cl-lib:fref v-%data% (1 m22) ((1 ldv) (1 *))
                                             v-%offset%)
                                var-4)))
                     (t
                      (setf beta
                              (f2cl-lib:fref h-%data%
                                             ((f2cl-lib:int-add k 1) k)
                                             ((1 ldh) (1 *)) h-%offset%))
                      (setf (f2cl-lib:fref v-%data% (2 m22) ((1 ldv) (1 *))
                                           v-%offset%)
                              (f2cl-lib:fref h-%data%
                                             ((f2cl-lib:int-add k 2) k)
                                             ((1 ldh) (1 *)) h-%offset%))
                      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                        ...
                        (setf (f2cl-lib:fref v-%data% (1 m22) ((1 ldv) (1 *))
                                             v-%offset%)
                                var-4))
                      (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add k 1) k)
                                           ((1 ldh) (1 *)) h-%offset%)
                              beta)
                      (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add k 2) k)
                                           ((1 ldh) (1 *)) h-%offset%)
                              zero)))))
                  (cond
                   (accum
                    ...
                    (tagbody
                      ...
                      (setf refsum
                              (*
                               (f2cl-lib:fref v-%data% (1 m) ((1 ldv) (1 *))
                                              v-%offset%)
                               (f2cl-lib:fref v-%data% (3 m) ((1 ldv) (1 *))
                                              v-%offset%)
                               (f2cl-lib:fref h-%data%
                      ...
                      (setf (f2cl-lib:fref h-%data%
                              ...
                              (* (- refsum)
                                 (f2cl-lib:dconjg
                                  (f2cl-lib:fref v-%data% (2 m) ((1 ldv) (1 *))
                                                 v-%offset%))))
                      (setf (f2cl-lib:fref h-%data%
                                           ((f2cl-lib:int-add k 4)
                                            (f2cl-lib:int-add k 3))
                  ...
                  (f2cl-lib:fdo (jcol
                    ...
                    (tagbody
                      ...
                      (zgemm "C" "N" nu jlen nu one
                       (f2cl-lib:array-slice u-%data% f2cl-lib:complex16
                                             (k1 k1) ((1 ldu) (1 *))
                                             u-%offset%)
                       ldu
                       (f2cl-lib:array-slice h-%data% f2cl-lib:complex16
                    ...
                    (f2cl-lib:fdo (jrow iloz (f2cl-lib:int-add jrow nv))
                      ...
                      (tagbody
                        ...
                        (zlacpy "ALL" jlen nu wv ldwv
                         ...
                         ldz)
                       label170)))))
                 (t (setf i2 (the f2cl-lib:integer4 (truncate (+ kdu 1) 2)))
                  (setf i4 kdu) (setf j2 (f2cl-lib:int-sub i4 i2))
                  (setf j4 kdu)
                    ...
                    (tagbody
                      ...
                      (zlacpy "ALL" knz jlen
                       (f2cl-lib:array-slice h-%data% f2cl-lib:complex16
                                             ...
                                             ((1 ldh) (1 *)) h-%offset%)
                       ldh
                       (f2cl-lib:array-slice wh-%data% f2cl-lib:complex16
                                             ((+ kzs 1) 1) ((1 ldwh) (1 *))
                                             wh-%offset%)
                       ldwh)
                    ...
                    (tagbody
                      ...
                      (zlacpy "ALL" jlen knz
                       (f2cl-lib:array-slice h-%data% f2cl-lib:complex16
                                             ...
                                             ((1 ldh) (1 *)) h-%offset%)
                       ldh
                       (f2cl-lib:array-slice wv-%data% f2cl-lib:complex16
                      ...
                      (zlacpy "ALL" jlen j2
                       ...
                       (f2cl-lib:array-slice wv-%data% f2cl-lib:complex16
                                             ...
                                             ((1 ldwv) (1 *)) wv-%offset%)
                       ldwv)
                      (ztrmm "R" "L" "N" "N" jlen (f2cl-lib:int-sub i4 i2) one
                       (f2cl-lib:array-slice u-%data% f2cl-lib:complex16
                                             (1 (f2cl-lib:int-add i2 1))
                                             ((1 ldu) (1 *)) u-%offset%)
                       ldu

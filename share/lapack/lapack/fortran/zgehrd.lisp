      ...
      (prog ((ei #C(0.0 0.0)) (i 0) (ib 0) (iinfo 0) (iws 0) (j 0) (ldwork 0)
        ...
        (cond ((< n 0) (setf info -1))
              ...
              ((and
               ...
               (setf info -8)))
        (cond
         ((/= info 0) (xerbla "ZGEHRD" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
               ...
               (f2cl-lib:fdo (i ilo (f2cl-lib:int-add i nb))
                 ...
                 (tagbody
                   ...
                   (multiple-value-bind
                       ...
                       (zlahr2 ihi i ib
                        ...
                        (f2cl-lib:array-slice tau-%data% f2cl-lib:complex16 (i)
                                              ((1 *)) tau-%offset%)
                        t$ ldt work ldwork)
                     (declare (ignore var-0 var-3 var-5 var-6 var-7 var-8))
                     (setf i var-1)
                     (setf ib var-2)
                     (setf lda var-4)
                     (setf ldwork var-9))
                   ...
                   (multiple-value-bind
                       ...
                       (zlarfb "Left" "Conjugate transpose" "Forward"
                        "Columnwise" (f2cl-lib:int-sub ihi i)
                        ...
                        lda work ldwork)
                     (declare
                      (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-7 var-9
                       var-11 var-13))
        ...
        (go end_label)
       end_label
        (return (values nil nil ihi nil lda nil nil nil info))))))
  ...
  (setf (gethash 'fortran-to-lisp::zgehrd
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '((fortran-to-lisp::integer4)
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(nil nil fortran-to-lisp::ihi nil

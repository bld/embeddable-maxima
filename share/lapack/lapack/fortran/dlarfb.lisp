           ...
           ((lsame direct "F")
            (cond
             ((lsame side "L")
              ...
              (cond
               ((> m k)
                (dgemm "Transpose" "No transpose" n k (f2cl-lib:int-sub m k)
                 one
              ...
              (cond
               ((> m k)
                (dgemm "No transpose" "Transpose" (f2cl-lib:int-sub m k) n k
                 (- one)
                 (f2cl-lib:array-slice v-%data% double-float ((+ k 1) 1)
                                       ((1 ldv) (1 *)) v-%offset%)
                 ldv work ldwork one
             ...
             ((lsame side "R")
              ...
              (cond
               ((> n k)
                (dgemm "No transpose" "No transpose" m k (f2cl-lib:int-sub n k)
                 one
              ...
              (cond
               ((> n k)
                (dgemm "No transpose" "Transpose" m (f2cl-lib:int-sub n k) k
                 (- one) work ldwork
                 (f2cl-lib:array-slice v-%data% double-float ((+ k 1) 1)
                                       ((1 ldv) (1 *)) v-%offset%)
                 ldv one
           ...
           ((lsame direct "F")
            (cond
             ((lsame side "L")
              ...
              (cond
               ((> m k)
                (dgemm "Transpose" "Transpose" n k (f2cl-lib:int-sub m k) one
                 (f2cl-lib:array-slice c-%data% double-float ((+ k 1) 1)
                                       ((1 ldc) (1 *)) c-%offset%)
                 ldc
                 (f2cl-lib:array-slice v-%data% double-float
             ...
             ((lsame side "R")
              ...
              (cond
               ((> n k)
                (dgemm "No transpose" "Transpose" m k (f2cl-lib:int-sub n k)
                 one
                 (f2cl-lib:array-slice c-%data% double-float
                                       (1 (f2cl-lib:int-add k 1))
                                       ((1 ldc) (1 *)) c-%offset%)
              ...
              (cond
               ((> n k)
                (dgemm "No transpose" "No transpose" m (f2cl-lib:int-sub n k) k
                 (- one) work ldwork
                 (f2cl-lib:array-slice v-%data% double-float
                                       (1 (f2cl-lib:int-add k 1))
                                       ((1 ldv) (1 *)) v-%offset%)
           ...
           (t
            (cond
             ((lsame side "L")
              ...
              (cond
               ((> m k)
                (dgemm "Transpose" "Transpose" n k (f2cl-lib:int-sub m k) one c

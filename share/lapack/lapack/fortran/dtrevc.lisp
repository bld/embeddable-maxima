    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((x (make-array 4 :element-type 'double-float)) (beta 0.0)
        ...
        (cond ((and (not rightv) (not leftv)) (setf info -1))
              ...
              (t
               (cond
                (somev (setf m 0) (setf pair f2cl-lib:%false%)
                 (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                               ((> j n) nil)
                   (tagbody
                     (cond
                      (pair (setf pair f2cl-lib:%false%)
                       (setf (f2cl-lib:fref select-%data% (j) ((1 *))
                                            select-%offset%)
                               f2cl-lib:%false%))
                      (t
                       (cond
                        ((< j n)
                         (cond
                          ((=
                            (f2cl-lib:fref t$ ((f2cl-lib:int-add j 1) j)
                                           ((1 ldt) (1 *)))
                            zero)
                           (if (f2cl-lib:fref select-%data% (j) ((1 *))
                                              select-%offset%)
                               (setf m (f2cl-lib:int-add m 1))))
                          (t (setf pair f2cl-lib:%true%)
                           (cond
                            ((or (f2cl-lib:fref select (j) ((1 *)))
                                 (f2cl-lib:fref select ((f2cl-lib:int-add j 1))
                                                ((1 *))))
                             (setf (f2cl-lib:fref select-%data% (j) ((1 *))
                                                  select-%offset%)
                                     f2cl-lib:%true%)
                        ...
                        (t
                         (if (f2cl-lib:fref select-%data% (n) ((1 *))
                                            select-%offset%)
                             (setf m (f2cl-lib:int-add m 1)))))))
                    label10)))
                (t (setf m n)))
               (cond ((< mm m) (setf info -11)))))
        (cond
         ((/= info 0) (xerbla "DTREVC" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= n 0)
            (go end_label))
              ...
              (tagbody
                (setf (f2cl-lib:fref work-%data% (j) ((1 *)) work-%offset%)
                        (+
                         ...
                         (abs
                          (f2cl-lib:fref t$-%data% (i j) ((1 ldt) (1 *))
                                         t$-%offset%))))
               label20))
           label30))
        (setf n2 (f2cl-lib:int-mul 2 n))
        (cond
         (rightv (setf ip 0) (setf is m)
          (f2cl-lib:fdo (ki n (f2cl-lib:int-add ki (f2cl-lib:int-sub 1)))
            ...
            (tagbody
              ...
              (if (= ki 1)
                  (go label40))
              (if (=
                   (f2cl-lib:fref t$-%data% (ki (f2cl-lib:int-sub ki 1))
                                  ((1 ldt) (1 *)) t$-%offset%)
                   zero)
                  (go label40))
              (setf ip -1)
             label40
              (cond
               (somev
                (cond
                 ((= ip 0)
                  (if (not
                       (f2cl-lib:fref select-%data% (ki) ((1 *))
                                      select-%offset%))
                      (go label130)))
                 (t
                  (if (not
                       (f2cl-lib:fref select-%data% ((f2cl-lib:int-sub ki 1))
                                      ((1 *)) select-%offset%))
                      (go label130))))))
              (setf wr
                      (f2cl-lib:fref t$-%data% (ki ki) ((1 ldt) (1 *))
                                     t$-%offset%))
              (setf wi zero)
              (if (/= ip 0)
                  (setf wi
              ...
              (cond
               ((= ip 0)
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                                     ((1 *)) work-%offset%)
                        one)
                (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                              ((> k (f2cl-lib:int-add ki (f2cl-lib:int-sub 1)))
                               nil)
                  (tagbody
                    (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add k n))
                                         ((1 *)) work-%offset%)
                            (-
                             (f2cl-lib:fref t$-%data% (k ki) ((1 ldt) (1 *))
                                            t$-%offset%)))
                   label50))
                     ...
                     ((= j1 j2)
                      (multiple-value-bind
                          ...
                          (dlaln2 f2cl-lib:%false% 1 1 smin one
                           (f2cl-lib:array-slice t$-%data% double-float (j j)
                                                 ((1 ldt) (1 *)) t$-%offset%)
                           ldt one one
                      ...
                      (if (/= scale one)
                          (dscal ki scale
                           (f2cl-lib:array-slice work-%data% double-float
                                                 ...
                                                 work-%offset%)
                           1))
                      (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add j n))
                                           ((1 *)) work-%offset%)
                              (f2cl-lib:fref x (1 1) ((1 2) (1 2))))
                      (daxpy (f2cl-lib:int-sub j 1)
                       (- (f2cl-lib:fref x (1 1) ((1 2) (1 2))))
                       (f2cl-lib:array-slice t$-%data% double-float (1 j)
                                             ((1 ldt) (1 *)) t$-%offset%)
                       1
                       (f2cl-lib:array-slice work-%data% double-float ((+ 1 n))
                                             ((1 *)) work-%offset%)
                       1))
                     (t
                      (multiple-value-bind
                 ...
                 ((not over)
                  (dcopy ki
                   (f2cl-lib:array-slice work-%data% double-float ((+ 1 n))
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vr-%data% double-float (1 is)
                                         ((1 ldvr) (1 *)) vr-%offset%)
                   1)
                  (setf ii
                          (idamax ki
                  ...
                  (setf remax
                          (/ one
                             (abs
                              (f2cl-lib:fref vr-%data% (ii is) ((1 ldvr) (1 *))
                                             vr-%offset%))))
                  (dscal ki remax
                   (f2cl-lib:array-slice vr-%data% double-float (1 is)
                                         ((1 ldvr) (1 *)) vr-%offset%)
                  ...
                  (f2cl-lib:fdo (k (f2cl-lib:int-add ki 1)
                                ...
                                ((> k n) nil)
                    (tagbody
                      (setf (f2cl-lib:fref vr-%data% (k is) ((1 ldvr) (1 *))
                                           vr-%offset%)
                              zero)
                     label70)))
                 (t
                  (if (> ki 1)
                      (dgemv "N" n (f2cl-lib:int-sub ki 1) one vr ldvr
                       (f2cl-lib:array-slice work-%data% double-float ((+ 1 n))
                                             ((1 *)) work-%offset%)
                       1
                       (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                                      ((1 *)) work-%offset%)
                       (f2cl-lib:array-slice vr-%data% double-float (1 ki)
                                             ((1 ldvr) (1 *)) vr-%offset%)
                       1))
                  (setf ii
                          (idamax n
                  ...
                  (setf remax
                          (/ one
                             (abs
                              (f2cl-lib:fref vr-%data% (ii ki) ((1 ldvr) (1 *))
                                             vr-%offset%))))
                  (dscal n remax
                   (f2cl-lib:array-slice vr-%data% double-float (1 ki)
                                         ((1 ldvr) (1 *)) vr-%offset%)
               ...
               (t
                (cond
                 ((>=
                  ...
                  (setf (f2cl-lib:fref work-%data%
                                       ((f2cl-lib:int-add
                                         (f2cl-lib:int-sub ki 1) n))
                                       ((1 *)) work-%offset%)
                          one)
                  (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n2))
                                       ((1 *)) work-%offset%)
                          (/ wi
                             (f2cl-lib:fref t$-%data%
                                            ((f2cl-lib:int-sub ki 1) ki)
                ...
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                        ...
                        zero)
                (setf (f2cl-lib:fref work-%data%
                                     ((f2cl-lib:int-add (f2cl-lib:int-sub ki 1)
                                                        n2))
                                     ((1 *)) work-%offset%)
                        zero)
                (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                              ((> k (f2cl-lib:int-add ki (f2cl-lib:int-sub 2)))
                               nil)
                  (tagbody
                    (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add k n))
                                         ((1 *)) work-%offset%)
                            (*
                             ...
                             (f2cl-lib:fref t$-%data%
                                            ...
                                            ((1 ldt) (1 *)) t$-%offset%)))
                    (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add k n2))
                                         ((1 *)) work-%offset%)
                            (*
                             (-
                              (f2cl-lib:fref work-%data%
                                             ((f2cl-lib:int-add ki n2)) ((1 *))
                                             work-%offset%))
                             (f2cl-lib:fref t$-%data% (k ki) ((1 ldt) (1 *))
                                            t$-%offset%)))
                   label80))
                 ...
                 ((not over)
                  (dcopy ki
                   (f2cl-lib:array-slice work-%data% double-float ((+ 1 n))
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vr-%data% double-float
                                         (1 (f2cl-lib:int-sub is 1))
                                         ((1 ldvr) (1 *)) vr-%offset%)
                   1)
                  (dcopy ki
                   (f2cl-lib:array-slice work-%data% double-float ((+ 1 n2))
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vr-%data% double-float (1 is)
                                         ((1 ldvr) (1 *)) vr-%offset%)
                   ...
                   ((> ki 2)
                    ...
                    (dgemv "N" n (f2cl-lib:int-sub ki 2) one vr ldvr
                     (f2cl-lib:array-slice work-%data% double-float ((+ 1 n2))
                                           ((1 *)) work-%offset%)
                     1
                     (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n2))
                                    ((1 *)) work-%offset%)
                     (f2cl-lib:array-slice vr-%data% double-float (1 ki)
                                           ((1 ldvr) (1 *)) vr-%offset%)
                     1))
          ...
          (f2cl-lib:fdo (ki 1 (f2cl-lib:int-add ki 1))
            ...
            (tagbody
              ...
              (if (= ki n)
                  (go label150))
              (if (=
                   (f2cl-lib:fref t$-%data% ((f2cl-lib:int-add ki 1) ki)
                                  ((1 ldt) (1 *)) t$-%offset%)
                   zero)
                  (go label150))
              (setf ip 1)
              ...
              (cond
               ((= ip 0)
                (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                                     ((1 *)) work-%offset%)
                        one)
                (f2cl-lib:fdo (k (f2cl-lib:int-add ki 1) (f2cl-lib:int-add k 1))
                              ((> k n) nil)
                  (tagbody
                    (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add k n))
                                         ((1 *)) work-%offset%)
                            (-
                             (f2cl-lib:fref t$-%data% (ki k) ((1 ldt) (1 *))
                                            t$-%offset%)))
                   label160))
                (setf vmax one) (setf vcrit bignum)
                (setf jnxt (f2cl-lib:int-add ki 1))
                (f2cl-lib:fdo (j (f2cl-lib:int-add ki 1) (f2cl-lib:int-add j 1))
                              ((> j n) nil)
                  (tagbody
                    (if (< j jnxt)
                        (go label170))
                     ...
                     ((= j1 j2)
                      (cond
                       ((> (f2cl-lib:fref work (j) ((1 *))) vcrit)
                        (setf rec (/ one vmax))
                        (dscal (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1) rec
                         (f2cl-lib:array-slice work-%data% double-float
                                               ((+ ki n)) ((1 *))
                                               work-%offset%)
                         1)
                      ...
                      (setf beta
                              (max
                               (f2cl-lib:fref work-%data% (j) ((1 *))
                                              work-%offset%)
                               (f2cl-lib:fref work-%data%
                                              ((f2cl-lib:int-add j 1)) ((1 *))
                                              work-%offset%)))
                      (cond
                       ((> beta vcrit) (setf rec (/ one vmax))
                        (dscal (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1) rec
                         (f2cl-lib:array-slice work-%data% double-float
                                               ((+ ki n)) ((1 *))
                                               work-%offset%)
                ...
                (cond
                 ((not over)
                  (dcopy (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1)
                   (f2cl-lib:array-slice work-%data% double-float ((+ ki n))
                                         ((1 *)) work-%offset%)
                   1
                   (f2cl-lib:array-slice vl-%data% double-float (ki is)
                                         ((1 ldvl) (1 *)) vl-%offset%)
                   1)
                  (setf ii
                          (f2cl-lib:int-sub
                           (f2cl-lib:int-add
                            (idamax
                             ...
                             (f2cl-lib:array-slice vl-%data% double-float
                                                   (ki is) ((1 ldvl) (1 *))
                                                   vl-%offset%)
                             1)
                            ki)
                  ...
                  (setf remax
                          (/ one
                             (abs
                              (f2cl-lib:fref vl-%data% (ii is) ((1 ldvl) (1 *))
                                             vl-%offset%))))
                  ...
                  (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                                ((> k
                                 ...
                                 nil)
                    (tagbody
                      (setf (f2cl-lib:fref vl-%data% (k is) ((1 ldvl) (1 *))
                                           vl-%offset%)
                              zero)
                     label180)))
                 (t
                  (if (< ki n)
                      (dgemv "N" n (f2cl-lib:int-sub n ki) one
                       ...
                       (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                                      ((1 *)) work-%offset%)
                       (f2cl-lib:array-slice vl-%data% double-float (1 ki)
                                             ((1 ldvl) (1 *)) vl-%offset%)
                       1))
                  (setf ii
                          (idamax n
                  ...
                  (setf remax
                          (/ one
                             (abs
                              (f2cl-lib:fref vl-%data% (ii ki) ((1 ldvl) (1 *))
                                             vl-%offset%))))
                  (dscal n remax
                   (f2cl-lib:array-slice vl-%data% double-float (1 ki)
                                         ((1 ldvl) (1 *)) vl-%offset%)
               ...
               (t
                (tagbody
                  (cond
                   ((>=
                     (abs
                      (f2cl-lib:fref t$ (ki (f2cl-lib:int-add ki 1))
                                     ((1 ldt) (1 *))))
                     (abs
                      (f2cl-lib:fref t$ ((f2cl-lib:int-add ki 1) ki)
                                     ((1 ldt) (1 *)))))
                    (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n))
                                         ((1 *)) work-%offset%)
                            (/ wi
                    ...
                    (setf (f2cl-lib:fref work-%data%
                            ...
                            (/ (- wi)
                               (f2cl-lib:fref t$-%data%
                                              ((f2cl-lib:int-add ki 1) ki)
                                              ((1 ldt) (1 *)) t$-%offset%)))))
                  (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki 1 n))
                                       ((1 *)) work-%offset%)
                          zero)
                  (setf (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki n2))
                                       ((1 *)) work-%offset%)
                  ...
                  (cond
                   ((not over)
                    (dcopy (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1)
                     ...
                     1)
                    (dcopy (f2cl-lib:int-add (f2cl-lib:int-sub n ki) 1)
                     (f2cl-lib:array-slice work-%data% double-float ((+ ki n2))
                                           ((1 *)) work-%offset%)
                     1
                     (f2cl-lib:array-slice vl-%data% double-float
                      ...
                      (tagbody
                        (setf emax
                                (max emax
                                     (+
                                      (abs
                                       (f2cl-lib:fref vl-%data% (k is)
                                                      ((1 ldvl) (1 *))
                                                      vl-%offset%))
                                      (abs
                                       (f2cl-lib:fref vl-%data%
                                                      (k
                                                       (f2cl-lib:int-add is 1))
                                                      ((1 ldvl) (1 *))
                                                      vl-%offset%)))))
                       label220))
                    (setf remax (/ one emax))
                     ...
                     ((< ki (f2cl-lib:int-add n (f2cl-lib:int-sub 1)))
                      ...
                      (dgemv "N" n (f2cl-lib:int-sub n ki 1) one
                       ...
                       (f2cl-lib:array-slice work-%data% double-float
                                             ...
                                             work-%offset%)
                       1
                       (f2cl-lib:fref work-%data% ((f2cl-lib:int-add ki 1 n2))
                                      ((1 *)) work-%offset%)
                       (f2cl-lib:array-slice vl-%data% double-float
                                             (1 (f2cl-lib:int-add ki 1))
                                             ((1 ldvl) (1 *)) vl-%offset%)

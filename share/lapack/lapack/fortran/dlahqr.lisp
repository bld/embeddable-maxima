      ...
      (prog ((v (make-array 3 :element-type 'double-float))
        ...
        (declare (type (array double-float (3)) v)
                 ...
                 (type (double-float) ave cs disc h00 h10 h11 h12 h21 h22 h33
                  h33s h43h34 h44 h44s ovfl s smlnum sn sum t1 t2 t3 tst1 ulp
                  unfl v1 v2 v3)
        ...
        (cond
         ((= ilo ihi)
          (setf (f2cl-lib:fref wr-%data% (ilo) ((1 *)) wr-%offset%)
                  (f2cl-lib:fref h-%data% (ilo ilo) ((1 ldh) (1 *))
                                 h-%offset%))
        ...
        (cond (wantt (setf i1 1) (setf i2 n)))
        ...
        (f2cl-lib:fdo (its 0 (f2cl-lib:int-add its 1))
          ...
          (tagbody
                ...
                (if (= tst1 zero)
                    (setf tst1
                            (dlanhs "1"
                             ...
                             (f2cl-lib:array-slice h-%data% double-float (l l)
                                                   ((1 ldh) (1 *)) h-%offset%)
                             ldh work)))
                (if (<=
                     (abs
           ...
           label30
            ...
            (cond
             ((> l ilo)
              (setf (f2cl-lib:fref h-%data% (l (f2cl-lib:int-sub l 1))
                                   ((1 ldh) (1 *)) h-%offset%)
                      zero)))
            (if (>= l (f2cl-lib:int-sub i 1))
                (go label140))
            ...
            (cond
             ((or (= its 10) (= its 20))
              ...
              (setf h44
                      (+ (* dat1 s)
                         (f2cl-lib:fref h-%data% (i i) ((1 ldh) (1 *))
                                        h-%offset%)))
              (setf h33 h44) (setf h43h34 (* dat2 s s)))
             (t
              (setf h44
                      (f2cl-lib:fref h-%data% (i i) ((1 ldh) (1 *))
                                     h-%offset%))
              ...
              (setf h43h34
                      (*
                       (f2cl-lib:fref h-%data% (i (f2cl-lib:int-sub i 1))
                                      ((1 ldh) (1 *)) h-%offset%)
                       (f2cl-lib:fref h-%data% ((f2cl-lib:int-sub i 1) i)
                                      ((1 ldh) (1 *)) h-%offset%)))
              (setf s
                      (*
                       (f2cl-lib:fref h-%data%
              ...
              (cond
               ((> disc zero) (setf disc (f2cl-lib:fsqrt disc))
                (setf ave (* half (+ h33 h44)))
                (cond
                 ((> (+ (abs h33) (- (abs h44))) zero)
                  (setf h33 (- (* h33 h44) h43h34))
                  (setf h44 (/ h33 (+ (f2cl-lib:sign disc ave) ave))))
                 (t (setf h44 (+ (f2cl-lib:sign disc ave) ave))))
                (setf h33 h44) (setf h43h34 zero)))))
              ...
              (tagbody
                ...
                (setf h22
                        (f2cl-lib:fref h-%data%
                                       ...
                                       ((1 ldh) (1 *)) h-%offset%))
                (setf h21
                        (f2cl-lib:fref h-%data% ((f2cl-lib:int-add m 1) m)
                                       ((1 ldh) (1 *)) h-%offset%))
                (setf h12
                        (f2cl-lib:fref h-%data% (m (f2cl-lib:int-add m 1))
                                       ((1 ldh) (1 *)) h-%offset%))
                (setf h44s (- h44 h11))
                (setf h33s (- h33 h11))
                ...
                (setf h00
                        (f2cl-lib:fref h-%data%
                                       ...
                                       ((1 ldh) (1 *)) h-%offset%))
                (setf h10
                        (f2cl-lib:fref h-%data% (m (f2cl-lib:int-sub m 1))
                                       ((1 ldh) (1 *)) h-%offset%))
           ...
           label50
            (f2cl-lib:fdo (k m (f2cl-lib:int-add k 1))
              ...
              (tagbody
                ...
                (if (> k m)
                    (dcopy nr
                     (f2cl-lib:array-slice h-%data% double-float
                ...
                (cond
                 ((> k m)
                  (setf (f2cl-lib:fref h-%data% (k (f2cl-lib:int-sub k 1))
                                       ((1 ldh) (1 *)) h-%offset%)
                ...
                (setf t2 (* t1 v2))
                (cond
                 ((= nr 3) (setf v3 (f2cl-lib:fref v (3) ((1 3))))
                  (setf t3 (* t1 v3))
                  (f2cl-lib:fdo (j k (f2cl-lib:int-add j 1))
                    ...
                    (tagbody
                      (setf sum
                              (+
                               (f2cl-lib:fref h-%data% (k j) ((1 ldh) (1 *))
                                              h-%offset%)
                               (* v2
                                  (f2cl-lib:fref h-%data%
                               ...
                               (* v3
                                  (f2cl-lib:fref h-%data%
                                                 ...
                                                 ((1 ldh) (1 *)) h-%offset%))))
                      (setf (f2cl-lib:fref h-%data% (k j) ((1 ldh) (1 *))
                                           h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data% (k j) ((1 ldh) (1 *))
                                              h-%offset%)
                               (* sum t1)))
                      (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add k 1) j)
                                           ((1 ldh) (1 *)) h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data%
                                              ((f2cl-lib:int-add k 1) j)
                                              ((1 ldh) (1 *)) h-%offset%)
                               (* sum t2)))
                      (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-add k 2) j)
                                           ((1 ldh) (1 *)) h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data%
                                              ((f2cl-lib:int-add k 2) j)
                  ...
                  (f2cl-lib:fdo (j i1 (f2cl-lib:int-add j 1))
                    ...
                    (tagbody
                      (setf sum
                              (+
                               (f2cl-lib:fref h-%data% (j k) ((1 ldh) (1 *))
                                              h-%offset%)
                               (* v2
                                  (f2cl-lib:fref h-%data%
                               ...
                               (* v3
                                  (f2cl-lib:fref h-%data%
                                                 ...
                                                 ((1 ldh) (1 *)) h-%offset%))))
                      (setf (f2cl-lib:fref h-%data% (j k) ((1 ldh) (1 *))
                                           h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data% (j k) ((1 ldh) (1 *))
                                              h-%offset%)
                               (* sum t1)))
                      (setf (f2cl-lib:fref h-%data% (j (f2cl-lib:int-add k 1))
                                           ((1 ldh) (1 *)) h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data%
                                              (j (f2cl-lib:int-add k 1))
                                              ((1 ldh) (1 *)) h-%offset%)
                               (* sum t2)))
                      (setf (f2cl-lib:fref h-%data% (j (f2cl-lib:int-add k 2))
                                           ((1 ldh) (1 *)) h-%offset%)
                              (-
                               (f2cl-lib:fref h-%data%
                                              (j (f2cl-lib:int-add k 2))
                   ...
                   (wantz
                    (f2cl-lib:fdo (j iloz (f2cl-lib:int-add j 1))
                      ...
                      (tagbody
                        (setf sum
                                (+
                                 (f2cl-lib:fref z-%data% (j k) ((1 ldz) (1 *))
                                                z-%offset%)
                                 (* v2
                                 ...
                                 (* v3
                                    (f2cl-lib:fref z-%data%
                                                   ...
                                                   ((1 ldz) (1 *))
                                                   z-%offset%))))
                        (setf (f2cl-lib:fref z-%data% (j k) ((1 ldz) (1 *))
                                             z-%offset%)
                                (-
                                 (f2cl-lib:fref z-%data% (j k) ((1 ldz) (1 *))
                                                z-%offset%)
          ...
          (multiple-value-bind
              ...
              (dlanv2
               ...
               (f2cl-lib:fref h-%data% (i (f2cl-lib:int-sub i 1))
                              ((1 ldh) (1 *)) h-%offset%)
               (f2cl-lib:fref h-%data% (i i) ((1 ldh) (1 *)) h-%offset%)
               (f2cl-lib:fref wr-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                              wr-%offset%)
               (f2cl-lib:fref wi-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                              wi-%offset%)
            ...
            (setf (f2cl-lib:fref h-%data%
                                 ...
                                 ((1 ldh) (1 *)) h-%offset%)
                    var-0)
            (setf (f2cl-lib:fref h-%data% ((f2cl-lib:int-sub i 1) i)
                                 ((1 ldh) (1 *)) h-%offset%)
                    var-1)
            (setf (f2cl-lib:fref h-%data% (i (f2cl-lib:int-sub i 1))
                                 ((1 ldh) (1 *)) h-%offset%)
                    var-2)
            (setf (f2cl-lib:fref h-%data% (i i) ((1 ldh) (1 *)) h-%offset%)
                    var-3)
            (setf (f2cl-lib:fref wr-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                                 wr-%offset%)
                    var-4)
            (setf (f2cl-lib:fref wi-%data% ((f2cl-lib:int-sub i 1)) ((1 *))
                                 wi-%offset%)
                    var-5)
          ...
          (cond
           (wantt
            ...
            (drot (f2cl-lib:int-sub i i1 1)
             (f2cl-lib:array-slice h-%data% double-float
                                   (i1 (f2cl-lib:int-sub i 1)) ((1 ldh) (1 *))
                                   h-%offset%)
             1
             (f2cl-lib:array-slice h-%data% double-float (i1 i) ((1 ldh) (1 *))
                                   h-%offset%)
             1 cs sn)))
          (cond
           (wantz
            (drot nz
             (f2cl-lib:array-slice z-%data% double-float
                                   (iloz (f2cl-lib:int-sub i 1))
                                   ((1 ldz) (1 *)) z-%offset%)
             1
             (f2cl-lib:array-slice z-%data% double-float (iloz i)
                                   ((1 ldz) (1 *)) z-%offset%)
             1 cs sn)))))

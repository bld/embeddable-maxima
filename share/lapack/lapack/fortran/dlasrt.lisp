...
(let* ((select 20))
  (declare (type (f2cl-lib:integer4 20 20) select)
           (ignorable select))
  (defun dlasrt (id n d info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((stack (make-array 64 :element-type 'f2cl-lib:integer4)) (d1 0.0)
        ...
        (setf info 0)
        (setf dir -1)
        (cond ((lsame id "D") (setf dir 0)) ((lsame id "I") (setf dir 1)))
        (cond ((= dir (f2cl-lib:int-sub 1)) (setf info -1))
              ((< n 0) (setf info -2)))
        (cond
         ((/= info 0) (xerbla "DLASRT" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (<= n 1)
            (go end_label))
        (setf stkpnt 1)
       ...
       label10
        ...
        (cond
         ((and (<= (f2cl-lib:int-add endd (f2cl-lib:int-sub start)) select)
          ...
          (cond
           ((= dir 0)
            (f2cl-lib:fdo (i (f2cl-lib:int-add start 1) (f2cl-lib:int-add i 1))
                          ((> i endd) nil)
              (tagbody
                    ...
                    (cond
                     ((> (f2cl-lib:fref d (j) ((1 *)))
                      ...
                      (setf (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                              (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub j 1))
                                             ((1 *)) d-%offset%))
                      (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-sub j 1))
                                           ((1 *)) d-%offset%)
                              dmnmx))
                     (t (go label30)))
                   label20))
         ...
         ((> (f2cl-lib:int-add endd (f2cl-lib:int-sub start)) select)
          ...
          (cond
           ((< d1 d2)
            (cond ((< d3 d1) (setf dmnmx d1)) ((< d3 d2) (setf dmnmx d3))
                  (t (setf dmnmx d2))))
           (t
            (cond ((< d3 d2) (setf dmnmx d2)) ((< d3 d1) (setf dmnmx d3))
                  (t (setf dmnmx d1)))))
          (cond
           ((= dir 0)
            (tagbody
             ...
             label80
              ...
              (cond
               ((> (f2cl-lib:int-add j (f2cl-lib:int-sub start))
                   (f2cl-lib:int-add endd (f2cl-lib:int-sub j)
                                     (f2cl-lib:int-sub 1)))
               ...
               (t (setf stkpnt (f2cl-lib:int-add stkpnt 1))
                (setf (f2cl-lib:fref stack (1 stkpnt) ((1 2) (1 32)))
                        (f2cl-lib:int-add j 1))
                (setf (f2cl-lib:fref stack (2 stkpnt) ((1 2) (1 32))) endd)
                (setf stkpnt (f2cl-lib:int-add stkpnt 1))

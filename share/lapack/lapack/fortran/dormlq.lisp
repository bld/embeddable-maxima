    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (i1 0) (i2 0) (i3 0) (ib 0) (ic 0) (iinfo 0) (iws 0) (jc 0)
        ...
        (cond ((and (not left) (not (lsame side "R"))) (setf info -1))
              ...
              ((< lda
                  (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 k)))
               (setf info -7))
              ((< ldc
        ...
        (cond
         ((/= info 0) (xerbla "DORMLQ" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (cond
         ((or (= m 0) (= n 0) (= k 0))
          (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%)
           ...
           ((< lwork iws)
            ...
            (setf nbmin
                    (max (the f2cl-lib:integer4 2)
                         (the f2cl-lib:integer4
                              (ilaenv 2 "DORMLQ" (f2cl-lib:f2cl-// side trans)
                               m n k -1)))))))
         (t (setf iws nw)))
        (cond
         ((or (< nb nbmin) (>= nb k))
         ...
         (t
          (cond
           ((or (and left notran) (and (not left) (not notran))) (setf i1 1)

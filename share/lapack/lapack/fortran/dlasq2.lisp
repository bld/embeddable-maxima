  ...
  (defun dlasq2 (n z info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((d 0.0) (desig 0.0) (dmin 0.0) (e 0.0) (emax 0.0) (emin 0.0)
             ...
             (splt 0) (ieee nil))
        (declare
         (type (double-float) d desig dmin e emax emin eps oldemn qmax qmin s
          safmin sigma t$ temp tol tol2 trace$ zmax)
         (type (f2cl-lib:integer4) i0 i4 iinfo ipn4 iter iwhila iwhilb k n0
          nbig ndiv nfail pp splt)
        ...
        (cond ((< n 0) (setf info -1) (xerbla "DLASQ2" 1) (go end_label))
              ((= n 0) (go end_label))
              ((= n 1)
               (cond
                ((< (f2cl-lib:fref z (1) ((1 *))) zero) (setf info -201)
                 (xerbla "DLASQ2" 2)))
               (go end_label))
              ((= n 2)
               (cond
                ((or (< (f2cl-lib:fref z (2) ((1 *))) zero)
                 ...
                 (setf info -2) (xerbla "DLASQ2" 2) (go end_label))
                ((> (f2cl-lib:fref z (3) ((1 *)))
                    (f2cl-lib:fref z (1) ((1 *))))
               ...
               (setf (f2cl-lib:fref z-%data% (6) ((1 *)) z-%offset%)
                       (+ (f2cl-lib:fref z-%data% (2) ((1 *)) z-%offset%)
                          (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%)))
               (go end_label)))
        (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-mul 2 n)) ((1 *))
                             z-%offset%)
                zero)
        ...
        (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 2))
          ...
          (tagbody
            ...
            (setf e
                    (+ e
                       (f2cl-lib:fref z-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                                      z-%offset%)))
            (setf qmax
                    (max qmax (f2cl-lib:fref z-%data% (k) ((1 *)) z-%offset%)))
            (setf emin
                    (min emin
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-add k 1))
                                        ((1 *)) z-%offset%)))
            (setf zmax
                    (max qmax zmax
                         (f2cl-lib:fref z-%data% ((f2cl-lib:int-add k 1))
        ...
        (cond
         ((<
          ...
          (setf info
                  (f2cl-lib:int-sub
                   (f2cl-lib:int-sub
                    (f2cl-lib:int-add 200 (f2cl-lib:int-mul 2 n)) 1)))
          (xerbla "DLASQ2" 2) (go end_label)))
        (setf d
                (+ d
        ...
        (f2cl-lib:fdo (k (f2cl-lib:int-mul 2 n)
                      ...
                      ((> k 2) nil)
          (tagbody
            (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-mul 2 k)) ((1 *))
                                 z-%offset%)
                    zero)
            (setf (f2cl-lib:fref z-%data%
            ...
            (setf (f2cl-lib:fref z-%data%
                                 ...
                                 ((1 *)) z-%offset%)
                    (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub k 1)) ((1 *))
                                   z-%offset%))
           label30))
        (setf i0 1)
        (setf n0 n)
        (cond
         ((<
          ...
          (f2cl-lib:fdo (i4 (f2cl-lib:int-mul 4 i0) (f2cl-lib:int-add i4 4))
            ...
            (tagbody
              (setf temp
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 3)) ((1 *))
                                     z-%offset%))
              (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 3)) ((1 *))
                                   z-%offset%)
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub ipn4 i4 3))
                                     ((1 *)) z-%offset%))
              (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub ipn4 i4 3))
                                   ((1 *)) z-%offset%)
                      temp)
              (setf temp
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 1)) ((1 *))
                                     z-%offset%))
              (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 1)) ((1 *))
                                   z-%offset%)
                      (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub ipn4 i4 5))
                                     ((1 *)) z-%offset%))
              (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub ipn4 i4 5))
                                   ((1 *)) z-%offset%)
                      temp)
             label40))))
        (setf pp 0)
                ...
                (cond
                 ((<=
                   (f2cl-lib:fref z
                                  ...
                                  ((1 *)))
                   (* tol2 d))
                  (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 1))
                                       ((1 *)) z-%offset%)
                          (- zero))
                  (setf d
                          (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 3))
                                         ((1 *)) z-%offset%)))
                 (t
                  (setf d
                          (*
            ...
            (f2cl-lib:fdo (i4 (f2cl-lib:int-add (f2cl-lib:int-mul 4 i0) pp)
              ...
              (tagbody
                (setf (f2cl-lib:fref z-%data%
                                     ((f2cl-lib:int-sub
                                       (f2cl-lib:int-add i4
                                                         (f2cl-lib:int-mul -1 2
                                                                           pp))
                                       2))
                                     ((1 *)) z-%offset%)
                        (+ d
                           (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 1))
                                          ((1 *)) z-%offset%)))
                (cond
                 ((<=
                   (f2cl-lib:fref z
                  ...
                  (setf (f2cl-lib:fref z-%data%
                          ...
                          zero)
                  (setf d
                          (f2cl-lib:fref z-%data% ((f2cl-lib:int-add i4 1))
                                         ((1 *)) z-%offset%)))
                 ((and
                   (<
                    (* safmin
        ...
        (f2cl-lib:fdo (iwhila 1 (f2cl-lib:int-add iwhila 1))
          ...
          (tagbody
            (if (< n0 1)
                (go label150))
            (setf desig zero)
            (cond ((= n0 n) (setf sigma zero))
                  (t
                   (setf sigma
                           (-
                            (f2cl-lib:fref z-%data%
                                           ((f2cl-lib:int-sub
                                             (f2cl-lib:int-mul 4 n0) 1))
                                           ((1 *)) z-%offset%)))))
            (cond ((< sigma zero) (setf info 1) (go end_label)))
            (setf emax zero)
            (cond
             ((> n0 i0)
              (setf emin
            ...
            (f2cl-lib:fdo (i4 (f2cl-lib:int-mul 4 n0)
              ...
              (tagbody
                (if (<=
                     (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 5)) ((1 *))
                                    z-%offset%)
                     zero)
                    (go label100))
                (cond
                 ((>= qmin (* four emax))
                  (setf qmin
                          (min qmin
                               (f2cl-lib:fref z-%data%
                                              ((f2cl-lib:int-sub i4 3)) ((1 *))
                                              z-%offset%)))
                  (setf emax
                          (max emax
                               (f2cl-lib:fref z-%data%
                                              ((f2cl-lib:int-sub i4 5)) ((1 *))
                                              z-%offset%)))))
                (setf qmax
                        (max qmax
                             (+
                              (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 7))
                                             ((1 *)) z-%offset%)
                              (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 5))
                                             ((1 *)) z-%offset%))))
                (setf emin
                        (min emin
                             (f2cl-lib:fref z-%data% ((f2cl-lib:int-sub i4 5))
           ...
           label100
            ...
            (setf dmin
                    (-
                     (max zero
                          (+ qmin
                             (* (- two) (f2cl-lib:fsqrt qmin)
                                (f2cl-lib:fsqrt emax))))))
            (setf pp 0)
            (setf nbig
                    (f2cl-lib:int-mul 30
                                      (f2cl-lib:int-add
                                       (f2cl-lib:int-sub n0 i0) 1)))
                  ...
                  (cond
                   ((or
                    ...
                    (setf qmax
                            (f2cl-lib:fref z-%data%
                                           ((f2cl-lib:int-sub
                                             (f2cl-lib:int-mul 4 i0) 3))
                                           ((1 *)) z-%offset%))
                    (setf emin
                            (f2cl-lib:fref z-%data%
                                           ((f2cl-lib:int-sub
                                             (f2cl-lib:int-mul 4 i0) 1))
                                           ((1 *)) z-%offset%))
                    (setf oldemn
                            (f2cl-lib:fref z-%data% ((f2cl-lib:int-mul 4 i0))
                                           ((1 *)) z-%offset%))
                    ...
                    (setf (f2cl-lib:fref z-%data%
                                         ...
                                         ((1 *)) z-%offset%)
                            emin)
                    (setf (f2cl-lib:fref z-%data% ((f2cl-lib:int-mul 4 n0))
                                         ((1 *)) z-%offset%)
                            oldemn)

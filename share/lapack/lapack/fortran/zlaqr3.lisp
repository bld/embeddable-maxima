        ...
        (prog ((i 0) (ifst 0) (ilst 0) (info 0) (infqr 0) (j 0) (jw 0) (kcol 0)
          ...
          (declare (type (single-float) dconjg$)
                   (type (f2cl-lib:integer4) i ifst ilst info infqr j jw kcol
                    kln knt krow kwtop ltop lwk1 lwk2 lwk3 lwkopt nmin)
          ...
          (cond ((<= jw 2) (setf lwkopt 1))
                (t
                 (multiple-value-bind
                     ...
                     (zgehrd jw 1 (f2cl-lib:int-sub jw 1) t$ ldt work work -1
                      info)
                   (declare (ignore var-0 var-1 var-2 var-3 var-5 var-6 var-7))
                   (setf ldt var-4)
                   (setf info var-8))
                 (setf lwk1
                         (f2cl-lib:int
                 ...
                 (multiple-value-bind
                     ...
                     (zunmhr "R" "N" jw jw 1 (f2cl-lib:int-sub jw 1) t$ ldt
                      work v ldv work -1 info)
                   (declare
                 ...
                 (multiple-value-bind
                     ...
                     (zlaqr4 f2cl-lib:%true% f2cl-lib:%true% jw 1 jw t$ ldt sh
          ...
          (cond
           ((= kbot kwtop)
            (setf (f2cl-lib:fref sh-%data% (kwtop) ((1 *)) sh-%offset%)
                    (f2cl-lib:fref h-%data% (kwtop kwtop) ((1 ldh) (1 *))
                                   h-%offset%))
            (setf ns 1) (setf nd 0)
            (cond
             ((<= (cabs1 s)
           ...
           ((> jw nmin)
            (multiple-value-bind
                ...
                (zlaqr4 f2cl-lib:%true% f2cl-lib:%true% jw 1 jw t$ ldt
                 (f2cl-lib:array-slice sh-%data% f2cl-lib:complex16 (kwtop)
                                       ((1 *)) sh-%offset%)
                 1 jw v ldv work lwork infqr)
              (declare
               (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-7 var-8 var-9
          ...
          (f2cl-lib:fdo (knt (f2cl-lib:int-add infqr 1)
            ...
            (tagbody
              (setf foo
                      (cabs1
                       (f2cl-lib:fref t$-%data% (ns ns) ((1 ldt) (1 *))
                                      t$-%offset%)))
              (if (= foo rzero)
                  (setf foo (cabs1 s)))
              (cond
               ((<=
                 (* (cabs1 s) (cabs1 (f2cl-lib:fref v (1 ns) ((1 ldv) (1 *)))))
                 (max smlnum (* ulp foo)))
              ...
              (tagbody
                ...
                (f2cl-lib:fdo (j (f2cl-lib:int-add i 1) (f2cl-lib:int-add j 1))
                  ...
                  (tagbody
                    (if (>
                         (cabs1
                          (f2cl-lib:fref t$-%data% (j j) ((1 ldt) (1 *))
                                         t$-%offset%))
                         (cabs1
                          (f2cl-lib:fref t$-%data% (ifst ifst) ((1 ldt) (1 *))
                                         t$-%offset%)))
                        (setf ifst j))
                   label20))
                (setf ilst i)
          ...
          (cond
           ((or (< ns jw) (= s zero))
            (cond
             ((and (> ns 1) (/= s zero)) (zcopy ns v ldv work 1)
              ...
              (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                  (zlarfg ns beta
                   (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (2)
                                         ((1 *)) work-%offset%)
                   1 tau)
                ...
                (setf tau var-4))
              (setf (f2cl-lib:fref work-%data% (1) ((1 *)) work-%offset%) one)
              (zlaset "L" (f2cl-lib:int-sub jw 2) (f2cl-lib:int-sub jw 2) zero
               zero
              ...
              (multiple-value-bind
                ...
                (declare (ignore var-0 var-1 var-3 var-5 var-6 var-7))
                (setf ns var-2)
                (setf ldt var-4)
                (setf info var-8))))
            (if (> kwtop 1)
                (setf (f2cl-lib:fref h-%data%
                        ...
                        (* s
                           (f2cl-lib:dconjg
                            (f2cl-lib:fref v-%data% (1 1) ((1 ldv) (1 *))
                                           v-%offset%)))))
            ...
            (f2cl-lib:fdo (krow ltop (f2cl-lib:int-add krow nv))
              ...
              (tagbody
                ...
                (zgemm "N" "N" kln jw jw one
                 (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (krow kwtop)
                                       ((1 ldh) (1 *)) h-%offset%)
                ...
                (tagbody
                  (setf kln
                          (min (the f2cl-lib:integer4 nh)
                               (the f2cl-lib:integer4
                                    (f2cl-lib:int-add (f2cl-lib:int-sub n kcol)
                                                      1))))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil nil nil nil nil nil ns nd nil
                   nil ldv nil nil ldt nil nil nil nil nil)))))))
  ...
  (setf (gethash 'fortran-to-lisp::zlaqr3
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil nil nil nil
                                              fortran-to-lisp::ns
                                              fortran-to-lisp::nd nil nil
                                              fortran-to-lisp::ldv nil nil
                                              fortran-to-lisp::ldt nil nil nil
                                              nil nil)
                                            :calls

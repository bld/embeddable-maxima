    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((orgnrm 0.0) (i 0) (idx 0) (idxc 0) (idxp 0) (isigma 0) (ivfw 0)
        ...
        (cond ((or (< icompq 0) (> icompq 1)) (setf info -1))
              ...
              ((< ldgcol n) (setf info -14)) ((< ldgnum n) (setf info -16)))
        (cond
         ((/= info 0) (xerbla "DLASD6" (f2cl-lib:int-sub info))
          (go end_label)))
        (setf isigma 1)
        ...
        (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-add nl 1)) ((1 *))
                             d-%offset%)
                zero)
        ...
        (multiple-value-bind
            (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9 var-10
             ...
             var-20 var-21 var-22 var-23 var-24 var-25 var-26)
            (dlasd7 icompq nl nr sqre k d z
             (f2cl-lib:array-slice work-%data% double-float (iw) ((1 *))
                                   work-%offset%)
             vf
             (f2cl-lib:array-slice work-%data% double-float (ivfw) ((1 *))
                                   work-%offset%)
             vl
             (f2cl-lib:array-slice work-%data% double-float (ivlw) ((1 *))
                                   work-%offset%)
             alpha beta
             (f2cl-lib:array-slice work-%data% double-float (isigma) ((1 *))
                                   work-%offset%)
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (idx) ((1 *))
                                   iwork-%offset%)
             (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (idxp)
                                   ((1 *)) iwork-%offset%)
             idxq perm givptr givcol ldgcol givnum ldgnum c s info)
          (declare
           (ignore var-0 var-1 var-2 var-3 var-5 var-6 var-7 var-8 var-9 var-10
            var-11 var-12 var-13 var-14 var-15 var-16 var-17 var-18 var-20
        ...
        (cond
         ((= icompq 1)
          (dcopy k d 1
           (f2cl-lib:array-slice poles-%data% double-float (1 1)
                                 ((1 ldgnum) (1 *)) poles-%offset%)
           1)
          (dcopy k
           (f2cl-lib:array-slice work-%data% double-float (isigma) ((1 *))
                                 work-%offset%)
           1
           (f2cl-lib:array-slice poles-%data% double-float (1 2)
                                 ((1 ldgnum) (1 *)) poles-%offset%)
           1)))
        (multiple-value-bind
            (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9)
       ...
       end_label
        (return
         (values nil nil nil nil nil nil nil alpha beta nil nil givptr nil nil
                 nil nil nil nil nil nil k c s nil nil info))))))

  ...
  (defun zgeev (jobvl jobvr n a lda w vl ldvl vr ldvr work lwork rwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
        ...
        (cond
         ((/= info 0) (xerbla "ZGEEV " (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (if (= n 0)
            (go end_label))
        (setf eps (dlamch "P"))
        ...
        (multiple-value-bind
            ...
            (zgehrd n ilo ihi a lda
             (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (itau)
                                   ((1 *)) work-%offset%)
             (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 (iwrk)
                                   ((1 *)) work-%offset%)
              ...
              (setf scl
                      (/ one
                         (dznrm2 n
                          ...
                          1)))
              (zdscal n scl
               (f2cl-lib:array-slice vr-%data% f2cl-lib:complex16 (1 i)
                                     ((1 ldvr) (1 *)) vr-%offset%)
               1)
              (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                            ((> k n) nil)
         ...
         (scalea
          (multiple-value-bind
              ...
              (zlascl "G" 0 0 cscale anrm (f2cl-lib:int-sub n info) 1
               (f2cl-lib:array-slice w-%data% f2cl-lib:complex16 ((+ info 1))
                                     ((1 *)) w-%offset%)
       ...
       end_label
        (return
         (values nil nil nil nil lda nil nil ldvl nil ldvr nil nil nil
                 info))))))
  ...
  (setf (gethash 'fortran-to-lisp::zgeev fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil
                                              ...
                                              fortran-to-lisp::ldvl nil
                                              fortran-to-lisp::ldvr nil nil nil

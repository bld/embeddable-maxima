...
(defun dlasd0 (n sqre d e u ldu vt ldvt smlsiz iwork work info)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((alpha 0.0) (beta 0.0) (i 0) (i1 0) (ic 0) (idxq 0) (idxqc 0)
      ...
      (declare
       (type (f2cl-lib:integer4) sqrei nrp1 nrf nr nlvl nlp1 nlf nl ndimr ndiml
        ndb1 nd ncc m lvl ll lf j iwk itemp inode im1 idxqc idxq ic i1 i)
       (type (double-float) beta alpha))
      (setf info 0)
      (cond ((< n 0) (setf info -1))
            ((or (< sqre 0) (> sqre 1)) (setf info -2)))
      (setf m (f2cl-lib:int-add n sqre))
      (cond ((< ldu n) (setf info -6)) ((< ldvt m) (setf info -8))
            ((< smlsiz 3) (setf info -9)))
      (cond
       ((/= info 0) (xerbla "DLASD0" (f2cl-lib:int-sub info)) (go end_label)))
      (cond
       ((<= n smlsiz)
        (multiple-value-bind
      ...
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
          (dlasdt n nlvl nd
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (inode) ((1 *))
                                 iwork-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (ndiml) ((1 *))
                                 iwork-%offset%)
           (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (ndimr) ((1 *))
                                 iwork-%offset%)
           smlsiz)
      ...
      (f2cl-lib:fdo (i ndb1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (multiple-value-bind
              ...
              (dlasdq "U" sqrei nl nlp1 nl ncc
               ...
               (f2cl-lib:array-slice e-%data% double-float (nlf) ((1 *))
                                     e-%offset%)
               (f2cl-lib:array-slice vt-%data% double-float (nlf nlf)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt
               (f2cl-lib:array-slice u-%data% double-float (nlf nlf)
                                     ((1 ldu) (1 *)) u-%offset%)
               ldu
               (f2cl-lib:array-slice u-%data% double-float (nlf nlf)
                                     ((1 ldu) (1 *)) u-%offset%)
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j nl) nil)
            (tagbody
              (setf (f2cl-lib:fref iwork-%data% ((f2cl-lib:int-add itemp j))
                                   ((1 *)) iwork-%offset%)
                      j)
             label10))
          (cond ((= i nd) (setf sqrei sqre)) (t (setf sqrei 1)))
          ...
          (multiple-value-bind
              ...
              (dlasdq "U" sqrei nr nrp1 nr ncc
               ...
               (f2cl-lib:array-slice e-%data% double-float (nrf) ((1 *))
                                     e-%offset%)
               (f2cl-lib:array-slice vt-%data% double-float (nrf nrf)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt
               (f2cl-lib:array-slice u-%data% double-float (nrf nrf)
                                     ((1 ldu) (1 *)) u-%offset%)
               ldu
               (f2cl-lib:array-slice u-%data% double-float (nrf nrf)
                                     ((1 ldu) (1 *)) u-%offset%)
            ...
            (tagbody
              ...
              (setf nr
                      (f2cl-lib:fref iwork-%data%
                                     ...
                                     iwork-%offset%))
              (setf nlf (f2cl-lib:int-sub ic nl))
              (cond ((and (= sqre 0) (= i ll)) (setf sqrei sqre))
                    (t (setf sqrei 1)))
              ...
              (multiple-value-bind
                  ...
                  (dlasd1 nl nr sqrei
                   ...
                   (f2cl-lib:array-slice vt-%data% double-float (nlf nlf)
                                         ((1 ldvt) (1 *)) vt-%offset%)
                   ldvt
                   (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (idxqc)
                                         ((1 *)) iwork-%offset%)
                   (f2cl-lib:array-slice iwork-%data% f2cl-lib:integer4 (iwk)
                                         ((1 *)) iwork-%offset%)
                   work info)
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-6 var-7 var-8 var-9 var-10
                  var-11 var-12))
                (setf alpha var-4)
                (setf beta var-5)
                (setf info var-13))

      ...
      (prog ((ws 0.0) (i 0) (iinfo 0) (j 0) (ldwrkx 0) (ldwrky 0) (lwkopt 0)
        ...
        (cond ((< m 0) (setf info -1)) ((< n 0) (setf info -2))
              ...
              ((and
               ...
               (setf info -10)))
        (cond
         ((< info 0) (xerbla "DGEBRD" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
           ...
           ((< nx minmn)
            (setf ws
                    (coerce
                     ...
                     'double-float))
            (cond
             ((< lwork ws) (setf nbmin (ilaenv 2 "DGEBRD" " " m n -1 -1))
              (cond
          ...
          (tagbody
            (dlabrd (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
             ...
             (f2cl-lib:array-slice e-%data% double-float (i) ((1 *))
                                   e-%offset%)
             (f2cl-lib:array-slice tauq-%data% double-float (i) ((1 *))
                                   tauq-%offset%)
             (f2cl-lib:array-slice taup-%data% double-float (i) ((1 *))
                                   taup-%offset%)
             work ldwrkx
            ...
            (dgemm "No transpose" "Transpose"
             ...
             (f2cl-lib:array-slice a-%data% double-float ((+ i nb) i)
                                   ((1 lda) (1 *)) a-%offset%)
             lda
             (f2cl-lib:array-slice work-%data% double-float
            ...
            (dgemm "No transpose" "No transpose"
             (f2cl-lib:int-add (f2cl-lib:int-sub m i nb) 1)
             (f2cl-lib:int-add (f2cl-lib:int-sub n i nb) 1) nb (- one)
             (f2cl-lib:array-slice work-%data% double-float ((+ nb 1)) ((1 *))
                                   work-%offset%)
             ldwrkx
             (f2cl-lib:array-slice a-%data% double-float
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dgebrd
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :calls
                                            '(fortran-to-lisp::dgebd2
                                              fortran-to-lisp::dgemm
                                              fortran-to-lisp::dlabrd

        ...
        (prog ((csumj #C(0.0 0.0)) (tjjs #C(0.0 0.0)) (uscal #C(0.0 0.0))
          ...
          (cond ((and (not upper) (not (lsame uplo "L"))) (setf info -1))
                ((and (not notran) (not (lsame trans "T"))
                      (not (lsame trans "C")))
                 (setf info -2))
                ((and (not nounit) (not (lsame diag "U"))) (setf info -3))
                ...
                ((< lda
                 ...
                 (setf info -7)))
          (cond
           ((/= info 0) (xerbla "ZLATRS" (f2cl-lib:int-sub info))
            (go end_label)))
          (if (= n 0)
              (go end_label))
            ...
            (cond
             (upper
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                            ((> j n) nil)
                (tagbody
                  (setf (f2cl-lib:fref cnorm-%data% (j) ((1 *)) cnorm-%offset%)
               ...
               (t (setf grow (min one (/ half (max xbnd smlnum))))
                (f2cl-lib:fdo (j jfirst (f2cl-lib:int-add j jinc))
                  ...
                  (tagbody
                   ...
                   label80))))
             label90)))
          (cond ((> (* grow tscal) smlnum) (ztrsv uplo trans diag n a lda x 1))
                (t
                 (cond
                  ((> xmax (* bignum half))
                   (setf scale (/ (* bignum half) xmax)) (zdscal n scale x 1)
                   (setf xmax bignum))
                       ...
                       (cond
                          ...
                          ((< tjj one)
                           (cond
                            ((> xj (* tjj bignum)) (setf rec (/ one xj))
                             (zdscal n rec x 1) (setf scale (* scale rec))
                             (setf xmax (* xmax rec))))))
                        ...
                        (t
                         (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                                       ((> i n) nil)
                           (tagbody
                             (setf (f2cl-lib:fref x-%data% (i) ((1 *))
                                                  x-%offset%)
                                     (coerce zero 'f2cl-lib:complex16))
                            label100))
                         (setf (f2cl-lib:fref x-%data% (j) ((1 *)) x-%offset%)
                                 (coerce one 'f2cl-lib:complex16))
                         (setf xj one) (setf scale zero) (setf xmax zero)))
                      label110
                       (cond
                        ((> xj one) (setf rec (/ one xj))
                         (cond
                          ((> (f2cl-lib:fref cnorm (j) ((1 *)))
                              (* (+ bignum (- xmax)) rec))
                           (setf rec (* rec half)) (zdscal n rec x 1)
                           (setf scale (* scale rec)))))
                        ((> (* xj (f2cl-lib:fref cnorm (j) ((1 *))))
                            (+ bignum (- xmax)))
                         (zdscal n half x 1) (setf scale (* scale half))))
                       (cond
                        (upper
                         (cond
                          ((> j 1)
                          ...
                          ((< j n)
                           (zaxpy (f2cl-lib:int-sub n j)
                            ...
                            (f2cl-lib:array-slice a-%data% f2cl-lib:complex16
                                                  ...
                                                  a-%offset%)
                            1
                            (f2cl-lib:array-slice x-%data% f2cl-lib:complex16
                                                  ((+ j 1)) ((1 *)) x-%offset%)
                            1)
                           (setf i
                                   (f2cl-lib:int-add j
          ...
          (cond ((/= tscal one) (dscal n (/ one tscal) cnorm 1)))
          (go end_label)
         end_label

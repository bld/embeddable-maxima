        ...
        (prog ((zdum (make-array 1 :element-type 'f2cl-lib:complex16))
          ...
          (declare (type (array f2cl-lib:complex16 (1)) zdum)
                   ...
                   (type (f2cl-lib:integer4) i inf it itmax k kacc22 kbot kdu
                    ks kt ktop ku kv kwh kwtop kwv ld ls lwkopt ndec ndfl nh
              ...
              (multiple-value-bind
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                  var-9 var-10 var-11 var-14 var-15 var-17 var-18 var-20 var-21
                 ...
                 label20
                  ...
                  (cond
                   ((< nw nwmax)
                    (cond
                     ...
                     (t
                      (setf kwtop
                              (f2cl-lib:int-add (f2cl-lib:int-sub kbot nw) 1))
                      (if (>
                           (cabs1
                  ...
                  (multiple-value-bind
                      ...
                      (zlaqr3 wantt wantz n ktop kbot nw h ldh iloz ihiz z ldz
                       ls ld w
                       (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (kv 1)
                                             ((1 ldh) (1 *)) h-%offset%)
                       ldh nho
                    ...
                    (declare
                     (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                      var-8 var-9 var-10 var-11 var-14 var-15 var-17 var-18
                   ...
                   ((or (= ld 0)
                    ...
                    (cond
                     ((= (mod ndfl kexsh) 0)
                      ...
                      (f2cl-lib:fdo (i kbot
                                     (f2cl-lib:int-add i (f2cl-lib:int-sub 2)))
                     ...
                     (t
                       ...
                       ((<= (f2cl-lib:int-add kbot (f2cl-lib:int-sub ks) 1)
                        ...
                        (setf ks
                                (f2cl-lib:int-add (f2cl-lib:int-sub kbot ns)
                                                  1))
                        (setf kt (f2cl-lib:int-add (f2cl-lib:int-sub n ns) 1))
                        (zlacpy "A" ns ns
                         (f2cl-lib:array-slice h-%data% f2cl-lib:complex16
                                               (ks ks) ((1 ldh) (1 *))
                                               h-%offset%)
                        ...
                        (cond
                         ((> ns nmin)
                          (multiple-value-bind
                              ...
                              (zlaqr4 f2cl-lib:%false% f2cl-lib:%false% ns 1 ns
                         ...
                         (t
                          (multiple-value-bind
                              ...
                              (zlahqr f2cl-lib:%false% f2cl-lib:%false% ns 1 ns
                               (f2cl-lib:array-slice h-%data%
                                                     f2cl-lib:complex16 (kt 1)
                                                     ((1 ldh) (1 *))
                                                     h-%offset%)
                      ...
                      (cond
                       ((> (f2cl-lib:int-add kbot (f2cl-lib:int-sub ks) 1) ns)
                        (tagbody
                       ...
                       ((<
                         (cabs1
                          (+ (f2cl-lib:fref w (kbot) ((1 *)))
                             (-
                              (f2cl-lib:fref h (kbot kbot) ((1 ldh) (1 *))))))
                         (cabs1
                          (+
                           (f2cl-lib:fref w
                    ...
                    (zlaqr5 wantt wantz kacc22 n ktop kbot ns
                     (f2cl-lib:array-slice w-%data% f2cl-lib:complex16 (ks)
                                           ((1 *)) w-%offset%)
                     h ldh iloz ihiz z ldz work 3
                     (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (ku 1)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh nve
                     (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (kwv 1)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh nho
                     (f2cl-lib:array-slice h-%data% f2cl-lib:complex16 (ku kwh)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh)))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil ldh nil nil nil nil nil nil nil
                   info)))))))
  ...
  (setf (gethash 'fortran-to-lisp::zlaqr0
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil
                                              fortran-to-lisp::ldh nil nil nil
                                              nil nil nil nil

  ...
  (defun dlasd3
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((rho 0.0) (temp 0.0) (ctemp 0) (i 0) (j 0) (jc 0) (ktemp 0) (m 0)
        ...
        (cond ((or (< k 1) (> k n)) (setf info -4)) ((< ldq k) (setf info -7))
              ((< ldu n) (setf info -10)) ((< ldu2 n) (setf info -12))
              ((< ldvt m) (setf info -14)) ((< ldvt2 m) (setf info -16)))
        (cond
         ((/= info 0) (xerbla "DLASD3" (f2cl-lib:int-sub info))
          (go end_label)))
        (cond
         ((= k 1)
          ...
          (dcopy m
           ...
           ldvt2
           (f2cl-lib:array-slice vt-%data% double-float (1 1) ((1 ldvt) (1 *))
                                 vt-%offset%)
           ldvt)
          (cond
           ((> (f2cl-lib:fref z (1) ((1 *))) zero)
            (dcopy n
             (f2cl-lib:array-slice u2-%data% double-float (1 1)
                                   ((1 ldu2) (1 *)) u2-%offset%)
             1
             (f2cl-lib:array-slice u-%data% double-float (1 1) ((1 ldu) (1 *))
                                   u-%offset%)
             1))
           (t
            (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                          ((> i n) nil)
              (tagbody
                (setf (f2cl-lib:fref u-%data% (i 1) ((1 ldu) (1 *)) u-%offset%)
                        (-
                         (f2cl-lib:fref u2-%data% (i 1) ((1 ldu2) (1 *))
                                        u2-%offset%)))
               label10))))
          (go end_label)))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
          ...
          (tagbody
            (multiple-value-bind
                ...
                (dlasd4 k j dsigma z
                 (f2cl-lib:array-slice u-%data% double-float (1 j)
                                       ((1 ldu) (1 *)) u-%offset%)
                 rho (f2cl-lib:fref d-%data% (j) ((1 *)) d-%offset%)
                 (f2cl-lib:array-slice vt-%data% double-float (1 j)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 info)
          ...
          (tagbody
            (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                    (*
                     ...
                     (f2cl-lib:fref vt-%data% (i k) ((1 ldvt) (1 *))
                                    vt-%offset%)))
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                ...
                (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                        (* (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                           (/
                            (/
                             (*
                              (f2cl-lib:fref u-%data% (i j) ((1 ldu) (1 *))
                                             u-%offset%)
                              (f2cl-lib:fref vt-%data% (i j) ((1 ldvt) (1 *))
                                             vt-%offset%))
                             (-
                              (f2cl-lib:fref dsigma-%data% (i) ((1 *))
                                             dsigma-%offset%)
                              (f2cl-lib:fref dsigma-%data% (j) ((1 *))
                                             dsigma-%offset%)))
                            (+
                             (f2cl-lib:fref dsigma-%data% (i) ((1 *))
                                            dsigma-%offset%)
            ...
            (setf (f2cl-lib:fref z-%data% (i) ((1 *)) z-%offset%)
                    (f2cl-lib:sign
                     ...
                     (f2cl-lib:fref q-%data% (i 1) ((1 ldq) (1 *))
                                    q-%offset%)))
           label60))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i k) nil)
          (tagbody
            (setf (f2cl-lib:fref vt-%data% (1 i) ((1 ldvt) (1 *)) vt-%offset%)
                    (/
                     (/ (f2cl-lib:fref z-%data% (1) ((1 *)) z-%offset%)
                        (f2cl-lib:fref u-%data% (1 i) ((1 ldu) (1 *))
                                       u-%offset%))
                     (f2cl-lib:fref vt-%data% (1 i) ((1 ldvt) (1 *))
                                    vt-%offset%)))
            ...
            (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
                          ((> j k) nil)
              (tagbody
                (setf (f2cl-lib:fref vt-%data% (j i) ((1 ldvt) (1 *))
                                     vt-%offset%)
                        (/
                         (/ (f2cl-lib:fref z-%data% (j) ((1 *)) z-%offset%)
                            (f2cl-lib:fref u-%data% (j i) ((1 ldu) (1 *))
                                           u-%offset%))
                         (f2cl-lib:fref vt-%data% (j i) ((1 ldvt) (1 *))
                                        vt-%offset%)))
            ...
            (setf temp
                    (dnrm2 k
                     (f2cl-lib:array-slice u-%data% double-float (1 i)
                                           ((1 ldu) (1 *)) u-%offset%)
                     1))
            ...
            (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                ...
                (setf (f2cl-lib:fref q-%data% (j i) ((1 ldq) (1 *)) q-%offset%)
                        (/
                         (f2cl-lib:fref u-%data% (jc i) ((1 ldu) (1 *))
                                        u-%offset%)
                         temp))
               label80))
           label90))
        (cond
         ((= k 2) (dgemm "N" "N" n k k one u2 ldu2 q ldq zero u ldu)
          (go label100)))
        (cond
         ((> (f2cl-lib:fref ctot (1) ((1 *))) 0)
          (dgemm "N" "N" nl k
           (f2cl-lib:fref ctot-%data% (1) ((1 *)) ctot-%offset%) one
           (f2cl-lib:array-slice u2-%data% double-float (1 2) ((1 ldu2) (1 *))
                                 u2-%offset%)
           ldu2
           (f2cl-lib:array-slice q-%data% double-float (2 1) ((1 ldq) (1 *))
                                 q-%offset%)
           ldq zero
           (f2cl-lib:array-slice u-%data% double-float (1 1) ((1 ldu) (1 *))
                                 u-%offset%)
          ...
          (cond
           ((> (f2cl-lib:fref ctot (3) ((1 *))) 0)
            (setf ktemp
                    (f2cl-lib:int-add 2
                                      (f2cl-lib:fref ctot-%data% (1) ((1 *))
                                                     ctot-%offset%)
                                      (f2cl-lib:fref ctot-%data% (2) ((1 *))
                                                     ctot-%offset%)))
            (dgemm "N" "N" nl k
             (f2cl-lib:fref ctot-%data% (3) ((1 *)) ctot-%offset%) one
             (f2cl-lib:array-slice u2-%data% double-float (1 ktemp)
                                   ((1 ldu2) (1 *)) u2-%offset%)
             ldu2
             (f2cl-lib:array-slice q-%data% double-float (ktemp 1)
                                   ((1 ldq) (1 *)) q-%offset%)
             ldq one
             (f2cl-lib:array-slice u-%data% double-float (1 1) ((1 ldu) (1 *))
                                   u-%offset%)
         ...
         ((> (f2cl-lib:fref ctot (3) ((1 *))) 0)
          ...
          (dgemm "N" "N" nl k
           ...
           (f2cl-lib:array-slice u-%data% double-float (1 1) ((1 ldu) (1 *))
                                 u-%offset%)
           ldu))
         (t (dlacpy "F" nl k u2 ldu2 u ldu)))
        (dcopy k
         (f2cl-lib:array-slice q-%data% double-float (1 1) ((1 ldq) (1 *))
                               q-%offset%)
         ldq
         (f2cl-lib:array-slice u-%data% double-float (nlp1 1) ((1 ldu) (1 *))
                               u-%offset%)
         ldu)
        (setf ktemp
                (f2cl-lib:int-add 2
        ...
        (dgemm "N" "N" nr k ctemp one
         (f2cl-lib:array-slice u2-%data% double-float (nlp2 ktemp)
                               ((1 ldu2) (1 *)) u2-%offset%)
         ldu2
         (f2cl-lib:array-slice q-%data% double-float (ktemp 1) ((1 ldq) (1 *))
                               q-%offset%)
         ldq zero
         (f2cl-lib:array-slice u-%data% double-float (nlp2 1) ((1 ldu) (1 *))
                               u-%offset%)
         ldu)
       label100
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (setf temp
                    (dnrm2 k
                     (f2cl-lib:array-slice vt-%data% double-float (1 i)
                                           ((1 ldvt) (1 *)) vt-%offset%)
                     1))
            ...
            (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                ...
                (setf (f2cl-lib:fref q-%data% (i j) ((1 ldq) (1 *)) q-%offset%)
                        (/
                         (f2cl-lib:fref vt-%data% (jc i) ((1 ldvt) (1 *))
                                        vt-%offset%)
                         temp))
               label110))
           label120))
        (cond
         ((= k 2) (dgemm "N" "N" k m k one q ldq vt2 ldvt2 zero vt ldvt)
          (go end_label)))
        (setf ktemp
                (f2cl-lib:int-add 1
                                  (f2cl-lib:fref ctot-%data% (1) ((1 *))
        ...
        (dgemm "N" "N" k nlp1 ktemp one
         (f2cl-lib:array-slice q-%data% double-float (1 1) ((1 ldq) (1 *))
                               q-%offset%)
         ldq
         (f2cl-lib:array-slice vt2-%data% double-float (1 1) ((1 ldvt2) (1 *))
                               vt2-%offset%)
         ldvt2 zero
         (f2cl-lib:array-slice vt-%data% double-float (1 1) ((1 ldvt) (1 *))
                               vt-%offset%)
        ...
        (if (<= ktemp ldvt2)
            (dgemm "N" "N" k nlp1
             (f2cl-lib:fref ctot-%data% (3) ((1 *)) ctot-%offset%) one
             (f2cl-lib:array-slice q-%data% double-float (1 ktemp)
                                   ((1 ldq) (1 *)) q-%offset%)
             ldq
             (f2cl-lib:array-slice vt2-%data% double-float (ktemp 1)
                                   ((1 ldvt2) (1 *)) vt2-%offset%)
             ldvt2 one
             (f2cl-lib:array-slice vt-%data% double-float (1 1)
                                   ((1 ldvt) (1 *)) vt-%offset%)
             ldvt))
        (setf ktemp
                (f2cl-lib:int-add
                 (f2cl-lib:fref ctot-%data% (1) ((1 *)) ctot-%offset%) 1))
        ...
        (cond
         ((> ktemp 1)
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i k) nil)
            (tagbody
              (setf (f2cl-lib:fref q-%data% (i ktemp) ((1 ldq) (1 *))
                                   q-%offset%)
                      (f2cl-lib:fref q-%data% (i 1) ((1 ldq) (1 *))
                                     q-%offset%))
             label130))
          (f2cl-lib:fdo (i nlp2 (f2cl-lib:int-add i 1))
                        ((> i m) nil)
            (tagbody
              (setf (f2cl-lib:fref vt2-%data% (ktemp i) ((1 ldvt2) (1 *))
                                   vt2-%offset%)
                      (f2cl-lib:fref vt2-%data% (1 i) ((1 ldvt2) (1 *))
                                     vt2-%offset%))
             label140))))
        (setf ctemp
                (f2cl-lib:int-add 1
                                  (f2cl-lib:fref ctot-%data% (2) ((1 *))
                                                 ctot-%offset%)
                                  (f2cl-lib:fref ctot-%data% (3) ((1 *))
                                                 ctot-%offset%)))
        (dgemm "N" "N" k nrp1 ctemp one
         (f2cl-lib:array-slice q-%data% double-float (1 ktemp) ((1 ldq) (1 *))
                               q-%offset%)
         ldq
         (f2cl-lib:array-slice vt2-%data% double-float (ktemp nlp2)
                               ((1 ldvt2) (1 *)) vt2-%offset%)
         ldvt2 zero
         (f2cl-lib:array-slice vt-%data% double-float (1 nlp2) ((1 ldvt) (1 *))
                               vt-%offset%)
         ldvt)
        (go end_label)
       end_label

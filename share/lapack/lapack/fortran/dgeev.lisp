  ...
  (defun dgeev (jobvl jobvr n a lda wr wi vl ldvl vr ldvr work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
        ...
        (cond ((and (not wantvl) (not (lsame jobvl "N"))) (setf info -1))
              ((and (not wantvr) (not (lsame jobvr "N"))) (setf info -2))
              ((< n 0) (setf info -3))
              ((< lda
                  (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 n)))
               (setf info -5))
              ((or (< ldvl 1) (and wantvl (< ldvl n))) (setf info -9))
              ((or (< ldvr 1) (and wantvr (< ldvr n))) (setf info -11)))
        (setf minwrk 1)
        (cond
         ((and (= info 0) (or (>= lwork 1) lquery))
          ...
          (cond
           ((and (not wantvl) (not wantvr))
            ...
            (setf maxb
                    (max
                     (the f2cl-lib:integer4 (ilaenv 8 "DHSEQR" "EN" n 1 n -1))
           ...
           (t
            ...
            (setf maxb
                    (max
                     (the f2cl-lib:integer4 (ilaenv 8 "DHSEQR" "SV" n 1 n -1))
                     (the f2cl-lib:integer4 2)))
            (setf k
                    (min (the f2cl-lib:integer4 maxb) (the f2cl-lib:integer4 n)
                         (the f2cl-lib:integer4
        ...
        (cond
         ((/= info 0) (xerbla "DGEEV " (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
        (if (= n 0)
            (go end_label))
        (setf eps (dlamch "P"))
        ...
        (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7)
            (dgebal "B" n a lda ilo ihi
             (f2cl-lib:array-slice work-%data% double-float (ibal) ((1 *))
                                   work-%offset%)
             ierr)
            ...
            (tagbody
              (cond
               ...
               ((> (f2cl-lib:fref wi (i) ((1 *))) zero)
                ...
                (setf k
                        (idamax n
                         (f2cl-lib:array-slice work-%data% double-float (iwrk)
                                               ((1 *)) work-%offset%)
                         1))

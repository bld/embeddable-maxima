        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (cond
             ((> i 1)
              ...
              (dcopy (f2cl-lib:int-sub i 1)
               (f2cl-lib:array-slice a-%data% double-float ((+ k 1) i)
                                     ((1 lda) (1 *)) a-%offset%)
               1
               (f2cl-lib:array-slice t$-%data% double-float (1 nb)
                                     ((1 ldt) (1 nb)) t$-%offset%)
               1)
              (dtrmv "Lower" "Transpose" "Unit" (f2cl-lib:int-sub i 1)
               (f2cl-lib:array-slice a-%data% double-float ((+ k 1) 1)
                                     ((1 lda) (1 *)) a-%offset%)
               lda
               (f2cl-lib:array-slice t$-%data% double-float (1 nb)
                                     ((1 ldt) (1 nb)) t$-%offset%)
              ...
              (dgemv "Transpose" (f2cl-lib:int-add (f2cl-lib:int-sub n k i) 1)
               ...
               (f2cl-lib:array-slice a-%data% double-float ((+ k i) 1)
                                     ((1 lda) (1 *)) a-%offset%)
               lda
               (f2cl-lib:array-slice a-%data% double-float ((+ k i) i)
                                     ((1 lda) (1 *)) a-%offset%)
               1 one
               (f2cl-lib:array-slice t$-%data% double-float (1 nb)
                                     ((1 ldt) (1 nb)) t$-%offset%)
            ...
            (dgemv "No transpose" n
             ...
             (f2cl-lib:array-slice a-%data% double-float
                                   (1 (f2cl-lib:int-add i 1)) ((1 lda) (1 *))
                                   a-%offset%)
             lda
             (f2cl-lib:array-slice a-%data% double-float ((+ k i) i)
                                   ((1 lda) (1 *)) a-%offset%)
             1 zero
             (f2cl-lib:array-slice y-%data% double-float (1 i) ((1 ldy) (1 nb))
                                   y-%offset%)
             1)
            (dgemv "Transpose" (f2cl-lib:int-add (f2cl-lib:int-sub n k i) 1)
             (f2cl-lib:int-sub i 1) one

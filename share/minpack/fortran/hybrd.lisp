  ...
  (defun hybrd
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((actred 0.0) (delta 0.0) (epsmch 0.0) (fnorm 0.0) (fnorm1 0.0)
        ...
        (declare
         (type (f2cl-lib:integer4) nslow2 nslow1 ncsuc ncfail msum l jm1 j iter
          iflag i)
        ...
        (setf iflag 0)
        (setf nfev 0)
        (if (or (<= n 0) (< xtol zero) (<= maxfev 0) (< ml 0) (< mu 0)
                (<= factor zero) (< ldfjac n)
       ...
       label30
        ...
        (multiple-value-bind
          ...
          (declare
           (ignore var-0 var-2 var-3 var-4 var-5 var-7 var-8 var-9 var-10
            var-11))
          (setf n var-1)
          (setf iflag var-6))
       ...
       end_label
        (return
         (values nil n nil nil nil nil nil nil nil nil nil nil nil info nfev
